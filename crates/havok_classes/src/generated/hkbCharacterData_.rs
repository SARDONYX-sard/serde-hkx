...
const _: () = {
    ...
    impl __serde::HavokClass for hkbCharacterData {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(806184968u32)
        }
    }
    impl __serde::Serialize for hkbCharacterData {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(806184968u32)));

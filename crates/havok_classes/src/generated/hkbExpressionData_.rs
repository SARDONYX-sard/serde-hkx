...
impl<'de> _serde::de::Visitor<'de> for __FieldVisitor {
        ...
        __E: _serde::de::Error,
    {
        match __value {
            ...
            "assignmentVariableIndex" => Ok(__Field::m_assignmentVariableIndex),
...
pub(super) struct __hkbExpressionDataVisitor<'de> {
    marker: core::marker::PhantomData<hkbExpressionData<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbExpressionDataVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbExpressionData<'de>, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkbExpressionDataVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkbExpressionData")
    }

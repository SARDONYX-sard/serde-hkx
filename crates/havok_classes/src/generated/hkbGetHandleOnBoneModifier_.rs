...
const _: () = {
    ...
    impl<'a> __serde::HavokClass for hkbGetHandleOnBoneModifier<'a> {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(1354975767u32)
        }
    }
    impl<'a> __serde::Serialize for hkbGetHandleOnBoneModifier<'a> {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(1354975767u32)));

...
const _: () = {
    ...
    impl _serde::HavokClass for hkpShapeCollection {
        #[inline]
    ...
    impl _serde::Serialize for hkpShapeCollection {
...
pub(super) struct __hkpShapeCollectionVisitor<'de> {
    marker: core::marker::PhantomData<hkpShapeCollection>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpShapeCollectionVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpShapeCollection, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkpShapeCollectionVisitor<'de> {
    type Value = hkpShapeCollection;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpShapeCollection")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let m_disableWelding = match m_disableWelding {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("disableWelding"),
                );
            }
        };
        let m_collectionType = match m_collectionType {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("collectionType"),
                );
            }
        };
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpShapeCollection {

...
pub(super) struct __hkbBlenderGeneratorChildInternalStateVisitor<'de> {
    marker: core::marker::PhantomData<hkbBlenderGeneratorChildInternalState>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbBlenderGeneratorChildInternalStateVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbBlenderGeneratorChildInternalState, __A::Error>
    where
...
for __hkbBlenderGeneratorChildInternalStateVisitor<'de> {
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let m_syncNextFrame = match m_syncNextFrame {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("syncNextFrame"),
                );
            }
        };

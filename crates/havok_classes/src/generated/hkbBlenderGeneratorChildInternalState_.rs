...
pub struct hkbBlenderGeneratorChildInternalState<'a> {
...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkbBlenderGeneratorChildInternalState<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkbBlenderGeneratorChildInternalState<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbBlenderGeneratorChildInternalState<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkbBlenderGeneratorChildInternalStateVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkbBlenderGeneratorChildInternalState<'de>,
                >,
            ...
            for __hkbBlenderGeneratorChildInternalStateVisitor<'de> {
                type Value = hkbBlenderGeneratorChildInternalState<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

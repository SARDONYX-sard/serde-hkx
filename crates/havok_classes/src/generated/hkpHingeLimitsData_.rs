...
pub(super) struct __hkpHingeLimitsDataVisitor<'de> {
    marker: core::marker::PhantomData<hkpHingeLimitsData>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpHingeLimitsDataVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpHingeLimitsData, __A::Error>
    where
        __A: _serde::de::MapAccess<'de>,
    {
        _serde::de::Visitor::visit_struct(
            Self {
                marker: _serde::__private::PhantomData::<hkpHingeLimitsData>,
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpHingeLimitsDataVisitor<'de> {
    type Value = hkpHingeLimitsData;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpHingeLimitsData")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let mut m_atoms: _serde::__private::Option<hkpHingeLimitsDataAtoms> = _serde::__private::None;
        for i in 0..1usize {
            match i {
                0usize => {
                    ...
                    m_atoms = _serde::__private::Some(
                        match __A::next_value::<hkpHingeLimitsDataAtoms>(&mut __map) {
        ...
        _serde::__private::Ok(hkpHingeLimitsData {
            __ptr,
            parent,
            m_atoms,
        })
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpHingeLimitsData {

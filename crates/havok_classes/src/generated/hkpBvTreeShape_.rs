...
pub(super) struct __hkpBvTreeShapeVisitor<'de> {
    marker: core::marker::PhantomData<hkpBvTreeShape>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpBvTreeShapeVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpBvTreeShape, __A::Error>
    where
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let m_bvTreeType = match m_bvTreeType {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("bvTreeType"),
                );
            }
        };

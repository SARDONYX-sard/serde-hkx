...
const _: () = {
    ...
    impl __serde::HavokClass for hkaRagdollInstance {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(357124328u32)
        }
    }
    impl __serde::Serialize for hkaRagdollInstance {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(357124328u32)));

...
const _: () = {
    ...
    impl __serde::HavokClass for hkbPoseMatchingGeneratorInternalState {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(1429052884u32)
        }
    }
    impl __serde::Serialize for hkbPoseMatchingGeneratorInternalState {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(1429052884u32)));

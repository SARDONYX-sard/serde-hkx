...
pub struct hkpDisplayBindingData<'a> {
    ...
    pub m_rigidBodyBindings: Vec<Pointer<'a>>,
    /// # C++ Info
    ...
    pub m_physicsSystemBindings: Vec<Pointer<'a>>,
}
const _: () = {
    use havok_serde as _serde;
    impl<'a> _serde::HavokClass for hkpDisplayBindingData<'a> {
        #[inline]
        ...
        fn deps_indexes(&self) -> Vec<&Pointer<'_>> {
            let mut v = Vec::new();
            v.extend(self.m_rigidBodyBindings.iter());
            v.extend(self.m_physicsSystemBindings.iter());
            v
        }
    }
    impl<'a> _serde::Serialize for hkpDisplayBindingData<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpDisplayBindingData<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpDisplayBindingDataVisitor<'de> {
                marker: _serde::__private::PhantomData<hkpDisplayBindingData<'de>>,
            ...
            impl<'de> _serde::de::Visitor<'de> for __hkpDisplayBindingDataVisitor<'de> {
                type Value = hkpDisplayBindingData<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

...
const _: () = {
    ...
    impl __serde::HavokClass for hkpDisplayBindingData {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(3695626502u32)
        }
    }
    impl __serde::Serialize for hkpDisplayBindingData {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(3695626502u32)));

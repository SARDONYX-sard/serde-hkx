...
const _: () = {
    ...
    impl<'a> __serde::HavokClass for hkbRigidBodyRagdollControlsModifier<'a> {
        fn name(&self) -> &'static core::ffi::CStr {
            c"hkbRigidBodyRagdollControlsModifier"
        }
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(2861027819u32)
        }
    }
    impl<'a> __serde::Serialize for hkbRigidBodyRagdollControlsModifier<'a> {

...
use super::*;
/// # C++ Info
/// - name: `hkbRigidBodyRagdollControlsModifier`
/// - version: `3`
...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkbRigidBodyRagdollControlsModifier<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkbRigidBodyRagdollControlsModifier<'a> {
            ...
            S: _serde::ser::Serializer,
        {
            ...
            let mut serializer = __serializer
                .serialize_struct("hkbRigidBodyRagdollControlsModifier", class_meta)?;
...
pub(super) struct __hkbRigidBodyRagdollControlsModifierVisitor<'de> {
    marker: core::marker::PhantomData<hkbRigidBodyRagdollControlsModifier<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbRigidBodyRagdollControlsModifierVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbRigidBodyRagdollControlsModifier<'de>, __A::Error>
    where
        ...
        _serde::de::Visitor::visit_struct(
            Self {
                marker: _serde::__private::PhantomData::<
                    hkbRigidBodyRagdollControlsModifier<'de>,
                >,
...
for __hkbRigidBodyRagdollControlsModifierVisitor<'de> {
    type Value = hkbRigidBodyRagdollControlsModifier<'de>;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbRigidBodyRagdollControlsModifier<'de> {
        fn deserialize<__D>(deserializer: __D) -> core::result::Result<Self, __D::Error>
        where
            __D: _serde::Deserializer<'de>,
        {
            const FIELDS: &[&str] = &["controlData", "bones"];
            _serde::Deserializer::deserialize_struct(
                deserializer,
                "hkbRigidBodyRagdollControlsModifier",
                FIELDS,
                __hkbRigidBodyRagdollControlsModifierVisitor {
                    marker: _serde::__private::PhantomData::<
                        hkbRigidBodyRagdollControlsModifier,
                    >,
                    lifetime: _serde::__private::PhantomData,

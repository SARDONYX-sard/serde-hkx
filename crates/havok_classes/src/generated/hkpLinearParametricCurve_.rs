...
pub struct hkpLinearParametricCurve<'a> {
    ...
    #[cfg_attr(feature = "serde", serde(borrow))]
    pub parent: hkpParametricCurve<'a>,
    /// # C++ Info
...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpLinearParametricCurve<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpLinearParametricCurve<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpLinearParametricCurve<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpLinearParametricCurveVisitor<'de> {
                marker: _serde::__private::PhantomData<hkpLinearParametricCurve<'de>>,
            ...
            for __hkpLinearParametricCurveVisitor<'de> {
                type Value = hkpLinearParametricCurve<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

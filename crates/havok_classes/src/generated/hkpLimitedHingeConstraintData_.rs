...
const _: () = {
    ...
    impl __serde::HavokClass for hkpLimitedHingeConstraintData {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(2081799019u32)
        }
    }
    impl __serde::Serialize for hkpLimitedHingeConstraintData {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(2081799019u32)));

...
pub struct hkpLimitedHingeConstraintData<'a> {
    ...
    pub m_atoms: hkpLimitedHingeConstraintDataAtoms<'a>,
}
const _: () = {
    use havok_serde as _serde;
    impl<'a> _serde::HavokClass for hkpLimitedHingeConstraintData<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpLimitedHingeConstraintData<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpLimitedHingeConstraintData<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpLimitedHingeConstraintDataVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkpLimitedHingeConstraintData<'de>,
                >,
            ...
            for __hkpLimitedHingeConstraintDataVisitor<'de> {
                type Value = hkpLimitedHingeConstraintData<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

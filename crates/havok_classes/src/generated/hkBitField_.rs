...
pub(super) struct __hkBitFieldVisitor<'de> {
    marker: core::marker::PhantomData<hkBitField>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkBitFieldVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkBitField, __A::Error>
    where
            ...
            match i {
                ...
                1usize => {
                    if _serde::__private::Option::is_some(&m_numBits) {
                        return _serde::__private::Err(
                            <__A::Error as _serde::de::Error>::duplicate_field("numBits"),
                        );
                    }

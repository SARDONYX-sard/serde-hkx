...
const _: () = {
    ...
    impl _serde::HavokClass for hkbMirroredSkeletonInfo {
        ...
        fn signature(&self) -> _serde::__private::Signature {
            _serde::__private::Signature::new(0xc6c2da4f)
        }
    }
...
pub(super) struct __hkbMirroredSkeletonInfoVisitor<'de> {
    marker: core::marker::PhantomData<hkbMirroredSkeletonInfo>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbMirroredSkeletonInfoVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbMirroredSkeletonInfo, __A::Error>
    where
        __A: _serde::de::MapAccess<'de>,
    {
        _serde::de::Visitor::visit_struct(
            Self {
                marker: _serde::__private::PhantomData::<hkbMirroredSkeletonInfo>,
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkbMirroredSkeletonInfoVisitor<'de> {
    type Value = hkbMirroredSkeletonInfo;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkbMirroredSkeletonInfo")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let m_mirrorAxis = match m_mirrorAxis {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("mirrorAxis"),
                );
            }
        };
        let m_bonePairMap = match m_bonePairMap {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("bonePairMap"),
                );
            }
        };
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbMirroredSkeletonInfo {
        fn deserialize<__D>(deserializer: __D) -> core::result::Result<Self, __D::Error>
        where
            __D: _serde::Deserializer<'de>,
        {
            const FIELDS: &[&str] = &["mirrorAxis", "bonePairMap"];
            _serde::Deserializer::deserialize_struct(
                deserializer,
                "hkbMirroredSkeletonInfo",
                FIELDS,
                __hkbMirroredSkeletonInfoVisitor {
                    marker: _serde::__private::PhantomData::<hkbMirroredSkeletonInfo>,
                    lifetime: _serde::__private::PhantomData,
                },
            )

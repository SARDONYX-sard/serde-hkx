...
const _: () = {
    ...
    impl __serde::HavokClass for hkbMirroredSkeletonInfo {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(3334658639u32)
        }
    }
    impl __serde::Serialize for hkbMirroredSkeletonInfo {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(3334658639u32)));

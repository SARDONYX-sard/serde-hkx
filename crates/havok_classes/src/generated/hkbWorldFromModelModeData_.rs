...
pub(super) struct __hkbWorldFromModelModeDataVisitor<'de> {
    marker: core::marker::PhantomData<hkbWorldFromModelModeData>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbWorldFromModelModeDataVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbWorldFromModelModeData, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkbWorldFromModelModeDataVisitor<'de> {
    type Value = hkbWorldFromModelModeData;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkbWorldFromModelModeData")
    }

...
impl<'de> _serde::de::Visitor<'de> for __FieldVisitor {
    ...
    {
        match __value {
            "keyFrameHierarchyControlData" => Ok(__Field::m_keyFrameHierarchyControlData),
...
pub(super) struct __hkbRigidBodyRagdollControlDataVisitor<'de> {
    marker: core::marker::PhantomData<hkbRigidBodyRagdollControlData>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbRigidBodyRagdollControlDataVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbRigidBodyRagdollControlData, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkbRigidBodyRagdollControlDataVisitor<'de> {

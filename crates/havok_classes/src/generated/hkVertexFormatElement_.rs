...
pub(super) struct __hkVertexFormatElementVisitor<'de> {
    marker: core::marker::PhantomData<hkVertexFormatElement>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkVertexFormatElementVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkVertexFormatElement, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkVertexFormatElementVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkVertexFormatElement")
    }

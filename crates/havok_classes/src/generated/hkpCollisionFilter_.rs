...
pub(super) struct __hkpCollisionFilterVisitor<'de> {
    marker: core::marker::PhantomData<hkpCollisionFilter>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpCollisionFilterVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpCollisionFilter, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkpCollisionFilterVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpCollisionFilter")
    }
            ...
            match i {
                ...
                2usize => {
                    if _serde::__private::Option::is_some(&m_postpad) {
                        return _serde::__private::Err(
                            <__A::Error as _serde::de::Error>::duplicate_field("postpad"),
                        );
                    }

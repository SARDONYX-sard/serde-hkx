...
pub struct hkxSparselyAnimatedInt<'a> {
    ...
    #[cfg_attr(feature = "json_schema", schemars(rename = "ints"))]
    #[cfg_attr(feature = "serde", serde(rename = "ints"))]
    pub m_ints: Vec<I32<'a>>,
    /// # C++ Info
...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkxSparselyAnimatedInt<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkxSparselyAnimatedInt<'a> {
            ...
            S: _serde::ser::Serializer,
        {
            ...
            let mut serializer = __serializer
                .serialize_struct("hkxSparselyAnimatedInt", class_meta, (32u64, 48u64))?;
            serializer.pad_field([0u8; 4usize].as_slice(), [0u8; 8usize].as_slice())?;
            serializer.skip_field("memSizeAndFlags", &self.parent.m_memSizeAndFlags)?;
            serializer.skip_field("referenceCount", &self.parent.m_referenceCount)?;
            serializer.pad_field([0u8; 0usize].as_slice(), [0u8; 4usize].as_slice())?;
            serializer.serialize_array_field("ints", &self.m_ints, TypeSize::NonPtr)?;
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkxSparselyAnimatedInt<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkxSparselyAnimatedIntVisitor<'de> {
                marker: _serde::__private::PhantomData<hkxSparselyAnimatedInt<'de>>,
            ...
            impl<'de> _serde::de::Visitor<'de> for __hkxSparselyAnimatedIntVisitor<'de> {
                type Value = hkxSparselyAnimatedInt<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkxAnimatedVector<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkxAnimatedVector<'a> {
            ...
            S: _serde::ser::Serializer,
        {
            ...
            let mut serializer = __serializer
                .serialize_struct("hkxAnimatedVector", class_meta, (24u64, 40u64))?;
            serializer.pad_field([0u8; 4usize].as_slice(), [0u8; 8usize].as_slice())?;
            serializer.skip_field("memSizeAndFlags", &self.parent.m_memSizeAndFlags)?;
            serializer.skip_field("referenceCount", &self.parent.m_referenceCount)?;
            serializer.pad_field([0u8; 0usize].as_slice(), [0u8; 4usize].as_slice())?;
            serializer
                .serialize_array_field("vectors", &self.m_vectors, TypeSize::NonPtr)?;
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkxAnimatedVector<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkxAnimatedVectorVisitor<'de> {
                marker: _serde::__private::PhantomData<hkxAnimatedVector<'de>>,
            ...
            impl<'de> _serde::de::Visitor<'de> for __hkxAnimatedVectorVisitor<'de> {
                type Value = hkxAnimatedVector<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

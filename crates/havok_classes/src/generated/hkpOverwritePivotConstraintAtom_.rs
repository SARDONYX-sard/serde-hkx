...
impl<'de> _serde::de::Visitor<'de> for __FieldVisitor {
    ...
    {
        match __value {
            "copyToPivotBFromPivotA" => Ok(__Field::m_copyToPivotBFromPivotA),
...
pub(super) struct __hkpOverwritePivotConstraintAtomVisitor<'de> {
    marker: core::marker::PhantomData<hkpOverwritePivotConstraintAtom>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpOverwritePivotConstraintAtomVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpOverwritePivotConstraintAtom, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpOverwritePivotConstraintAtomVisitor<'de> {
    type Value = hkpOverwritePivotConstraintAtom;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        for i in 0..1usize {
            match i {
                0usize => {
                    if _serde::__private::Option::is_some(&m_copyToPivotBFromPivotA) {
                    ...
                    m_copyToPivotBFromPivotA = _serde::__private::Some(
        ...
        let m_copyToPivotBFromPivotA = match m_copyToPivotBFromPivotA {
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        for _ in 0..1usize {
            ...
            if let _serde::__private::Some(__key) = __res {
                match __key {
                    __Field::m_copyToPivotBFromPivotA => {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpOverwritePivotConstraintAtom {
        fn deserialize<__D>(deserializer: __D) -> core::result::Result<Self, __D::Error>
        where
            __D: _serde::Deserializer<'de>,
        {
            const FIELDS: &[&str] = &["copyToPivotBFromPivotA"];
            _serde::Deserializer::deserialize_struct(
                deserializer,
                "hkpOverwritePivotConstraintAtom",
                FIELDS,
                __hkpOverwritePivotConstraintAtomVisitor {
                    marker: _serde::__private::PhantomData::<
                        hkpOverwritePivotConstraintAtom,
                    >,
                    lifetime: _serde::__private::PhantomData,

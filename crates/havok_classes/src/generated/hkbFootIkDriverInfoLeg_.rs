...
pub(super) struct __hkbFootIkDriverInfoLegVisitor<'de> {
    marker: core::marker::PhantomData<hkbFootIkDriverInfoLeg>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbFootIkDriverInfoLegVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbFootIkDriverInfoLeg, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkbFootIkDriverInfoLegVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkbFootIkDriverInfoLeg")
    }

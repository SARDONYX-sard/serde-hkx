...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpConstrainedSystemFilter<'a> {
        #[inline]
        ...
        fn deps_indexes(&self) -> Vec<&Pointer<'_>> {
            let mut v = Vec::new();
            v.push(&self.m_otherFilter);
            v
        }
    }
    impl<'a> _serde::Serialize for hkpConstrainedSystemFilter<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpConstrainedSystemFilter<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpConstrainedSystemFilterVisitor<'de> {
                marker: _serde::__private::PhantomData<hkpConstrainedSystemFilter<'de>>,
            ...
            for __hkpConstrainedSystemFilterVisitor<'de> {
                type Value = hkpConstrainedSystemFilter<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    let mut m_otherFilter: _serde::__private::Option<Pointer<'de>> = _serde::__private::None;
                    for i in 0..1usize {
                        match i {
                            0usize => {

...
const _: () = {
    ...
    impl __serde::HavokClass for hkbClipGeneratorEcho {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(1963908928u32)
        }
    }
    impl __serde::Serialize for hkbClipGeneratorEcho {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(1963908928u32)));

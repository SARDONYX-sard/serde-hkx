...
pub(super) struct __hkpConeLimitConstraintAtomVisitor<'de> {
    marker: core::marker::PhantomData<hkpConeLimitConstraintAtom>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpConeLimitConstraintAtomVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpConeLimitConstraintAtom, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpConeLimitConstraintAtomVisitor<'de> {
    type Value = hkpConeLimitConstraintAtom;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpConeLimitConstraintAtom")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let mut m_angleMeasurementMode: _serde::__private::Option<MeasurementMode> = _serde::__private::None;
        ...
        for i in 0..8usize {
            match i {
                ...
                3usize => {
                    if _serde::__private::Option::is_some(&m_angleMeasurementMode) {
                        return _serde::__private::Err(
                            <__A::Error as _serde::de::Error>::duplicate_field(
                ...
                4usize => {
                    if _serde::__private::Option::is_some(&m_memOffsetToAngleOffset) {
                        return _serde::__private::Err(
                            <__A::Error as _serde::de::Error>::duplicate_field(
                                "memOffsetToAngleOffset",
                            ),

    ...
    impl<'a> _serde::Serialize for BSGetTimeStepModifier<'a> {
            ...
            S: _serde::ser::Serializer,
        {
            ...
            let mut serializer = __serializer
                .serialize_struct("BSGetTimeStepModifier", class_meta)?;
...
pub(super) struct __BSGetTimeStepModifierVisitor<'de> {
    marker: core::marker::PhantomData<BSGetTimeStepModifier<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __BSGetTimeStepModifierVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<BSGetTimeStepModifier<'de>, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __BSGetTimeStepModifierVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct BSGetTimeStepModifier")
    }

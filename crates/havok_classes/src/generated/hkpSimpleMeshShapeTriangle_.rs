...
const _: () = {
    ...
    impl _serde::HavokClass for hkpSimpleMeshShapeTriangle {
        #[inline]
        ...
        fn signature(&self) -> _serde::__private::Signature {
            _serde::__private::Signature::new(0xd38738c1)
        }
    }
    impl _serde::Serialize for hkpSimpleMeshShapeTriangle {
            ...
            S: _serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, _serde::__private::Signature::new(0xd38738c1)));
...
pub(super) struct __hkpSimpleMeshShapeTriangleVisitor<'de> {
    marker: core::marker::PhantomData<hkpSimpleMeshShapeTriangle>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpSimpleMeshShapeTriangleVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpSimpleMeshShapeTriangle, __A::Error>
    where
        __A: _serde::de::MapAccess<'de>,
    {
        _serde::de::Visitor::visit_struct(
            Self {
                marker: _serde::__private::PhantomData::<hkpSimpleMeshShapeTriangle>,
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpSimpleMeshShapeTriangleVisitor<'de> {
    type Value = hkpSimpleMeshShapeTriangle;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpSimpleMeshShapeTriangle")
    }
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpSimpleMeshShapeTriangle {
        fn deserialize<__D>(deserializer: __D) -> core::result::Result<Self, __D::Error>
        where
            __D: _serde::Deserializer<'de>,
        {
            const FIELDS: &[&str] = &["a", "b", "c", "weldingInfo"];
            _serde::Deserializer::deserialize_struct(
                deserializer,
                "hkpSimpleMeshShapeTriangle",
                FIELDS,
                __hkpSimpleMeshShapeTriangleVisitor {
                    marker: _serde::__private::PhantomData::<hkpSimpleMeshShapeTriangle>,
                    lifetime: _serde::__private::PhantomData,
                },
            )

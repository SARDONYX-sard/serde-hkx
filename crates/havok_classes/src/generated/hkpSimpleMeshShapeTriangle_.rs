...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpSimpleMeshShapeTriangle<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpSimpleMeshShapeTriangle<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpSimpleMeshShapeTriangle<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpSimpleMeshShapeTriangleVisitor<'de> {
                marker: _serde::__private::PhantomData<hkpSimpleMeshShapeTriangle<'de>>,
            ...
            for __hkpSimpleMeshShapeTriangleVisitor<'de> {
                type Value = hkpSimpleMeshShapeTriangle<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

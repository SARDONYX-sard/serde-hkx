...
const _: () = {
    ...
    impl __serde::HavokClass for hkpTriSampledHeightFieldCollection {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(3264339422u32)
        }
    }
    impl __serde::Serialize for hkpTriSampledHeightFieldCollection {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(3264339422u32)));

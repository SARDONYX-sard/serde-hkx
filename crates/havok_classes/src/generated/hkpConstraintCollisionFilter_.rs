...
const _: () = {
    ...
    impl __serde::HavokClass for hkpConstraintCollisionFilter {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(3283449777u32)
        }
    }
    impl __serde::Serialize for hkpConstraintCollisionFilter {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(3283449777u32)));

...
pub(super) struct __hkpConstraintCollisionFilterVisitor<'de> {
    marker: core::marker::PhantomData<hkpConstraintCollisionFilter>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpConstraintCollisionFilterVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpConstraintCollisionFilter, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpConstraintCollisionFilterVisitor<'de> {
    ...
    {
        let __ptr = __A::class_ptr(&mut __map);
        let parent = __hkpPairCollisionFilterVisitor::visit_as_parent(&mut __map)?;
        for _ in 0..0usize {

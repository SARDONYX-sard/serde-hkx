...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkbDelayedModifierInternalState<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkbDelayedModifierInternalState<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbDelayedModifierInternalState<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkbDelayedModifierInternalStateVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkbDelayedModifierInternalState<'de>,
                >,
            ...
            for __hkbDelayedModifierInternalStateVisitor<'de> {
                type Value = hkbDelayedModifierInternalState<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

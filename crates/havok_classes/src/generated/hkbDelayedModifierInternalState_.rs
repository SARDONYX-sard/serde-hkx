...
pub(super) struct __hkbDelayedModifierInternalStateVisitor<'de> {
    marker: core::marker::PhantomData<hkbDelayedModifierInternalState>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbDelayedModifierInternalStateVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbDelayedModifierInternalState, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkbDelayedModifierInternalStateVisitor<'de> {

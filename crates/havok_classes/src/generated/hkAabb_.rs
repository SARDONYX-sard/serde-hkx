...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkAabb<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkAabb<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkAabb<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkAabbVisitor<'de> {
                marker: _serde::__private::PhantomData<hkAabb<'de>>,

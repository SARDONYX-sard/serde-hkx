...
const _: () = {
    ...
    impl __serde::HavokClass for hkaKeyFrameHierarchyUtility {
        #[inline]
    ...
    impl __serde::Serialize for hkaKeyFrameHierarchyUtility {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(2077607535u32)));

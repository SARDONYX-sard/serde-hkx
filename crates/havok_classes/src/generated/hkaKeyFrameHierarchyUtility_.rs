...
pub(super) struct __hkaKeyFrameHierarchyUtilityVisitor<'de> {
    marker: core::marker::PhantomData<hkaKeyFrameHierarchyUtility>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkaKeyFrameHierarchyUtilityVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkaKeyFrameHierarchyUtility, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkaKeyFrameHierarchyUtilityVisitor<'de> {
    ...
    impl<'de> _serde::Deserialize<'de> for hkaKeyFrameHierarchyUtility {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            _serde::Deserializer::deserialize_struct(
                ...
                "hkaKeyFrameHierarchyUtility",
                FIELDS,
                __hkaKeyFrameHierarchyUtilityVisitor {

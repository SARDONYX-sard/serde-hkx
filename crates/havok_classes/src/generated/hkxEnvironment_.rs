...
pub(super) struct __hkxEnvironmentVisitor<'de> {
    marker: core::marker::PhantomData<hkxEnvironment<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkxEnvironmentVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkxEnvironment<'de>, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkxEnvironmentVisitor<'de> {
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let m_variables = match m_variables {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("variables"),
                );
            }
        };

...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpMultithreadedVehicleManager<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpMultithreadedVehicleManager<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpMultithreadedVehicleManager<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpMultithreadedVehicleManagerVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkpMultithreadedVehicleManager<'de>,
                >,
            ...
            for __hkpMultithreadedVehicleManagerVisitor<'de> {
                type Value = hkpMultithreadedVehicleManager<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

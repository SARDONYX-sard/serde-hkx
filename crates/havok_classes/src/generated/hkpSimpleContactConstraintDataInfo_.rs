...
const _: () = {
    ...
    impl __serde::HavokClass for hkpSimpleContactConstraintDataInfo {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(3046971188u32)
        }
    }
    impl __serde::Serialize for hkpSimpleContactConstraintDataInfo {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(3046971188u32)));

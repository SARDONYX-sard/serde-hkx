...
pub(super) struct __hkbGetUpModifierInternalStateVisitor<'de> {
    marker: core::marker::PhantomData<hkbGetUpModifierInternalState>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbGetUpModifierInternalStateVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbGetUpModifierInternalState, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkbGetUpModifierInternalStateVisitor<'de> {

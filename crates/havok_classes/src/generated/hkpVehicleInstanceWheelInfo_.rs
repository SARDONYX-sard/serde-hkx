...
pub struct hkpVehicleInstanceWheelInfo<'a> {
    ...
    pub m_contactPoint: hkContactPoint<'a>,
    /// # C++ Info
...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpVehicleInstanceWheelInfo<'a> {
        #[inline]
        ...
        fn deps_indexes(&self) -> Vec<&Pointer<'_>> {
            let mut v = Vec::new();
            v.extend(self.m_contactPoint.deps_indexes());
            v.push(&self.m_contactBody);
            v
        }
    }
    impl<'a> _serde::Serialize for hkpVehicleInstanceWheelInfo<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpVehicleInstanceWheelInfo<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpVehicleInstanceWheelInfoVisitor<'de> {
                marker: _serde::__private::PhantomData<hkpVehicleInstanceWheelInfo<'de>>,
            ...
            for __hkpVehicleInstanceWheelInfoVisitor<'de> {
                type Value = hkpVehicleInstanceWheelInfo<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    let mut m_contactBody: _serde::__private::Option<Pointer<'de>> = _serde::__private::None;

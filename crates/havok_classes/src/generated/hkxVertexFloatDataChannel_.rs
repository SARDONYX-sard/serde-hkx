...
pub(super) struct __hkxVertexFloatDataChannelVisitor<'de> {
    marker: core::marker::PhantomData<hkxVertexFloatDataChannel>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkxVertexFloatDataChannelVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkxVertexFloatDataChannel, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkxVertexFloatDataChannelVisitor<'de> {
    type Value = hkxVertexFloatDataChannel;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkxVertexFloatDataChannel")
    }

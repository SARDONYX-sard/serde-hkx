...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkxVertexFloatDataChannel<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkxVertexFloatDataChannel<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkxVertexFloatDataChannel<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkxVertexFloatDataChannelVisitor<'de> {
                marker: _serde::__private::PhantomData<hkxVertexFloatDataChannel<'de>>,
            ...
            for __hkxVertexFloatDataChannelVisitor<'de> {
                type Value = hkxVertexFloatDataChannel<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

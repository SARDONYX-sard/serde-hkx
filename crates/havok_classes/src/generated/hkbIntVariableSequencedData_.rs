...
pub(super) struct __hkbIntVariableSequencedDataVisitor<'de> {
    marker: core::marker::PhantomData<hkbIntVariableSequencedData>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbIntVariableSequencedDataVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbIntVariableSequencedData, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkbIntVariableSequencedDataVisitor<'de> {

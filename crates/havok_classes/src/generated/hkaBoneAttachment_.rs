...
pub(super) struct __hkaBoneAttachmentVisitor<'de> {
    marker: core::marker::PhantomData<hkaBoneAttachment<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkaBoneAttachmentVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkaBoneAttachment<'de>, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkaBoneAttachmentVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkaBoneAttachment")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        for i in 0..5usize {
            match i {
                ...
                1usize => {
                    if _serde::__private::Option::is_some(&m_boneFromAttachment) {
                        return _serde::__private::Err(
                            <__A::Error as _serde::de::Error>::duplicate_field(
                                "boneFromAttachment",
                            ),

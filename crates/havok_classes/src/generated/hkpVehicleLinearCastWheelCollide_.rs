...
const _: () = {
    ...
    impl __serde::HavokClass for hkpVehicleLinearCastWheelCollide {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(3314784720u32)
        }
    }
    impl __serde::Serialize for hkpVehicleLinearCastWheelCollide {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(3314784720u32)));

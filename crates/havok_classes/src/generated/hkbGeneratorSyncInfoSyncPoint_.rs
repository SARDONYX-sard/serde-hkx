...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkbGeneratorSyncInfoSyncPoint<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkbGeneratorSyncInfoSyncPoint<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbGeneratorSyncInfoSyncPoint<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkbGeneratorSyncInfoSyncPointVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkbGeneratorSyncInfoSyncPoint<'de>,
                >,
            ...
            for __hkbGeneratorSyncInfoSyncPointVisitor<'de> {
                type Value = hkbGeneratorSyncInfoSyncPoint<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

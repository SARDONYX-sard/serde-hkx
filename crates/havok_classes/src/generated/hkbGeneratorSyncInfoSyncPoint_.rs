...
pub(super) struct __hkbGeneratorSyncInfoSyncPointVisitor<'de> {
    marker: core::marker::PhantomData<hkbGeneratorSyncInfoSyncPoint>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbGeneratorSyncInfoSyncPointVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbGeneratorSyncInfoSyncPoint, __A::Error>
    where
        __A: _serde::de::MapAccess<'de>,
    {
        _serde::de::Visitor::visit_struct(
            Self {
                marker: _serde::__private::PhantomData::<hkbGeneratorSyncInfoSyncPoint>,
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkbGeneratorSyncInfoSyncPointVisitor<'de> {
    type Value = hkbGeneratorSyncInfoSyncPoint;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        _serde::__private::Ok(hkbGeneratorSyncInfoSyncPoint {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbGeneratorSyncInfoSyncPoint {
        fn deserialize<__D>(deserializer: __D) -> core::result::Result<Self, __D::Error>
        where
            __D: _serde::Deserializer<'de>,
        {
            const FIELDS: &[&str] = &["id", "time"];
            _serde::Deserializer::deserialize_struct(
                deserializer,
                "hkbGeneratorSyncInfoSyncPoint",
                FIELDS,
                __hkbGeneratorSyncInfoSyncPointVisitor {

...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkbModifierWrapper<'a> {
        #[inline]
...
pub(super) struct __hkbModifierWrapperVisitor<'de> {
    marker: core::marker::PhantomData<hkbModifierWrapper<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbModifierWrapperVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbModifierWrapper<'de>, __A::Error>
    where
        __A: _serde::de::MapAccess<'de>,
    {
        _serde::de::Visitor::visit_struct(
            Self {
                marker: _serde::__private::PhantomData::<hkbModifierWrapper<'de>>,
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkbModifierWrapperVisitor<'de> {
    type Value = hkbModifierWrapper<'de>;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkbModifierWrapper")
    }
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbModifierWrapper<'de> {
        fn deserialize<__D>(deserializer: __D) -> core::result::Result<Self, __D::Error>
        where
            __D: _serde::Deserializer<'de>,
        {
            const FIELDS: &[&str] = &["modifier"];
            _serde::Deserializer::deserialize_struct(
                deserializer,
                "hkbModifierWrapper",
                FIELDS,
                __hkbModifierWrapperVisitor {
                    marker: _serde::__private::PhantomData::<hkbModifierWrapper>,
                    lifetime: _serde::__private::PhantomData,
                },
            )
        }

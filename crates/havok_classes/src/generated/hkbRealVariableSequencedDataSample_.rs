...
pub(super) struct __hkbRealVariableSequencedDataSampleVisitor<'de> {
    marker: core::marker::PhantomData<hkbRealVariableSequencedDataSample>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbRealVariableSequencedDataSampleVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbRealVariableSequencedDataSample, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkbRealVariableSequencedDataSampleVisitor<'de> {
    type Value = hkbRealVariableSequencedDataSample;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let mut m_value: _serde::__private::Option<f32> = _serde::__private::None;
        for i in 0..2usize {
            match i {
                0usize => {
        ...
        _serde::__private::Ok(hkbRealVariableSequencedDataSample {
            __ptr,
            m_time,
            m_value,
        })
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbRealVariableSequencedDataSample {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            _serde::Deserializer::deserialize_struct(
                ...
                "hkbRealVariableSequencedDataSample",
                FIELDS,
                __hkbRealVariableSequencedDataSampleVisitor {
                    marker: _serde::__private::PhantomData::<
                        hkbRealVariableSequencedDataSample,
                    >,
                    lifetime: _serde::__private::PhantomData,

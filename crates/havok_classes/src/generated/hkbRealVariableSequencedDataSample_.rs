...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkbRealVariableSequencedDataSample<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkbRealVariableSequencedDataSample<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbRealVariableSequencedDataSample<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkbRealVariableSequencedDataSampleVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkbRealVariableSequencedDataSample<'de>,
                >,
            ...
            for __hkbRealVariableSequencedDataSampleVisitor<'de> {
                type Value = hkbRealVariableSequencedDataSample<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

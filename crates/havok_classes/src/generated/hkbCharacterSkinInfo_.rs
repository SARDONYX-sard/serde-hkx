...
const _: () = {
    ...
    impl __serde::HavokClass for hkbCharacterSkinInfo {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(403542029u32)
        }
    }
    impl __serde::Serialize for hkbCharacterSkinInfo {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(403542029u32)));

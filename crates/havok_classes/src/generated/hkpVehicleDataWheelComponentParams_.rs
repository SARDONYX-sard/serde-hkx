...
const _: () = {
    ...
    impl __serde::HavokClass for hkpVehicleDataWheelComponentParams {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(2197700832u32)
        }
    }
    impl __serde::Serialize for hkpVehicleDataWheelComponentParams {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(2197700832u32)));

...
pub(super) struct __hkMonitorStreamStringMapStringMapVisitor<'de> {
    marker: core::marker::PhantomData<hkMonitorStreamStringMapStringMap<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkMonitorStreamStringMapStringMapVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkMonitorStreamStringMapStringMap<'de>, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkMonitorStreamStringMapStringMapVisitor<'de> {

...
pub(super) struct __hkDocumentationAttributeVisitor<'de> {
    marker: core::marker::PhantomData<hkDocumentationAttribute<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkDocumentationAttributeVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkDocumentationAttribute<'de>, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkDocumentationAttributeVisitor<'de> {
    type Value = hkDocumentationAttribute<'de>;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkDocumentationAttribute")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let m_docsSectionTag = match m_docsSectionTag {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("docsSectionTag"),
                );
            }
        };

...
pub struct hkpSetLocalTransformsConstraintAtom<'a> {
    ...
    #[cfg_attr(feature = "json_schema", schemars(rename = "transformA"))]
    #[cfg_attr(feature = "serde", serde(rename = "transformA"))]
    pub m_transformA: Transform,
    /// # C++ Info
    /// - name: `transformB`(ctype: `hkTransform`)
    /// - offset: ` 80`(x86)/` 80`(x86_64)
    /// - type_size: ` 64`(x86)/` 64`(x86_64)
    #[cfg_attr(feature = "json_schema", schemars(rename = "transformB"))]
    #[cfg_attr(feature = "serde", serde(rename = "transformB"))]
    pub m_transformB: Transform,
}
const _: () = {
    use havok_serde as _serde;
    impl<'a> _serde::HavokClass for hkpSetLocalTransformsConstraintAtom<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpSetLocalTransformsConstraintAtom<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpSetLocalTransformsConstraintAtom<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            for __hkpSetLocalTransformsConstraintAtomVisitor<'de> {
                type Value = hkpSetLocalTransformsConstraintAtom<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

...
pub(super) struct __hkpSetLocalTransformsConstraintAtomVisitor<'de> {
    marker: core::marker::PhantomData<hkpSetLocalTransformsConstraintAtom>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpSetLocalTransformsConstraintAtomVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpSetLocalTransformsConstraintAtom, __A::Error>
    where
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let m_transformA = match m_transformA {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("transformA"),
                );
            }
        };
        let m_transformB = match m_transformB {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("transformB"),
                );
            }
        };

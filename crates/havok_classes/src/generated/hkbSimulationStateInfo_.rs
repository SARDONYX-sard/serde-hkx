...
const _: () = {
    ...
    impl __serde::HavokClass for hkbSimulationStateInfo {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(2751996596u32)
        }
    }
    impl __serde::Serialize for hkbSimulationStateInfo {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(2751996596u32)));

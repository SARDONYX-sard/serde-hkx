...
const _: () = {
    ...
    impl __serde::HavokClass for hkpPointToPlaneConstraintData {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(1707437591u32)
        }
    }
    impl __serde::Serialize for hkpPointToPlaneConstraintData {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(1707437591u32)));

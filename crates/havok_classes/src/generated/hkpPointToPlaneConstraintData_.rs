...
pub struct hkpPointToPlaneConstraintData<'a> {
    ...
    pub m_atoms: hkpPointToPlaneConstraintDataAtoms<'a>,
}
const _: () = {
    use havok_serde as _serde;
    impl<'a> _serde::HavokClass for hkpPointToPlaneConstraintData<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpPointToPlaneConstraintData<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpPointToPlaneConstraintData<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpPointToPlaneConstraintDataVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkpPointToPlaneConstraintData<'de>,
                >,
            ...
            for __hkpPointToPlaneConstraintDataVisitor<'de> {
                type Value = hkpPointToPlaneConstraintData<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

...
pub struct hkpHingeConstraintData<'a> {
    ...
    pub m_atoms: hkpHingeConstraintDataAtoms<'a>,
}
const _: () = {
    use havok_serde as _serde;
    impl<'a> _serde::HavokClass for hkpHingeConstraintData<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpHingeConstraintData<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpHingeConstraintData<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpHingeConstraintDataVisitor<'de> {
                marker: _serde::__private::PhantomData<hkpHingeConstraintData<'de>>,
            ...
            impl<'de> _serde::de::Visitor<'de> for __hkpHingeConstraintDataVisitor<'de> {
                type Value = hkpHingeConstraintData<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

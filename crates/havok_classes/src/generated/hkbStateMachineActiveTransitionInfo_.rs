...
const _: () = {
    ...
    impl __serde::HavokClass for hkbStateMachineActiveTransitionInfo {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(3146831183u32)
        }
    }
    impl __serde::Serialize for hkbStateMachineActiveTransitionInfo {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(3146831183u32)));

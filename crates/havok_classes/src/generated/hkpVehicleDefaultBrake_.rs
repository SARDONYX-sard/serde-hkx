...
const _: () = {
    ...
    impl __serde::HavokClass for hkpVehicleDefaultBrake {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(1263503382u32)
        }
    }
    impl __serde::Serialize for hkpVehicleDefaultBrake {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(1263503382u32)));

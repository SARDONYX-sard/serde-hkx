...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpVehicleDefaultBrake<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpVehicleDefaultBrake<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpVehicleDefaultBrake<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpVehicleDefaultBrakeVisitor<'de> {
                marker: _serde::__private::PhantomData<hkpVehicleDefaultBrake<'de>>,
            ...
            impl<'de> _serde::de::Visitor<'de> for __hkpVehicleDefaultBrakeVisitor<'de> {
                type Value = hkpVehicleDefaultBrake<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

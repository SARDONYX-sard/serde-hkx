...
const _: () = {
    ...
    impl __serde::HavokClass for hkMultipleVertexBuffer {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(3728389634u32)
        }
    }
    impl __serde::Serialize for hkMultipleVertexBuffer {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(3728389634u32)));

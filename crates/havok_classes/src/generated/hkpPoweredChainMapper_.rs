...
const _: () = {
    ...
    impl _serde::HavokClass for hkpPoweredChainMapper {
        #[inline]
    ...
    impl _serde::Serialize for hkpPoweredChainMapper {
...
pub(super) struct __hkpPoweredChainMapperVisitor<'de> {
    marker: core::marker::PhantomData<hkpPoweredChainMapper>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpPoweredChainMapperVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpPoweredChainMapper, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkpPoweredChainMapperVisitor<'de> {
    type Value = hkpPoweredChainMapper;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpPoweredChainMapper")
    }
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpPoweredChainMapper {

...
pub struct hkpConstraintChainData<'a> {
...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpConstraintChainData<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpConstraintChainData<'a> {
            ...
            S: _serde::ser::Serializer,
        {
            ...
            let mut serializer = __serializer
                .serialize_struct("hkpConstraintChainData", class_meta, (12u64, 24u64))?;
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpConstraintChainData<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpConstraintChainDataVisitor<'de> {
                marker: _serde::__private::PhantomData<hkpConstraintChainData<'de>>,
            ...
            impl<'de> _serde::de::Visitor<'de> for __hkpConstraintChainDataVisitor<'de> {
                type Value = hkpConstraintChainData<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

...
pub(super) struct __hkMonitorStreamColorTableColorPairVisitor<'de> {
    marker: core::marker::PhantomData<hkMonitorStreamColorTableColorPair<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkMonitorStreamColorTableColorPairVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkMonitorStreamColorTableColorPair<'de>, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkMonitorStreamColorTableColorPairVisitor<'de> {
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let m_colorName = match m_colorName {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("colorName"),
                );
            }
        };

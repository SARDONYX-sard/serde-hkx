...
const _: () = {
    ...
    impl _serde::HavokClass for hkbBehaviorGraphInternalState {
        ...
        fn signature(&self) -> _serde::__private::Signature {
            _serde::__private::Signature::new(0x8699b6eb)
        }
    }
...
pub(super) struct __hkbBehaviorGraphInternalStateVisitor<'de> {
    marker: core::marker::PhantomData<hkbBehaviorGraphInternalState>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbBehaviorGraphInternalStateVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbBehaviorGraphInternalState, __A::Error>
    where
        __A: _serde::de::MapAccess<'de>,
    {
        _serde::de::Visitor::visit_struct(
            Self {
                marker: _serde::__private::PhantomData::<hkbBehaviorGraphInternalState>,
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkbBehaviorGraphInternalStateVisitor<'de> {
    type Value = hkbBehaviorGraphInternalState;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        for i in 0..2usize {
            match i {
                0usize => {
                    if _serde::__private::Option::is_some(&m_nodeInternalStateInfos) {
                    ...
                    m_nodeInternalStateInfos = _serde::__private::Some(
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbBehaviorGraphInternalState {
        fn deserialize<__D>(deserializer: __D) -> core::result::Result<Self, __D::Error>
        where
            __D: _serde::Deserializer<'de>,
        {
            const FIELDS: &[&str] = &["nodeInternalStateInfos", "variableValueSet"];
            _serde::Deserializer::deserialize_struct(
                deserializer,
                "hkbBehaviorGraphInternalState",
                FIELDS,
                __hkbBehaviorGraphInternalStateVisitor {

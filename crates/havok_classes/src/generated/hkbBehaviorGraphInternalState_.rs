...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkbBehaviorGraphInternalState<'a> {
        #[inline]
        ...
        fn deps_indexes(&self) -> Vec<&Pointer<'_>> {
            let mut v = Vec::new();
            v.extend(self.m_nodeInternalStateInfos.iter());
            v.push(&self.m_variableValueSet);
            v
        }
    }
    impl<'a> _serde::Serialize for hkbBehaviorGraphInternalState<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbBehaviorGraphInternalState<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkbBehaviorGraphInternalStateVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkbBehaviorGraphInternalState<'de>,
                >,
            ...
            for __hkbBehaviorGraphInternalStateVisitor<'de> {
                type Value = hkbBehaviorGraphInternalState<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

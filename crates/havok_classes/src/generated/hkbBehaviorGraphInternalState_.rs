...
const _: () = {
    ...
    impl __serde::HavokClass for hkbBehaviorGraphInternalState {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(2258220779u32)
        }
    }
    impl __serde::Serialize for hkbBehaviorGraphInternalState {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(2258220779u32)));

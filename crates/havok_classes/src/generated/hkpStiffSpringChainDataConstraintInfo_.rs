...
const _: () = {
    ...
    impl __serde::HavokClass for hkpStiffSpringChainDataConstraintInfo {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(3324289408u32)
        }
    }
    impl __serde::Serialize for hkpStiffSpringChainDataConstraintInfo {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(3324289408u32)));

...
pub(super) struct __hkMemoryMeshVertexBufferVisitor<'de> {
    marker: core::marker::PhantomData<hkMemoryMeshVertexBuffer>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkMemoryMeshVertexBufferVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkMemoryMeshVertexBuffer, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkMemoryMeshVertexBufferVisitor<'de> {
    type Value = hkMemoryMeshVertexBuffer;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkMemoryMeshVertexBuffer")
    }

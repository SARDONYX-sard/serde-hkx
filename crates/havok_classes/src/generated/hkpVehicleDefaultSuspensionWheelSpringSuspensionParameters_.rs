...
const _: () = {
    ...
    for hkpVehicleDefaultSuspensionWheelSpringSuspensionParameters<'a> {
        #[inline]
...
const _: () = {
    ...
    for hkpVehicleDefaultSuspensionWheelSpringSuspensionParameters<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            > {
                marker: _serde::__private::PhantomData<
                    hkpVehicleDefaultSuspensionWheelSpringSuspensionParameters<'de>,
                >,

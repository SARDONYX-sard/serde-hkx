...
pub struct hkpBinaryAction<'a> {
    ...
    #[cfg_attr(feature = "json_schema", schemars(rename = "entityA"))]
    #[cfg_attr(feature = "serde", serde(rename = "entityA"))]
    pub m_entityA: Pointer<'a>,
    /// # C++ Info
    /// - name: `entityB`(ctype: `struct hkpEntity*`)
    /// - offset: ` 28`(x86)/` 56`(x86_64)
    /// - type_size: `  4`(x86)/`  8`(x86_64)
    #[cfg_attr(feature = "json_schema", schemars(rename = "entityB"))]
    #[cfg_attr(feature = "serde", serde(rename = "entityB"))]
    pub m_entityB: Pointer<'a>,
}
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpBinaryAction<'a> {
        ...
        fn deps_indexes(&self) -> Vec<&Pointer<'_>> {
            ...
            v.push(&self.m_entityA);
            v.push(&self.m_entityB);
            v
        }
    }
    impl<'a> _serde::Serialize for hkpBinaryAction<'a> {
            ...
            S: _serde::ser::Serializer,
        {
            ...
            let mut serializer = __serializer
                .serialize_struct("hkpBinaryAction", class_meta, (32u64, 64u64))?;
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpBinaryAction<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpBinaryActionVisitor<'de> {
            ...
            impl<'de> _serde::de::Visitor<'de> for __hkpBinaryActionVisitor<'de> {
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    let mut m_entityA: _serde::__private::Option<Pointer<'de>> = _serde::__private::None;
                    let mut m_entityB: _serde::__private::Option<Pointer<'de>> = _serde::__private::None;
                    for i in 0..2usize {
                        match i {
                            0usize => {

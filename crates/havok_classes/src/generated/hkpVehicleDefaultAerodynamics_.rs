...
pub(super) struct __hkpVehicleDefaultAerodynamicsVisitor<'de> {
    marker: core::marker::PhantomData<hkpVehicleDefaultAerodynamics>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpVehicleDefaultAerodynamicsVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpVehicleDefaultAerodynamics, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpVehicleDefaultAerodynamicsVisitor<'de> {
    ...
    {
        let __ptr = __A::class_ptr(&mut __map);
        let parent = __hkpVehicleAerodynamicsVisitor::visit_as_parent(&mut __map)?;
        let mut m_airDensity: _serde::__private::Option<f32> = _serde::__private::None;
        let mut m_frontalArea: _serde::__private::Option<f32> = _serde::__private::None;
        let mut m_dragCoefficient: _serde::__private::Option<f32> = _serde::__private::None;
        let mut m_liftCoefficient: _serde::__private::Option<f32> = _serde::__private::None;

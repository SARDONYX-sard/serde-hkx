...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkbSetWorldFromModelModifier<'a> {
        #[inline]
        ...
        fn signature(&self) -> _serde::__private::Signature {
            _serde::__private::Signature::new(0xafcfa211)
        }
    }
    impl<'a> _serde::Serialize for hkbSetWorldFromModelModifier<'a> {
            ...
            S: _serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, _serde::__private::Signature::new(0xafcfa211)));
            let mut serializer = __serializer
                .serialize_struct("hkbSetWorldFromModelModifier", class_meta)?;
            ...
            serializer.serialize_field("setTranslation", &self.m_setTranslation)?;
            serializer.serialize_field("setRotation", &self.m_setRotation)?;
...
impl<'de> _serde::de::Visitor<'de> for __FieldVisitor {
        ...
        __E: _serde::de::Error,
    {
        match __value {
            ...
            "setTranslation" => Ok(__Field::m_setTranslation),
            "setRotation" => Ok(__Field::m_setRotation),
...
pub(super) struct __hkbSetWorldFromModelModifierVisitor<'de> {
    marker: core::marker::PhantomData<hkbSetWorldFromModelModifier<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbSetWorldFromModelModifierVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbSetWorldFromModelModifier<'de>, __A::Error>
    where
        ...
        _serde::de::Visitor::visit_struct(
            Self {
                marker: _serde::__private::PhantomData::<
                    hkbSetWorldFromModelModifier<'de>,
                >,
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkbSetWorldFromModelModifierVisitor<'de> {
    type Value = hkbSetWorldFromModelModifier<'de>;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        for i in 0..4usize {
            match i {
                ...
                2usize => {
                    if _serde::__private::Option::is_some(&m_setTranslation) {
                        return _serde::__private::Err(
                            <__A::Error as _serde::de::Error>::duplicate_field(
                                "setTranslation",
                            ),
                    ...
                    m_setTranslation = _serde::__private::Some(
                ...
                3usize => {
                    if _serde::__private::Option::is_some(&m_setRotation) {
                        return _serde::__private::Err(
                            <__A::Error as _serde::de::Error>::duplicate_field(
                                "setRotation",
                            ),
                    ...
                    m_setRotation = _serde::__private::Some(
                        match __A::next_value::<bool>(&mut __map) {
                            _serde::__private::Ok(__val) => __val,
                            _serde::__private::Err(__err) => {
                                return _serde::__private::Err(__err);
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbSetWorldFromModelModifier<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            _serde::Deserializer::deserialize_struct(
                ...
                "hkbSetWorldFromModelModifier",
                FIELDS,
                __hkbSetWorldFromModelModifierVisitor {
                    marker: _serde::__private::PhantomData::<
                        hkbSetWorldFromModelModifier,
                    >,
                    lifetime: _serde::__private::PhantomData,

...
const _: () = {
    ...
    impl _serde::HavokClass for hkbBoneIndexArray {
        #[inline]
...
impl<'de> _serde::de::Visitor<'de> for __FieldVisitor {
    ...
    {
        match __value {
            "boneIndices" => Ok(__Field::m_boneIndices),
...
pub(super) struct __hkbBoneIndexArrayVisitor<'de> {
    marker: core::marker::PhantomData<hkbBoneIndexArray>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbBoneIndexArrayVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbBoneIndexArray, __A::Error>
    where
        __A: _serde::de::MapAccess<'de>,
    {
        _serde::de::Visitor::visit_struct(
            Self {
                marker: _serde::__private::PhantomData::<hkbBoneIndexArray>,
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkbBoneIndexArrayVisitor<'de> {
    type Value = hkbBoneIndexArray;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkbBoneIndexArray")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        for i in 0..1usize {
            match i {
                0usize => {
                    if _serde::__private::Option::is_some(&m_boneIndices) {
                    ...
                    m_boneIndices = _serde::__private::Some(
        ...
        let m_boneIndices = match m_boneIndices {
            _serde::__private::Some(__field) => __field,
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("boneIndices"),
                );
            }
        };
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbBoneIndexArray {
        fn deserialize<__D>(deserializer: __D) -> core::result::Result<Self, __D::Error>
        where
            __D: _serde::Deserializer<'de>,
        {
            const FIELDS: &[&str] = &["boneIndices"];
            _serde::Deserializer::deserialize_struct(
                deserializer,
                "hkbBoneIndexArray",
                FIELDS,
                __hkbBoneIndexArrayVisitor {
                    marker: _serde::__private::PhantomData::<hkbBoneIndexArray>,
                    lifetime: _serde::__private::PhantomData,
                },
            )

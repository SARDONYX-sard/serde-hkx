...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkbBoneIndexArray<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkbBoneIndexArray<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbBoneIndexArray<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkbBoneIndexArrayVisitor<'de> {
                marker: _serde::__private::PhantomData<hkbBoneIndexArray<'de>>,
            ...
            impl<'de> _serde::de::Visitor<'de> for __hkbBoneIndexArrayVisitor<'de> {
                type Value = hkbBoneIndexArray<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    let mut m_boneIndices: _serde::__private::Option<Vec<I16<'de>>> = _serde::__private::None;
                    for i in 0..1usize {
                        match i {
                            0usize => {

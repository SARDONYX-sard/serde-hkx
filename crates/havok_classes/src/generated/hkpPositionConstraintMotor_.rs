...
const _: () = {
    ...
    impl __serde::HavokClass for hkpPositionConstraintMotor {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(1955574531u32)
        }
    }
    impl __serde::Serialize for hkpPositionConstraintMotor {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(1955574531u32)));

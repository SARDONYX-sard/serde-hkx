...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpPositionConstraintMotor<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpPositionConstraintMotor<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpPositionConstraintMotor<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpPositionConstraintMotorVisitor<'de> {
                marker: _serde::__private::PhantomData<hkpPositionConstraintMotor<'de>>,
            ...
            for __hkpPositionConstraintMotorVisitor<'de> {
                type Value = hkpPositionConstraintMotor<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

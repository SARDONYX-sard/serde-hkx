...
const _: () = {
    ...
    impl __serde::HavokClass for hkbBehaviorGraphData {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(156944989u32)
        }
    }
    impl __serde::Serialize for hkbBehaviorGraphData {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(156944989u32)));

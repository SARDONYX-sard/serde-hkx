...
const _: () = {
    ...
    impl _serde::HavokClass for hkpSpringDamperConstraintMotor {
        #[inline]
        ...
        fn signature(&self) -> _serde::__private::Signature {
            _serde::__private::Signature::new(0x7ead26f6)
        }
    }
    impl _serde::Serialize for hkpSpringDamperConstraintMotor {
            ...
            S: _serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, _serde::__private::Signature::new(0x7ead26f6)));
...
pub(super) struct __hkpSpringDamperConstraintMotorVisitor<'de> {
    marker: core::marker::PhantomData<hkpSpringDamperConstraintMotor>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpSpringDamperConstraintMotorVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpSpringDamperConstraintMotor, __A::Error>
    where
        __A: _serde::de::MapAccess<'de>,
    {
        _serde::de::Visitor::visit_struct(
            Self {
                marker: _serde::__private::PhantomData::<hkpSpringDamperConstraintMotor>,
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpSpringDamperConstraintMotorVisitor<'de> {
    type Value = hkpSpringDamperConstraintMotor;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        ...
        for i in 0..2usize {
            match i {
                0usize => {
                    ...
                    m_springConstant = _serde::__private::Some(
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpSpringDamperConstraintMotor {
        fn deserialize<__D>(deserializer: __D) -> core::result::Result<Self, __D::Error>
        where
            __D: _serde::Deserializer<'de>,
        {
            const FIELDS: &[&str] = &["springConstant", "springDamping"];
            _serde::Deserializer::deserialize_struct(
                deserializer,
                "hkpSpringDamperConstraintMotor",
                FIELDS,
                __hkpSpringDamperConstraintMotorVisitor {

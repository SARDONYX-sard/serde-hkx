...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpSpringDamperConstraintMotor<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpSpringDamperConstraintMotor<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpSpringDamperConstraintMotor<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpSpringDamperConstraintMotorVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkpSpringDamperConstraintMotor<'de>,
                >,
            ...
            for __hkpSpringDamperConstraintMotorVisitor<'de> {
                type Value = hkpSpringDamperConstraintMotor<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

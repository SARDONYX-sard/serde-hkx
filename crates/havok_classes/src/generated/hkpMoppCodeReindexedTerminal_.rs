...
pub(super) struct __hkpMoppCodeReindexedTerminalVisitor<'de> {
    marker: core::marker::PhantomData<hkpMoppCodeReindexedTerminal>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpMoppCodeReindexedTerminalVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpMoppCodeReindexedTerminal, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpMoppCodeReindexedTerminalVisitor<'de> {
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let m_origShapeKey = match m_origShapeKey {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("origShapeKey"),
                );
            }
        };
        let m_reindexedShapeKey = match m_reindexedShapeKey {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("reindexedShapeKey"),
                );
            }
        };

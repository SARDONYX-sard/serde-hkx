...
const _: () = {
    ...
    impl __serde::HavokClass for hkbCompiledExpressionSet {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(981300940u32)
        }
    }
    impl __serde::Serialize for hkbCompiledExpressionSet {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(981300940u32)));

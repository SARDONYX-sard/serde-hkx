...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkbCompiledExpressionSet<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkbCompiledExpressionSet<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbCompiledExpressionSet<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkbCompiledExpressionSetVisitor<'de> {
                marker: _serde::__private::PhantomData<hkbCompiledExpressionSet<'de>>,
            ...
            for __hkbCompiledExpressionSetVisitor<'de> {
                type Value = hkbCompiledExpressionSet<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    let mut m_expressionToRpnIndex: _serde::__private::Option<
                        Vec<I32<'de>>,
                    > = _serde::__private::None;
                    let mut m_numExpressions: _serde::__private::Option<I8<'de>> = _serde::__private::None;
                    for i in 0..3usize {
                        match i {
                            0usize => {

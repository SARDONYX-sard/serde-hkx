...
const _: () = {
    ...
    impl _serde::HavokClass for hkpThinBoxMotion {
        #[inline]
    ...
    impl _serde::Serialize for hkpThinBoxMotion {
...
pub(super) struct __hkpThinBoxMotionVisitor<'de> {
    marker: core::marker::PhantomData<hkpThinBoxMotion>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpThinBoxMotionVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpThinBoxMotion, __A::Error>
    where
        __A: _serde::de::MapAccess<'de>,
    {
        _serde::de::Visitor::visit_struct(
            Self {
                marker: _serde::__private::PhantomData::<hkpThinBoxMotion>,
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpThinBoxMotionVisitor<'de> {
    type Value = hkpThinBoxMotion;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpThinBoxMotion")
    }
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpThinBoxMotion {

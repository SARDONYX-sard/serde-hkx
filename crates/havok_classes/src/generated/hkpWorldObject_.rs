...
pub(super) struct __hkpWorldObjectVisitor<'de> {
    marker: core::marker::PhantomData<hkpWorldObject<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpWorldObjectVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpWorldObject<'de>, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkpWorldObjectVisitor<'de> {
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let mut m_collidable: _serde::__private::Option<hkpLinkedCollidable> = _serde::__private::None;

...
pub(super) struct __hkTraceStreamTitleVisitor<'de> {
    marker: core::marker::PhantomData<hkTraceStreamTitle>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkTraceStreamTitleVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkTraceStreamTitle, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkTraceStreamTitleVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkTraceStreamTitle")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let mut m_value: _serde::__private::Option<[char; 32usize]> = _serde::__private::None;
        for i in 0..1usize {
            match i {
                0usize => {
                    ...
                    m_value = _serde::__private::Some(
                        match __A::next_value::<[char; 32usize]>(&mut __map) {

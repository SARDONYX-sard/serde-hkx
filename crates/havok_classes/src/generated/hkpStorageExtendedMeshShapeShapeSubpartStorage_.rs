...
const _: () = {
    ...
    impl __serde::HavokClass for hkpStorageExtendedMeshShapeShapeSubpartStorage {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(1065189452u32)
        }
    }
    impl __serde::Serialize for hkpStorageExtendedMeshShapeShapeSubpartStorage {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(1065189452u32)));

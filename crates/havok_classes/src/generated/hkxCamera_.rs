...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkxCamera<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkxCamera<'a> {
            ...
            S: _serde::ser::Serializer,
        {
            ...
            let mut serializer = __serializer
                .serialize_struct("hkxCamera", class_meta, (80u64, 80u64))?;
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkxCamera<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkxCameraVisitor<'de> {
                marker: _serde::__private::PhantomData<hkxCamera<'de>>,

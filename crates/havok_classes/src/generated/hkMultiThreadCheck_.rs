...
pub(super) struct __hkMultiThreadCheckVisitor<'de> {
    marker: core::marker::PhantomData<hkMultiThreadCheck>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkMultiThreadCheckVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkMultiThreadCheck, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkMultiThreadCheckVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkMultiThreadCheck")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let m_stackTraceId = match m_stackTraceId {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("stackTraceId"),
                );
            }
        };
        let m_markCount = match m_markCount {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("markCount"),
                );
            }
        };
        let m_markBitStack = match m_markBitStack {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("markBitStack"),
                );
            }
        };

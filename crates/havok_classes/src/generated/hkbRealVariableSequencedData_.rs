...
pub struct hkbRealVariableSequencedData<'a> {
    ...
    pub m_samples: Vec<hkbRealVariableSequencedDataSample<'a>>,
    /// # C++ Info
...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkbRealVariableSequencedData<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkbRealVariableSequencedData<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbRealVariableSequencedData<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkbRealVariableSequencedDataVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkbRealVariableSequencedData<'de>,
                >,
            ...
            for __hkbRealVariableSequencedDataVisitor<'de> {
                type Value = hkbRealVariableSequencedData<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

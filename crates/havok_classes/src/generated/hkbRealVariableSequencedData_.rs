...
const _: () = {
    ...
    impl __serde::HavokClass for hkbRealVariableSequencedData {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(3800444162u32)
        }
    }
    impl __serde::Serialize for hkbRealVariableSequencedData {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(3800444162u32)));

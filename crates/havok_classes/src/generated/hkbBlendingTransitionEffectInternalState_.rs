...
const _: () = {
    ...
    impl _serde::HavokClass for hkbBlendingTransitionEffectInternalState {
        #[inline]
    ...
    impl _serde::Serialize for hkbBlendingTransitionEffectInternalState {
...
impl<'de> _serde::de::Visitor<'de> for __FieldVisitor {
        ...
        __E: _serde::de::Error,
    {
        match __value {
            ...
            "initializeCharacterPose" => Ok(__Field::m_initializeCharacterPose),
...
pub(super) struct __hkbBlendingTransitionEffectInternalStateVisitor<'de> {
    marker: core::marker::PhantomData<hkbBlendingTransitionEffectInternalState>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbBlendingTransitionEffectInternalStateVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbBlendingTransitionEffectInternalState, __A::Error>
    where
...
for __hkbBlendingTransitionEffectInternalStateVisitor<'de> {
    type Value = hkbBlendingTransitionEffectInternalState;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbBlendingTransitionEffectInternalState {

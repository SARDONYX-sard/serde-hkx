...
use super::*;
/// # C++ Info
/// -            name: `hkbMoveCharacterModifierInternalState`
/// -         version: `0`
    ...
    impl _serde::Serialize for hkbMoveCharacterModifierInternalState {
            ...
            S: _serde::ser::Serializer,
        {
            ...
            let mut serializer = __serializer
                .serialize_struct("hkbMoveCharacterModifierInternalState", class_meta)?;
            serializer.pad_field([0u8; 4usize].as_slice(), [0u8; 8usize].as_slice())?;
            serializer.skip_field("memSizeAndFlags", &self.parent.m_memSizeAndFlags)?;
            serializer.skip_field("referenceCount", &self.parent.m_referenceCount)?;
            serializer.pad_field([0u8; 0usize].as_slice(), [0u8; 4usize].as_slice())?;
            serializer
                .serialize_field("timeSinceLastModify", &self.m_timeSinceLastModify)?;
            serializer.pad_field([0u8; 0usize].as_slice(), [0u8; 4usize].as_slice())?;
            serializer.end()
        }
    }
...
impl<'de> _serde::de::Visitor<'de> for __FieldVisitor {
    ...
    {
        match __value {
            "timeSinceLastModify" => Ok(__Field::m_timeSinceLastModify),
...
pub(super) struct __hkbMoveCharacterModifierInternalStateVisitor<'de> {
    marker: core::marker::PhantomData<hkbMoveCharacterModifierInternalState>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbMoveCharacterModifierInternalStateVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbMoveCharacterModifierInternalState, __A::Error>
    where
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbMoveCharacterModifierInternalState {
        ...
        where
            __D: _serde::Deserializer<'de>,
        {
            const FIELDS: &[&str] = &["timeSinceLastModify"];
            _serde::Deserializer::deserialize_struct(
                deserializer,
                "hkbMoveCharacterModifierInternalState",
                FIELDS,
                __hkbMoveCharacterModifierInternalStateVisitor {
                    marker: _serde::__private::PhantomData::<
                        hkbMoveCharacterModifierInternalState,
                    >,
                    lifetime: _serde::__private::PhantomData,

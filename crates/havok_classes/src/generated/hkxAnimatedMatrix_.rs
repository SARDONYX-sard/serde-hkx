...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkxAnimatedMatrix<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkxAnimatedMatrix<'a> {
            ...
            S: _serde::ser::Serializer,
        {
            ...
            let mut serializer = __serializer
                .serialize_struct("hkxAnimatedMatrix", class_meta, (24u64, 40u64))?;
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkxAnimatedMatrix<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkxAnimatedMatrixVisitor<'de> {
                marker: _serde::__private::PhantomData<hkxAnimatedMatrix<'de>>,
            ...
            impl<'de> _serde::de::Visitor<'de> for __hkxAnimatedMatrixVisitor<'de> {
                type Value = hkxAnimatedMatrix<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

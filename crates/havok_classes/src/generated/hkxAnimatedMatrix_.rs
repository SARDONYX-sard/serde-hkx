...
const _: () = {
    ...
    impl __serde::HavokClass for hkxAnimatedMatrix {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(1480123191u32)
        }
    }
    impl __serde::Serialize for hkxAnimatedMatrix {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(1480123191u32)));

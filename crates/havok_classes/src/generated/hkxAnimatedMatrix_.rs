...
pub(super) struct __hkxAnimatedMatrixVisitor<'de> {
    marker: core::marker::PhantomData<hkxAnimatedMatrix>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkxAnimatedMatrixVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkxAnimatedMatrix, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkxAnimatedMatrixVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkxAnimatedMatrix")
    }

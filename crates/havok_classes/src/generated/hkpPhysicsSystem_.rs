...
pub(super) struct __hkpPhysicsSystemVisitor<'de> {
    marker: core::marker::PhantomData<hkpPhysicsSystem<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpPhysicsSystemVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpPhysicsSystem<'de>, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkpPhysicsSystemVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpPhysicsSystem")
    }

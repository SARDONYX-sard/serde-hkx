...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkbCombineTransformsModifierInternalState<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkbCombineTransformsModifierInternalState<'a> {
...
const _: () = {
    ...
    for hkbCombineTransformsModifierInternalState<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkbCombineTransformsModifierInternalStateVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkbCombineTransformsModifierInternalState<'de>,
                >,
            ...
            for __hkbCombineTransformsModifierInternalStateVisitor<'de> {
                type Value = hkbCombineTransformsModifierInternalState<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

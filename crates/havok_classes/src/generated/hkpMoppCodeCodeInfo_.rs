...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpMoppCodeCodeInfo<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpMoppCodeCodeInfo<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpMoppCodeCodeInfo<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpMoppCodeCodeInfoVisitor<'de> {
                marker: _serde::__private::PhantomData<hkpMoppCodeCodeInfo<'de>>,
            ...
            impl<'de> _serde::de::Visitor<'de> for __hkpMoppCodeCodeInfoVisitor<'de> {
                type Value = hkpMoppCodeCodeInfo<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

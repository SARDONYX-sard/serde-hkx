...
const _: () = {
    ...
    impl _serde::HavokClass for hkpMoppCodeCodeInfo {
        ...
        fn signature(&self) -> _serde::__private::Signature {
            _serde::__private::Signature::new(0xd8fdbb08)
        }
    }
...
pub(super) struct __hkpMoppCodeCodeInfoVisitor<'de> {
    marker: core::marker::PhantomData<hkpMoppCodeCodeInfo>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpMoppCodeCodeInfoVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpMoppCodeCodeInfo, __A::Error>
    where
        __A: _serde::de::MapAccess<'de>,
    {
        _serde::de::Visitor::visit_struct(
            Self {
                marker: _serde::__private::PhantomData::<hkpMoppCodeCodeInfo>,
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpMoppCodeCodeInfoVisitor<'de> {
    type Value = hkpMoppCodeCodeInfo;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpMoppCodeCodeInfo")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        _serde::__private::Ok(hkpMoppCodeCodeInfo {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpMoppCodeCodeInfo {
        fn deserialize<__D>(deserializer: __D) -> core::result::Result<Self, __D::Error>
        where
            __D: _serde::Deserializer<'de>,
        {
            const FIELDS: &[&str] = &["offset"];
            _serde::Deserializer::deserialize_struct(
                deserializer,
                "hkpMoppCodeCodeInfo",
                FIELDS,
                __hkpMoppCodeCodeInfoVisitor {
                    marker: _serde::__private::PhantomData::<hkpMoppCodeCodeInfo>,
                    lifetime: _serde::__private::PhantomData,
                },
            )

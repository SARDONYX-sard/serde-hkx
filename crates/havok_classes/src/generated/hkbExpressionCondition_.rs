...
pub(super) struct __hkbExpressionConditionVisitor<'de> {
    marker: core::marker::PhantomData<hkbExpressionCondition<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbExpressionConditionVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbExpressionCondition<'de>, __A::Error>
    where
        __A: _serde::de::MapAccess<'de>,
    {
        _serde::de::Visitor::visit_struct(
            Self {
                marker: _serde::__private::PhantomData::<hkbExpressionCondition<'de>>,
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkbExpressionConditionVisitor<'de> {
    type Value = hkbExpressionCondition<'de>;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkbExpressionCondition")
    }
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbExpressionCondition<'de> {
        fn deserialize<__D>(deserializer: __D) -> core::result::Result<Self, __D::Error>
        where
            __D: _serde::Deserializer<'de>,
        {
            const FIELDS: &[&str] = &["expression", "compiledExpressionSet"];
            _serde::Deserializer::deserialize_struct(
                deserializer,
                "hkbExpressionCondition",
                FIELDS,
                __hkbExpressionConditionVisitor {
                    marker: _serde::__private::PhantomData::<hkbExpressionCondition>,
                    lifetime: _serde::__private::PhantomData,
                },
            )
        }

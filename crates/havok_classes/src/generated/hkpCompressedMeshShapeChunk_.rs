...
const _: () = {
    ...
    impl __serde::HavokClass for hkpCompressedMeshShapeChunk {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(1561159613u32)
        }
    }
    impl __serde::Serialize for hkpCompressedMeshShapeChunk {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(1561159613u32)));

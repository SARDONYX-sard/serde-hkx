...
const _: () = {
    ...
    impl __serde::HavokClass for hkpMovingSurfaceModifierConstraintAtom {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(2041270653u32)
        }
    }
    impl __serde::Serialize for hkpMovingSurfaceModifierConstraintAtom {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(2041270653u32)));

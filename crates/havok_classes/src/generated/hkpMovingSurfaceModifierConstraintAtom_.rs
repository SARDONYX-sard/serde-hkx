...
pub(super) struct __hkpMovingSurfaceModifierConstraintAtomVisitor<'de> {
    marker: core::marker::PhantomData<hkpMovingSurfaceModifierConstraintAtom>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpMovingSurfaceModifierConstraintAtomVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpMovingSurfaceModifierConstraintAtom, __A::Error>
    where

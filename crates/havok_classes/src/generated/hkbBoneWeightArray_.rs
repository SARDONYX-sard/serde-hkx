...
const _: () = {
    ...
    impl __serde::HavokClass for hkbBoneWeightArray {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(3448777591u32)
        }
    }
    impl __serde::Serialize for hkbBoneWeightArray {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(3448777591u32)));

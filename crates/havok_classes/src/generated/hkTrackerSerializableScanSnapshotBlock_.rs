...
pub(super) struct __hkTrackerSerializableScanSnapshotBlockVisitor<'de> {
    marker: core::marker::PhantomData<hkTrackerSerializableScanSnapshotBlock>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkTrackerSerializableScanSnapshotBlockVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkTrackerSerializableScanSnapshotBlock, __A::Error>
    where
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        for i in 0..6usize {
            match i {
                ...
                4usize => {
                    if _serde::__private::Option::is_some(&m_startReferenceIndex) {
                        return _serde::__private::Err(
                            <__A::Error as _serde::de::Error>::duplicate_field(
                                "startReferenceIndex",
                            ),
        ...
        let m_typeIndex = match m_typeIndex {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("typeIndex"),
                );
            }
        };
        ...
        let m_arraySize = match m_arraySize {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("arraySize"),
                );
            }
        };
        ...
        let m_numReferences = match m_numReferences {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("numReferences"),
                );
            }
        };

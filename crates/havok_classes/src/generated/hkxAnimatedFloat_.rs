...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkxAnimatedFloat<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkxAnimatedFloat<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkxAnimatedFloat<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkxAnimatedFloatVisitor<'de> {
                marker: _serde::__private::PhantomData<hkxAnimatedFloat<'de>>,
            ...
            impl<'de> _serde::de::Visitor<'de> for __hkxAnimatedFloatVisitor<'de> {
                type Value = hkxAnimatedFloat<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

...
const _: () = {
    ...
    impl _serde::HavokClass for hkxAnimatedFloat {
        ...
        fn signature(&self) -> _serde::__private::Signature {
            _serde::__private::Signature::new(0xce8b2fbd)
        }
    }
...
pub(super) struct __hkxAnimatedFloatVisitor<'de> {
    marker: core::marker::PhantomData<hkxAnimatedFloat>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkxAnimatedFloatVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkxAnimatedFloat, __A::Error>
    where
        __A: _serde::de::MapAccess<'de>,
    {
        _serde::de::Visitor::visit_struct(
            Self {
                marker: _serde::__private::PhantomData::<hkxAnimatedFloat>,
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkxAnimatedFloatVisitor<'de> {
    type Value = hkxAnimatedFloat;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkxAnimatedFloat")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        _serde::__private::Ok(hkxAnimatedFloat {
            __ptr,
            parent,
            m_floats,
            m_hint,
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkxAnimatedFloat {
        fn deserialize<__D>(deserializer: __D) -> core::result::Result<Self, __D::Error>
        where
            __D: _serde::Deserializer<'de>,
        {
            const FIELDS: &[&str] = &["floats", "hint"];
            _serde::Deserializer::deserialize_struct(
                deserializer,
                "hkxAnimatedFloat",
                FIELDS,
                __hkxAnimatedFloatVisitor {
                    marker: _serde::__private::PhantomData::<hkxAnimatedFloat>,
                    lifetime: _serde::__private::PhantomData,
                },
            )

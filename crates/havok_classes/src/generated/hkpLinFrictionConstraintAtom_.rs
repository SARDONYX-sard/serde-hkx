...
const _: () = {
    ...
    impl __serde::HavokClass for hkpLinFrictionConstraintAtom {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(1049948028u32)
        }
    }
    impl __serde::Serialize for hkpLinFrictionConstraintAtom {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(1049948028u32)));

...
pub(super) struct __hkbEventSequencedDataVisitor<'de> {
    marker: core::marker::PhantomData<hkbEventSequencedData>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbEventSequencedDataVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbEventSequencedData, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkbEventSequencedDataVisitor<'de> {
    type Value = hkbEventSequencedData;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkbEventSequencedData")
    }
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbEventSequencedData {

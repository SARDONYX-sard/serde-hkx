...
pub(super) struct __hkpTriggerVolumeEventInfoVisitor<'de> {
    marker: core::marker::PhantomData<hkpTriggerVolumeEventInfo>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpTriggerVolumeEventInfoVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpTriggerVolumeEventInfo, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpTriggerVolumeEventInfoVisitor<'de> {
    type Value = hkpTriggerVolumeEventInfo;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpTriggerVolumeEventInfo")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let m_sortValue = match m_sortValue {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("sortValue"),
                );
            }
        };
        ...
        let m_operation = match m_operation {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("operation"),
                );
            }
        };

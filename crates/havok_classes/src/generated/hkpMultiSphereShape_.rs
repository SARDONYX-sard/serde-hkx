...
const _: () = {
    ...
    impl __serde::HavokClass for hkpMultiSphereShape {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(1638240508u32)
        }
    }
    impl __serde::Serialize for hkpMultiSphereShape {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(1638240508u32)));

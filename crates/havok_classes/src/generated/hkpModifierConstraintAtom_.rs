...
pub(super) struct __hkpModifierConstraintAtomVisitor<'de> {
    marker: core::marker::PhantomData<hkpModifierConstraintAtom>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpModifierConstraintAtomVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpModifierConstraintAtom, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpModifierConstraintAtomVisitor<'de> {
    type Value = hkpModifierConstraintAtom;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpModifierConstraintAtom")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let m_modifierAtomSize = match m_modifierAtomSize {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("modifierAtomSize"),
                );
            }
        };

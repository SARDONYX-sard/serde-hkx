...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkbStringEventPayload<'a> {
        ...
        fn signature(&self) -> _serde::__private::Signature {
            _serde::__private::Signature::new(0xed04256a)
        }
    }
    impl<'a> _serde::Serialize for hkbStringEventPayload<'a> {
            ...
            S: _serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, _serde::__private::Signature::new(0xed04256a)));
...
pub(super) struct __hkbStringEventPayloadVisitor<'de> {
    marker: core::marker::PhantomData<hkbStringEventPayload<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbStringEventPayloadVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbStringEventPayload<'de>, __A::Error>
    where
        __A: _serde::de::MapAccess<'de>,
    {
        _serde::de::Visitor::visit_struct(
            Self {
                marker: _serde::__private::PhantomData::<hkbStringEventPayload<'de>>,
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkbStringEventPayloadVisitor<'de> {
    type Value = hkbStringEventPayload<'de>;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkbStringEventPayload")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        _serde::__private::Ok(hkbStringEventPayload {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbStringEventPayload<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            _serde::Deserializer::deserialize_struct(
                ...
                "hkbStringEventPayload",
                FIELDS,
                __hkbStringEventPayloadVisitor {
                    marker: _serde::__private::PhantomData::<hkbStringEventPayload>,
                    lifetime: _serde::__private::PhantomData,
                },
            )
        }

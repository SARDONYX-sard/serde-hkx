...
pub(super) struct __hkbHandleVisitor<'de> {
    marker: core::marker::PhantomData<hkbHandle>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbHandleVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbHandle, __A::Error>
    where

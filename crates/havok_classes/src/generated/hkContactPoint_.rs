...
const _: () = {
    ...
    impl __serde::HavokClass for hkContactPoint {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(2446843278u32)
        }
    }
    impl __serde::Serialize for hkContactPoint {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(2446843278u32)));

...
pub(super) struct __hkbEventDrivenModifierInternalStateVisitor<'de> {
    marker: core::marker::PhantomData<hkbEventDrivenModifierInternalState>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbEventDrivenModifierInternalStateVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbEventDrivenModifierInternalState, __A::Error>
    where
...
for __hkbEventDrivenModifierInternalStateVisitor<'de> {
    type Value = hkbEventDrivenModifierInternalState;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbEventDrivenModifierInternalState {

...
pub struct hkbEventDrivenModifierInternalState<'a> {
...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkbEventDrivenModifierInternalState<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkbEventDrivenModifierInternalState<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbEventDrivenModifierInternalState<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkbEventDrivenModifierInternalStateVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkbEventDrivenModifierInternalState<'de>,
                >,
            ...
            for __hkbEventDrivenModifierInternalStateVisitor<'de> {
                type Value = hkbEventDrivenModifierInternalState<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {
            ...
            const FIELDS: &[&str] = &["isActive"];
            _serde::Deserializer::deserialize_struct(
                deserializer,
                "hkbEventDrivenModifierInternalState",
                FIELDS,
                __hkbEventDrivenModifierInternalStateVisitor {
                    marker: _serde::__private::PhantomData::<
                        hkbEventDrivenModifierInternalState,
                    >,

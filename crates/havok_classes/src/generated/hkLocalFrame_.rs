    ...
    impl _serde::Serialize for hkLocalFrame {
            ...
            S: _serde::ser::Serializer,
        {
            ...
            let mut serializer = __serializer
                .serialize_struct("hkLocalFrame", class_meta)?;
...
pub(super) struct __hkLocalFrameVisitor<'de> {
    marker: core::marker::PhantomData<hkLocalFrame>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkLocalFrameVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkLocalFrame, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkLocalFrameVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkLocalFrame")
    }

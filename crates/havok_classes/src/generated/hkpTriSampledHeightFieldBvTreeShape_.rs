...
const _: () = {
    ...
    impl __serde::HavokClass for hkpTriSampledHeightFieldBvTreeShape {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(1491199365u32)
        }
    }
    impl __serde::Serialize for hkpTriSampledHeightFieldBvTreeShape {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(1491199365u32)));

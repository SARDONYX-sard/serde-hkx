...
const _: () = {
    ...
    impl __serde::HavokClass for hkbEventsFromRangeModifierInternalState {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(3427251341u32)
        }
    }
    impl __serde::Serialize for hkbEventsFromRangeModifierInternalState {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(3427251341u32)));

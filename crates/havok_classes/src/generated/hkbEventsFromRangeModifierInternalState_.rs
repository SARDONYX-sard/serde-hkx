...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkbEventsFromRangeModifierInternalState<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkbEventsFromRangeModifierInternalState<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbEventsFromRangeModifierInternalState<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            impl<'de> _serde::de::Visitor<'de> for __FieldVisitor {
                    ...
                    __E: _serde::de::Error,
                {
                    match __value {
                        "wasActiveInPreviousFrame" => {
                            Ok(__Field::m_wasActiveInPreviousFrame)
                        }
            ...
            struct __hkbEventsFromRangeModifierInternalStateVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkbEventsFromRangeModifierInternalState<'de>,
                >,
            ...
            for __hkbEventsFromRangeModifierInternalStateVisitor<'de> {
                type Value = hkbEventsFromRangeModifierInternalState<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

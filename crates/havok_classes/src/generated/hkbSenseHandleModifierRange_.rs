...
pub(super) struct __hkbSenseHandleModifierRangeVisitor<'de> {
    marker: core::marker::PhantomData<hkbSenseHandleModifierRange>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbSenseHandleModifierRangeVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbSenseHandleModifierRange, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkbSenseHandleModifierRangeVisitor<'de> {

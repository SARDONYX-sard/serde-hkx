...
pub(super) struct __hkpCapsuleShapeVisitor<'de> {
    marker: core::marker::PhantomData<hkpCapsuleShape>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpCapsuleShapeVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpCapsuleShape, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkpCapsuleShapeVisitor<'de> {
    type Value = hkpCapsuleShape;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpCapsuleShape")
    }
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpCapsuleShape {

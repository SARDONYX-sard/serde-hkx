...
const _: () = {
    ...
    impl __serde::HavokClass for hkpCapsuleShape {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(3708493779u32)
        }
    }
    impl __serde::Serialize for hkpCapsuleShape {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(3708493779u32)));

...
pub(super) struct __hkbComputeRotationToTargetModifierInternalStateVisitor<'de> {
    marker: core::marker::PhantomData<hkbComputeRotationToTargetModifierInternalState>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbComputeRotationToTargetModifierInternalStateVisitor<'de> {
...
for __hkbComputeRotationToTargetModifierInternalStateVisitor<'de> {
    type Value = hkbComputeRotationToTargetModifierInternalState;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
...
const _: () = {
    ...
    for hkbComputeRotationToTargetModifierInternalState {

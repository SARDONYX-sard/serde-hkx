...
pub(super) struct __hkpTriggerVolumeVisitor<'de> {
    marker: core::marker::PhantomData<hkpTriggerVolume>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpTriggerVolumeVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpTriggerVolume, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkpTriggerVolumeVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpTriggerVolume")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let mut m_overlappingBodies: _serde::__private::Option<Vec<Pointer>> = _serde::__private::None;
        ...
        let m_overlappingBodies = match m_overlappingBodies {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("overlappingBodies"),
                );
            }
        };
        ...
        let m_triggerBody = match m_triggerBody {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("triggerBody"),
                );
            }
        };
        let m_sequenceNumber = match m_sequenceNumber {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("sequenceNumber"),
                );
            }
        };

...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpTriggerVolume<'a> {
        #[inline]
        ...
        fn deps_indexes(&self) -> Vec<&Pointer<'_>> {
            let mut v = Vec::new();
            v.extend(self.m_overlappingBodies.iter());
            v.extend(
                self
                    .m_eventQueue
                    .iter()
            ...
            v.push(&self.m_triggerBody);
            v
        }
    }
    impl<'a> _serde::Serialize for hkpTriggerVolume<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpTriggerVolume<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpTriggerVolumeVisitor<'de> {
                marker: _serde::__private::PhantomData<hkpTriggerVolume<'de>>,
            ...
            impl<'de> _serde::de::Visitor<'de> for __hkpTriggerVolumeVisitor<'de> {
                type Value = hkpTriggerVolume<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {
...
/// # C++ Info
/// - name: `Operation`(ctype: `hkEnum<Operation, hkInt32>`)
#[allow(non_upper_case_globals, non_snake_case)]
#[cfg_attr(feature = "json_schema", derive(schemars::JsonSchema))]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(

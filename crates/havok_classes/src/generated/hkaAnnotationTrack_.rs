...
pub(super) struct __hkaAnnotationTrackVisitor<'de> {
    marker: core::marker::PhantomData<hkaAnnotationTrack<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkaAnnotationTrackVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkaAnnotationTrack<'de>, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkaAnnotationTrackVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkaAnnotationTrack")
    }

...
const _: () = {
    ...
    impl<'a> __serde::HavokClass for hkaAnnotationTrack<'a> {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(3557904349u32)
        }
    }
    impl<'a> __serde::Serialize for hkaAnnotationTrack<'a> {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(3557904349u32)));

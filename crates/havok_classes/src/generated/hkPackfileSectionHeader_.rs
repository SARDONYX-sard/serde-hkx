...
const _: () = {
    ...
    impl __serde::HavokClass for hkPackfileSectionHeader {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(4071170388u32)
        }
    }
    impl __serde::Serialize for hkPackfileSectionHeader {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(4071170388u32)));

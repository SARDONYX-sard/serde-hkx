...
pub struct hkpRotationalConstraintData<'a> {
    ...
    pub m_atoms: hkpRotationalConstraintDataAtoms<'a>,
}
const _: () = {
    use havok_serde as _serde;
    impl<'a> _serde::HavokClass for hkpRotationalConstraintData<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpRotationalConstraintData<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpRotationalConstraintData<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpRotationalConstraintDataVisitor<'de> {
                marker: _serde::__private::PhantomData<hkpRotationalConstraintData<'de>>,
            ...
            for __hkpRotationalConstraintDataVisitor<'de> {
                type Value = hkpRotationalConstraintData<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

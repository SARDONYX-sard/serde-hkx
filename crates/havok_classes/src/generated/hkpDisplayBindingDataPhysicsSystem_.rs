...
const _: () = {
    ...
    impl __serde::HavokClass for hkpDisplayBindingDataPhysicsSystem {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(3366880935u32)
        }
    }
    impl __serde::Serialize for hkpDisplayBindingDataPhysicsSystem {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(3366880935u32)));

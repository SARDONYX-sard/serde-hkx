...
pub(super) struct __hkxEdgeSelectionChannelVisitor<'de> {
    marker: core::marker::PhantomData<hkxEdgeSelectionChannel>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkxEdgeSelectionChannelVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkxEdgeSelectionChannel, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkxEdgeSelectionChannelVisitor<'de> {
    type Value = hkxEdgeSelectionChannel;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkxEdgeSelectionChannel")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let m_selectedEdges = match m_selectedEdges {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("selectedEdges"),
                );
            }
        };

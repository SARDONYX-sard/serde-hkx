...
pub struct hkxEdgeSelectionChannel<'a> {
...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkxEdgeSelectionChannel<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkxEdgeSelectionChannel<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkxEdgeSelectionChannel<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkxEdgeSelectionChannelVisitor<'de> {
                marker: _serde::__private::PhantomData<hkxEdgeSelectionChannel<'de>>,
            ...
            for __hkxEdgeSelectionChannelVisitor<'de> {
                type Value = hkxEdgeSelectionChannel<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    let mut m_selectedEdges: _serde::__private::Option<Vec<I32<'de>>> = _serde::__private::None;
                    for i in 0..1usize {
                        match i {
                            0usize => {

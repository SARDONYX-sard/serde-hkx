...
const _: () = {
    ...
    impl _serde::HavokClass for hkbBehaviorEventsInfo {
        #[inline]
        ...
        fn signature(&self) -> _serde::__private::Signature {
            _serde::__private::Signature::new(0x66840004)
        }
    }
    impl _serde::Serialize for hkbBehaviorEventsInfo {
...
pub(super) struct __hkbBehaviorEventsInfoVisitor<'de> {
    marker: core::marker::PhantomData<hkbBehaviorEventsInfo>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbBehaviorEventsInfoVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbBehaviorEventsInfo, __A::Error>
    where
        __A: _serde::de::MapAccess<'de>,
    {
        _serde::de::Visitor::visit_struct(
            Self {
                marker: _serde::__private::PhantomData::<hkbBehaviorEventsInfo>,
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkbBehaviorEventsInfoVisitor<'de> {
    type Value = hkbBehaviorEventsInfo;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkbBehaviorEventsInfo")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        _serde::__private::Ok(hkbBehaviorEventsInfo {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbBehaviorEventsInfo {
        fn deserialize<__D>(deserializer: __D) -> core::result::Result<Self, __D::Error>
        where
            __D: _serde::Deserializer<'de>,
        {
            const FIELDS: &[&str] = &["characterId", "externalEventIds", "padding"];
            _serde::Deserializer::deserialize_struct(
                deserializer,
                "hkbBehaviorEventsInfo",
                FIELDS,
                __hkbBehaviorEventsInfoVisitor {
                    marker: _serde::__private::PhantomData::<hkbBehaviorEventsInfo>,
                    lifetime: _serde::__private::PhantomData,
                },
            )

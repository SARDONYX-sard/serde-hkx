...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkbBehaviorEventsInfo<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkbBehaviorEventsInfo<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbBehaviorEventsInfo<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkbBehaviorEventsInfoVisitor<'de> {
                marker: _serde::__private::PhantomData<hkbBehaviorEventsInfo<'de>>,
            ...
            impl<'de> _serde::de::Visitor<'de> for __hkbBehaviorEventsInfoVisitor<'de> {
                type Value = hkbBehaviorEventsInfo<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

...
const _: () = {
    ...
    impl __serde::HavokClass for hkbBehaviorEventsInfo {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(1719926788u32)
        }
    }
    impl __serde::Serialize for hkbBehaviorEventsInfo {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(1719926788u32)));

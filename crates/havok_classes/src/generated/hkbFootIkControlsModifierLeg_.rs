...
const _: () = {
    ...
    impl __serde::HavokClass for hkbFootIkControlsModifierLeg {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(2652309786u32)
        }
    }
    impl __serde::Serialize for hkbFootIkControlsModifierLeg {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(2652309786u32)));

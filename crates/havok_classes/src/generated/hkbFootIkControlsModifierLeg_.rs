...
pub(super) struct __hkbFootIkControlsModifierLegVisitor<'de> {
    marker: core::marker::PhantomData<hkbFootIkControlsModifierLeg>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbFootIkControlsModifierLegVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbFootIkControlsModifierLeg, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkbFootIkControlsModifierLegVisitor<'de> {

...
pub(super) struct __hkpPrismaticConstraintDataAtomsVisitor<'de> {
    marker: core::marker::PhantomData<hkpPrismaticConstraintDataAtoms>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpPrismaticConstraintDataAtomsVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpPrismaticConstraintDataAtoms, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpPrismaticConstraintDataAtomsVisitor<'de> {
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let mut m_motor: _serde::__private::Option<hkpLinMotorConstraintAtom> = _serde::__private::None;
        let mut m_friction: _serde::__private::Option<hkpLinFrictionConstraintAtom> = _serde::__private::None;

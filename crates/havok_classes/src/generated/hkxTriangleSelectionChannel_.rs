...
const _: () = {
    ...
    impl __serde::HavokClass for hkxTriangleSelectionChannel {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(2687302825u32)
        }
    }
    impl __serde::Serialize for hkxTriangleSelectionChannel {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(2687302825u32)));

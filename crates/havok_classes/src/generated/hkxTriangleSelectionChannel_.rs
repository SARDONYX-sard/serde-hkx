...
pub struct hkxTriangleSelectionChannel<'a> {
    ...
    #[cfg_attr(feature = "json_schema", schemars(rename = "selectedTriangles"))]
    #[cfg_attr(feature = "serde", serde(rename = "selectedTriangles"))]
    pub m_selectedTriangles: Vec<I32<'a>>,
}
const _: () = {
    use havok_serde as _serde;
    impl<'a> _serde::HavokClass for hkxTriangleSelectionChannel<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkxTriangleSelectionChannel<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkxTriangleSelectionChannel<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkxTriangleSelectionChannelVisitor<'de> {
                marker: _serde::__private::PhantomData<hkxTriangleSelectionChannel<'de>>,
            ...
            for __hkxTriangleSelectionChannelVisitor<'de> {
                type Value = hkxTriangleSelectionChannel<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    let mut m_selectedTriangles: _serde::__private::Option<
                        Vec<I32<'de>>,

...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkbSimulationControlCommand<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkbSimulationControlCommand<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbSimulationControlCommand<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkbSimulationControlCommandVisitor<'de> {
                marker: _serde::__private::PhantomData<hkbSimulationControlCommand<'de>>,
            ...
            for __hkbSimulationControlCommandVisitor<'de> {
                type Value = hkbSimulationControlCommand<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {
...
/// # C++ Info
/// - name: `SimulationControlCommand`(ctype: `hkEnum<SimulationControlCommand, hkUint8>`)
#[allow(non_upper_case_globals, non_snake_case)]
#[cfg_attr(feature = "json_schema", derive(schemars::JsonSchema))]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(

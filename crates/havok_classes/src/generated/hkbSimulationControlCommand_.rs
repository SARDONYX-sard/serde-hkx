...
pub(super) struct __hkbSimulationControlCommandVisitor<'de> {
    marker: core::marker::PhantomData<hkbSimulationControlCommand>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbSimulationControlCommandVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbSimulationControlCommand, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkbSimulationControlCommandVisitor<'de> {
            ...
            match i {
                0usize => {
                    ...
                    m_command = _serde::__private::Some(
                        match __A::next_value::<SimulationControlCommand>(&mut __map) {

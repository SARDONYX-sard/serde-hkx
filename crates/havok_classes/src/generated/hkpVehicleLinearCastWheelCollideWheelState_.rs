...
pub(super) struct __hkpVehicleLinearCastWheelCollideWheelStateVisitor<'de> {
    marker: core::marker::PhantomData<hkpVehicleLinearCastWheelCollideWheelState>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpVehicleLinearCastWheelCollideWheelStateVisitor<'de> {

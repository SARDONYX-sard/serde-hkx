...
pub(super) struct __hkbStateMachineEventPropertyArrayVisitor<'de> {
    marker: core::marker::PhantomData<hkbStateMachineEventPropertyArray>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbStateMachineEventPropertyArrayVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbStateMachineEventPropertyArray, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkbStateMachineEventPropertyArrayVisitor<'de> {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbStateMachineEventPropertyArray {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            _serde::Deserializer::deserialize_struct(
                ...
                "hkbStateMachineEventPropertyArray",
                FIELDS,
                __hkbStateMachineEventPropertyArrayVisitor {
                    marker: _serde::__private::PhantomData::<
                        hkbStateMachineEventPropertyArray,
                    >,
                    lifetime: _serde::__private::PhantomData,

...
const _: () = {
    ...
    impl<'a> __serde::HavokClass for BSTweenerModifier<'a> {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(221092356u32)
        }
    }
    impl<'a> __serde::Serialize for BSTweenerModifier<'a> {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(221092356u32)));

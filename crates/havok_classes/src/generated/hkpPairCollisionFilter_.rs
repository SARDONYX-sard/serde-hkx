...
pub(super) struct __hkpPairCollisionFilterVisitor<'de> {
    marker: core::marker::PhantomData<hkpPairCollisionFilter>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpPairCollisionFilterVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpPairCollisionFilter, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkpPairCollisionFilterVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpPairCollisionFilter")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let m_disabledPairs = match m_disabledPairs {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("disabledPairs"),
                );
            }
        };
        let m_childFilter = match m_childFilter {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("childFilter"),
                );
            }
        };

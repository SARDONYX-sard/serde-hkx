...
pub(super) struct __hkContactPointMaterialVisitor<'de> {
    marker: core::marker::PhantomData<hkContactPointMaterial>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkContactPointMaterialVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkContactPointMaterial, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkContactPointMaterialVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkContactPointMaterial")
    }

...
pub(super) struct __hkpTransformShapeVisitor<'de> {
    marker: core::marker::PhantomData<hkpTransformShape>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpTransformShapeVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpTransformShape, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkpTransformShapeVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpTransformShape")
    }

...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpTransformShape<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpTransformShape<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpTransformShape<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpTransformShapeVisitor<'de> {
                marker: _serde::__private::PhantomData<hkpTransformShape<'de>>,
            ...
            impl<'de> _serde::de::Visitor<'de> for __hkpTransformShapeVisitor<'de> {
                type Value = hkpTransformShape<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

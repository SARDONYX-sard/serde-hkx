...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpSetLocalRotationsConstraintAtom<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpSetLocalRotationsConstraintAtom<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpSetLocalRotationsConstraintAtom<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            for __hkpSetLocalRotationsConstraintAtomVisitor<'de> {
                type Value = hkpSetLocalRotationsConstraintAtom<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

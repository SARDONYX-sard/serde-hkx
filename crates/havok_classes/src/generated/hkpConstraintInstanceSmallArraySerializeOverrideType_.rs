...
const _: () = {
    ...
    impl __serde::HavokClass for hkpConstraintInstanceSmallArraySerializeOverrideType {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(3996920556u32)
        }
    }
    impl __serde::Serialize for hkpConstraintInstanceSmallArraySerializeOverrideType {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(3996920556u32)));

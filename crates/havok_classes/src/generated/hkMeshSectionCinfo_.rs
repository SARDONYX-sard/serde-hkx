...
pub(super) struct __hkMeshSectionCinfoVisitor<'de> {
    marker: core::marker::PhantomData<hkMeshSectionCinfo>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkMeshSectionCinfoVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkMeshSectionCinfo, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkMeshSectionCinfoVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkMeshSectionCinfo")
    }

...
impl<'de> _serde::de::Visitor<'de> for __FieldVisitor {
        ...
        __E: _serde::de::Error,
    {
        match __value {
            ...
            "previousTargetPositionOffset" => Ok(__Field::m_previousTargetPositionOffset),
...
pub(super) struct __hkpLinMotorConstraintAtomVisitor<'de> {
    marker: core::marker::PhantomData<hkpLinMotorConstraintAtom>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpLinMotorConstraintAtomVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpLinMotorConstraintAtom, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpLinMotorConstraintAtomVisitor<'de> {
    type Value = hkpLinMotorConstraintAtom;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpLinMotorConstraintAtom")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let mut m_previousTargetPositionOffset: _serde::__private::Option<i16> = _serde::__private::None;
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpLinMotorConstraintAtom {

...
pub struct hkpFirstPersonGun<'a> {
    ...
    /// - type_size: `  1`(x86)/`  1`(x86_64)
    #[cfg_attr(feature = "json_schema", schemars(rename = "keyboardKey"))]
    #[cfg_attr(feature = "serde", serde(rename = "keyboardKey"))]
...
const _: () = {
    ...
    impl<'a> _serde::Serialize for hkpFirstPersonGun<'a> {
            ...
            S: _serde::ser::Serializer,
        {
            ...
            serializer.pad_field([0u8; 3usize].as_slice(), [0u8; 7usize].as_slice())?;
            serializer
                .skip_array_field("listeners", &self.m_listeners, TypeSize::NonPtr)?;
            serializer.end()
        }
    }
};
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpFirstPersonGun<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpFirstPersonGunVisitor<'de> {

...
pub(super) struct __hkpFirstPersonGunVisitor<'de> {
    marker: core::marker::PhantomData<hkpFirstPersonGun<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpFirstPersonGunVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpFirstPersonGun<'de>, __A::Error>
    where
        __A: _serde::de::MapAccess<'de>,
    {
        _serde::de::Visitor::visit_struct(
            Self {
                marker: _serde::__private::PhantomData::<hkpFirstPersonGun<'de>>,
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpFirstPersonGunVisitor<'de> {
    type Value = hkpFirstPersonGun<'de>;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpFirstPersonGun")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let m_keyboardKey = match m_keyboardKey {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("keyboardKey"),
                );
            }
        };
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpFirstPersonGun<'de> {
        fn deserialize<__D>(deserializer: __D) -> core::result::Result<Self, __D::Error>
        where
            __D: _serde::Deserializer<'de>,
        {
            const FIELDS: &[&str] = &["type", "name", "keyboardKey", "listeners"];
            _serde::Deserializer::deserialize_struct(
                deserializer,
                "hkpFirstPersonGun",
                FIELDS,
                __hkpFirstPersonGunVisitor {
                    marker: _serde::__private::PhantomData::<hkpFirstPersonGun>,
                    lifetime: _serde::__private::PhantomData,
                },
            )
        }

...
pub(super) struct __hkbBehaviorGraphStringDataVisitor<'de> {
    marker: core::marker::PhantomData<hkbBehaviorGraphStringData<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbBehaviorGraphStringDataVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbBehaviorGraphStringData<'de>, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkbBehaviorGraphStringDataVisitor<'de> {
    type Value = hkbBehaviorGraphStringData<'de>;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkbBehaviorGraphStringData")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let mut m_attributeNames: _serde::__private::Option<Vec<StringPtr<'de>>> = _serde::__private::None;
        ...
        let m_attributeNames = match m_attributeNames {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("attributeNames"),
                );
            }
        };

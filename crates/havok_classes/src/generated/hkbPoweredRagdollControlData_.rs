...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkbPoweredRagdollControlData<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkbPoweredRagdollControlData<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbPoweredRagdollControlData<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkbPoweredRagdollControlDataVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkbPoweredRagdollControlData<'de>,
                >,
            ...
            for __hkbPoweredRagdollControlDataVisitor<'de> {
                type Value = hkbPoweredRagdollControlData<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

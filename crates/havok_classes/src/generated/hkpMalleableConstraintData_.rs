...
pub(super) struct __hkpMalleableConstraintDataVisitor<'de> {
    marker: core::marker::PhantomData<hkpMalleableConstraintData>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpMalleableConstraintDataVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpMalleableConstraintData, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpMalleableConstraintDataVisitor<'de> {
    type Value = hkpMalleableConstraintData;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpMalleableConstraintData")
    }

...
const _: () = {
    ...
    impl _serde::HavokClass for hkpBoxShape {
        #[inline]
    ...
    impl _serde::Serialize for hkpBoxShape {
            ...
            S: _serde::ser::Serializer,
        {
            ...
            let mut serializer = __serializer
                .serialize_struct("hkpBoxShape", class_meta)?;
...
pub(super) struct __hkpBoxShapeVisitor<'de> {
    marker: core::marker::PhantomData<hkpBoxShape>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpBoxShapeVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpBoxShape, __A::Error>
    where
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let m_halfExtents = match m_halfExtents {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("halfExtents"),
                );
            }
        };
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpBoxShape {

...
const _: () = {
    ...
    impl __serde::HavokClass for hkbBlenderGeneratorChild {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(3803415728u32)
        }
    }
    impl __serde::Serialize for hkbBlenderGeneratorChild {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(3803415728u32)));

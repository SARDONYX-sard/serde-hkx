...
pub(super) struct __hkpMassPropertiesVisitor<'de> {
    marker: core::marker::PhantomData<hkpMassProperties>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpMassPropertiesVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpMassProperties, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkpMassPropertiesVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpMassProperties")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let m_centerOfMass = match m_centerOfMass {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("centerOfMass"),
                );
            }
        };
        let m_inertiaTensor = match m_inertiaTensor {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("inertiaTensor"),
                );
            }
        };

...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpMassProperties<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpMassProperties<'a> {
            ...
            S: _serde::ser::Serializer,
        {
            ...
            let mut serializer = __serializer
                .serialize_struct("hkpMassProperties", class_meta, (80u64, 80u64))?;
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpMassProperties<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpMassPropertiesVisitor<'de> {
                marker: _serde::__private::PhantomData<hkpMassProperties<'de>>,
            ...
            impl<'de> _serde::de::Visitor<'de> for __hkpMassPropertiesVisitor<'de> {
                type Value = hkpMassProperties<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkbDampingModifierInternalState<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkbDampingModifierInternalState<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbDampingModifierInternalState<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkbDampingModifierInternalStateVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkbDampingModifierInternalState<'de>,
                >,
            ...
            for __hkbDampingModifierInternalStateVisitor<'de> {
                type Value = hkbDampingModifierInternalState<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

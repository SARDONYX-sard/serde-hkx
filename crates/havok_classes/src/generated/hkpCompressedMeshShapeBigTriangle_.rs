...
pub(super) struct __hkpCompressedMeshShapeBigTriangleVisitor<'de> {
    marker: core::marker::PhantomData<hkpCompressedMeshShapeBigTriangle>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpCompressedMeshShapeBigTriangleVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpCompressedMeshShapeBigTriangle, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpCompressedMeshShapeBigTriangleVisitor<'de> {

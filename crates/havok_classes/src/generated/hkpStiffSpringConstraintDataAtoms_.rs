...
const _: () = {
    ...
    impl __serde::HavokClass for hkpStiffSpringConstraintDataAtoms {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(545174390u32)
        }
    }
    impl __serde::Serialize for hkpStiffSpringConstraintDataAtoms {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(545174390u32)));

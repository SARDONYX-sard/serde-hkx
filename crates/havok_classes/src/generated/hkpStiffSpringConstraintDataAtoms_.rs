...
pub struct hkpStiffSpringConstraintDataAtoms<'a> {
...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpStiffSpringConstraintDataAtoms<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpStiffSpringConstraintDataAtoms<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpStiffSpringConstraintDataAtoms<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpStiffSpringConstraintDataAtomsVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkpStiffSpringConstraintDataAtoms<'de>,
                >,
            ...
            for __hkpStiffSpringConstraintDataAtomsVisitor<'de> {
                type Value = hkpStiffSpringConstraintDataAtoms<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

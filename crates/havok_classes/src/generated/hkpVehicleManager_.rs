...
const _: () = {
    ...
    impl __serde::HavokClass for hkpVehicleManager {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(3807893159u32)
        }
    }
    impl __serde::Serialize for hkpVehicleManager {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(3807893159u32)));

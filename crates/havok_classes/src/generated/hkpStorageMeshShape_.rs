...
pub(super) struct __hkpStorageMeshShapeVisitor<'de> {
    marker: core::marker::PhantomData<hkpStorageMeshShape>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpStorageMeshShapeVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpStorageMeshShape, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkpStorageMeshShapeVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpStorageMeshShape")
    }

...
pub struct hkbEvaluateExpressionModifierInternalExpressionData<'a> {
...
const _: () = {
    ...
    for hkbEvaluateExpressionModifierInternalExpressionData<'a> {
        #[inline]
...
const _: () = {
    ...
    for hkbEvaluateExpressionModifierInternalExpressionData<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkbEvaluateExpressionModifierInternalExpressionDataVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkbEvaluateExpressionModifierInternalExpressionData<'de>,
                >,
            ...
            for __hkbEvaluateExpressionModifierInternalExpressionDataVisitor<'de> {
                type Value = hkbEvaluateExpressionModifierInternalExpressionData<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

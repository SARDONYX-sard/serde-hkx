...
const _: () = {
    ...
    impl<'a> __serde::HavokClass for BSSynchronizedClipGenerator<'a> {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(3627805284u32)
        }
    }
    impl<'a> __serde::Serialize for BSSynchronizedClipGenerator<'a> {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(3627805284u32)));

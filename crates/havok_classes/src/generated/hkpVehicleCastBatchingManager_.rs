...
pub(super) struct __hkpVehicleCastBatchingManagerVisitor<'de> {
    marker: core::marker::PhantomData<hkpVehicleCastBatchingManager>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpVehicleCastBatchingManagerVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpVehicleCastBatchingManager, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpVehicleCastBatchingManagerVisitor<'de> {
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let m_totalNumWheels = match m_totalNumWheels {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("totalNumWheels"),
                );
            }
        };

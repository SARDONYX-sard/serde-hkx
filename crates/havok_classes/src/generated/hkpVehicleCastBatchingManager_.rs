...
const _: () = {
    ...
    impl __serde::HavokClass for hkpVehicleCastBatchingManager {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(87244969u32)
        }
    }
    impl __serde::Serialize for hkpVehicleCastBatchingManager {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(87244969u32)));

...
pub struct hkpVehicleCastBatchingManager<'a> {
    ...
    #[cfg_attr(feature = "serde", serde(borrow))]
    pub parent: hkpVehicleManager<'a>,
    /// # C++ Info
    /// - name: `totalNumWheels`(ctype: `hkUint16`)
    /// - offset: ` 20`(x86)/` 32`(x86_64)
    /// - type_size: `  2`(x86)/`  2`(x86_64)
    #[cfg_attr(feature = "json_schema", schemars(rename = "totalNumWheels"))]
    #[cfg_attr(feature = "serde", serde(rename = "totalNumWheels"))]
    pub m_totalNumWheels: U16<'a>,
}
const _: () = {
    use havok_serde as _serde;
    impl<'a> _serde::HavokClass for hkpVehicleCastBatchingManager<'a> {
        #[inline]
        ...
        fn deps_indexes(&self) -> Vec<&Pointer<'_>> {
            let mut v = Vec::new();
            v.extend(self.parent.m_registeredVehicles.iter());
            v
        }
    }
    impl<'a> _serde::Serialize for hkpVehicleCastBatchingManager<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpVehicleCastBatchingManager<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpVehicleCastBatchingManagerVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkpVehicleCastBatchingManager<'de>,
                >,
            ...
            for __hkpVehicleCastBatchingManagerVisitor<'de> {
                type Value = hkpVehicleCastBatchingManager<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

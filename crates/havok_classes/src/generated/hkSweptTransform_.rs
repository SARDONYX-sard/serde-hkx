...
pub(super) struct __hkSweptTransformVisitor<'de> {
    marker: core::marker::PhantomData<hkSweptTransform>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkSweptTransformVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkSweptTransform, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkSweptTransformVisitor<'de> {
    type Value = hkSweptTransform;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkSweptTransform")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        for i in 0..5usize {
            match i {
                ...
                4usize => {
                    if _serde::__private::Option::is_some(&m_centerOfMassLocal) {
                        return _serde::__private::Err(
                            <__A::Error as _serde::de::Error>::duplicate_field(
                                "centerOfMassLocal",
                            ),
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkSweptTransform {

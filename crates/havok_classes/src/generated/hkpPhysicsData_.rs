...
const _: () = {
    ...
    impl __serde::HavokClass for hkpPhysicsData {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(3265552868u32)
        }
    }
    impl __serde::Serialize for hkpPhysicsData {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(3265552868u32)));

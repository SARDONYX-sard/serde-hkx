...
pub(super) struct __hkpPhysicsDataVisitor<'de> {
    marker: core::marker::PhantomData<hkpPhysicsData>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpPhysicsDataVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpPhysicsData, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkpPhysicsDataVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpPhysicsData")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        for i in 0..2usize {
            match i {
                0usize => {
                    if _serde::__private::Option::is_some(&m_worldCinfo) {
                ...
                1usize => {
                    if _serde::__private::Option::is_some(&m_systems) {
                        return _serde::__private::Err(
                            <__A::Error as _serde::de::Error>::duplicate_field("systems"),
                        );
                    }
        ...
        let m_worldCinfo = match m_worldCinfo {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("worldCinfo"),
                );
            }
        };
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpPhysicsData {
        ...
        where
            __D: _serde::Deserializer<'de>,
        {
            const FIELDS: &[&str] = &["worldCinfo", "systems"];
            _serde::Deserializer::deserialize_struct(
                deserializer,
                "hkpPhysicsData",
                FIELDS,
                __hkpPhysicsDataVisitor {
                    marker: _serde::__private::PhantomData::<hkpPhysicsData>,
                    lifetime: _serde::__private::PhantomData,
                },
            )

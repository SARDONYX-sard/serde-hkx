...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkaFootstepAnalysisInfo<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkaFootstepAnalysisInfo<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkaFootstepAnalysisInfo<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkaFootstepAnalysisInfoVisitor<'de> {
                marker: _serde::__private::PhantomData<hkaFootstepAnalysisInfo<'de>>,
            ...
            for __hkaFootstepAnalysisInfoVisitor<'de> {
                type Value = hkaFootstepAnalysisInfo<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

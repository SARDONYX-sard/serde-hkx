...
const _: () = {
    ...
    impl __serde::HavokClass for hkbTimerModifierInternalState {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(2213293378u32)
        }
    }
    impl __serde::Serialize for hkbTimerModifierInternalState {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(2213293378u32)));

...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkbTimerModifierInternalState<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkbTimerModifierInternalState<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbTimerModifierInternalState<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkbTimerModifierInternalStateVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkbTimerModifierInternalState<'de>,
                >,
            ...
            for __hkbTimerModifierInternalStateVisitor<'de> {
                type Value = hkbTimerModifierInternalState<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

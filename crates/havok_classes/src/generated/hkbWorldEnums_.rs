...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkbWorldEnums<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkbWorldEnums<'a> {
            ...
            S: _serde::ser::Serializer,
        {
            ...
            let mut serializer = __serializer
                .serialize_struct("hkbWorldEnums", class_meta, (1u64, 1u64))?;
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbWorldEnums<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkbWorldEnumsVisitor<'de> {
                marker: _serde::__private::PhantomData<hkbWorldEnums<'de>>,
...
/// # C++ Info
/// - name: `SimulationState`(ctype: `hkEnum<SimulationState, hkUint8>`)
#[allow(non_upper_case_globals, non_snake_case)]
#[cfg_attr(feature = "json_schema", derive(schemars::JsonSchema))]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(

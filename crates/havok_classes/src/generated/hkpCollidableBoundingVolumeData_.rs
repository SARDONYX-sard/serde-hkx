...
pub(super) struct __hkpCollidableBoundingVolumeDataVisitor<'de> {
    marker: core::marker::PhantomData<hkpCollidableBoundingVolumeData>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpCollidableBoundingVolumeDataVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpCollidableBoundingVolumeData, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpCollidableBoundingVolumeDataVisitor<'de> {
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        for i in 0..10usize {
            match i {
                ...
                6usize => {
                    if _serde::__private::Option::is_some(&m_numChildShapeAabbs) {
                        return _serde::__private::Err(
                            <__A::Error as _serde::de::Error>::duplicate_field(
                                "numChildShapeAabbs",
                            ),
                ...
                7usize => {
                    if _serde::__private::Option::is_some(&m_capacityChildShapeAabbs) {
                        return _serde::__private::Err(
                            <__A::Error as _serde::de::Error>::duplicate_field(
        ...
        let m_childShapeAabbs = match m_childShapeAabbs {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("childShapeAabbs"),
                );
            }
        };
        let m_childShapeKeys = match m_childShapeKeys {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("childShapeKeys"),
                );
            }
        };

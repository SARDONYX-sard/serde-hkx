...
const _: () = {
    ...
    impl __serde::HavokClass for hkpCollidableBoundingVolumeData {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(3052463793u32)
        }
    }
    impl __serde::Serialize for hkpCollidableBoundingVolumeData {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(3052463793u32)));

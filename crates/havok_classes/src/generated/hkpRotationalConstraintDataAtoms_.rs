...
pub(super) struct __hkpRotationalConstraintDataAtomsVisitor<'de> {
    marker: core::marker::PhantomData<hkpRotationalConstraintDataAtoms>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpRotationalConstraintDataAtomsVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpRotationalConstraintDataAtoms, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpRotationalConstraintDataAtomsVisitor<'de> {

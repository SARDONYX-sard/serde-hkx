...
pub struct hkPackedVector3<'a> {
    ...
    pub m_values: [I16<'a>; 4usize],
}
const _: () = {
    use havok_serde as _serde;
    impl<'a> _serde::HavokClass for hkPackedVector3<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkPackedVector3<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkPackedVector3<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkPackedVector3Visitor<'de> {
                marker: _serde::__private::PhantomData<hkPackedVector3<'de>>,
            ...
            impl<'de> _serde::de::Visitor<'de> for __hkPackedVector3Visitor<'de> {
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    let mut m_values: _serde::__private::Option<[I16<'de>; 4usize]> = _serde::__private::None;
                    for i in 0..1usize {
                        match i {
                            0usize => {
                                ...
                                m_values = _serde::__private::Some(
                                    match __A::next_value::<[I16<'de>; 4usize]>(&mut __map) {

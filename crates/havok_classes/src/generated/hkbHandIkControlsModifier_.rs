...
pub struct hkbHandIkControlsModifier<'a> {
    ...
    ///
    pub m_hands: Vec<hkbHandIkControlsModifierHand>,
}
const _: () = {
    ...
    impl<'a> _serde::Serialize for hkbHandIkControlsModifier<'a> {
            ...
            S: _serde::ser::Serializer,
        {
            ...
            let mut serializer = __serializer
                .serialize_struct("hkbHandIkControlsModifier", class_meta)?;
...
pub(super) struct __hkbHandIkControlsModifierVisitor<'de> {
    marker: core::marker::PhantomData<hkbHandIkControlsModifier<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbHandIkControlsModifierVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbHandIkControlsModifier<'de>, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkbHandIkControlsModifierVisitor<'de> {
    type Value = hkbHandIkControlsModifier<'de>;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkbHandIkControlsModifier")
    }

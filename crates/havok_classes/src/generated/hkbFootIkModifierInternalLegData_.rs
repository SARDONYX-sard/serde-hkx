...
pub(super) struct __hkbFootIkModifierInternalLegDataVisitor<'de> {
    marker: core::marker::PhantomData<hkbFootIkModifierInternalLegData>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbFootIkModifierInternalLegDataVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbFootIkModifierInternalLegData, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkbFootIkModifierInternalLegDataVisitor<'de> {
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let m_footIkSolver = match m_footIkSolver {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("footIkSolver"),
                );
            }
        };

...
const _: () = {
    ...
    impl __serde::HavokClass for hkpStiffSpringConstraintAtom {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(1813151894u32)
        }
    }
    impl __serde::Serialize for hkpStiffSpringConstraintAtom {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(1813151894u32)));

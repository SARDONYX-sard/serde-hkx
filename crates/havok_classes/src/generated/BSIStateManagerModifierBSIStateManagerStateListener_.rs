...
pub(super) struct __BSIStateManagerModifierBSIStateManagerStateListenerVisitor<'de> {
    marker: core::marker::PhantomData<
        BSIStateManagerModifierBSIStateManagerStateListener,
    >,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __BSIStateManagerModifierBSIStateManagerStateListenerVisitor<'de> {
...
for __BSIStateManagerModifierBSIStateManagerStateListenerVisitor<'de> {
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        for i in 0..1usize {
            match i {
                0usize => {
                    if _serde::__private::Option::is_some(&m_pStateManager) {
        ...
        let m_pStateManager = match m_pStateManager {
            _serde::__private::Some(__field) => __field,
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("pStateManager"),
                );
            }
        };
...
const _: () = {
    ...
    for BSIStateManagerModifierBSIStateManagerStateListener {
        ...
        where
            __D: _serde::Deserializer<'de>,
        {
            const FIELDS: &[&str] = &["pStateManager"];
            _serde::Deserializer::deserialize_struct(
                deserializer,
                "BSIStateManagerModifierBSIStateManagerStateListener",
                FIELDS,
                __BSIStateManagerModifierBSIStateManagerStateListenerVisitor {
                    marker: _serde::__private::PhantomData::<
                        BSIStateManagerModifierBSIStateManagerStateListener,
                    >,
                    lifetime: _serde::__private::PhantomData,

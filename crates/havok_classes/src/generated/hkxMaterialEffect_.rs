...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkxMaterialEffect<'a> {
        #[inline]
        ...
        fn signature(&self) -> _serde::__private::Signature {
            _serde::__private::Signature::new(0x1d39f925)
        }
    }
    impl<'a> _serde::Serialize for hkxMaterialEffect<'a> {
            ...
            S: _serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, _serde::__private::Signature::new(0x1d39f925)));
...
pub(super) struct __hkxMaterialEffectVisitor<'de> {
    marker: core::marker::PhantomData<hkxMaterialEffect<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkxMaterialEffectVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkxMaterialEffect<'de>, __A::Error>
    where
        __A: _serde::de::MapAccess<'de>,
    {
        _serde::de::Visitor::visit_struct(
            Self {
                marker: _serde::__private::PhantomData::<hkxMaterialEffect<'de>>,
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkxMaterialEffectVisitor<'de> {
    type Value = hkxMaterialEffect<'de>;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkxMaterialEffect")
    }
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkxMaterialEffect<'de> {
        fn deserialize<__D>(deserializer: __D) -> core::result::Result<Self, __D::Error>
        where
            __D: _serde::Deserializer<'de>,
        {
            const FIELDS: &[&str] = &["name", "type", "data"];
            _serde::Deserializer::deserialize_struct(
                deserializer,
                "hkxMaterialEffect",
                FIELDS,
                __hkxMaterialEffectVisitor {
                    marker: _serde::__private::PhantomData::<hkxMaterialEffect>,
                    lifetime: _serde::__private::PhantomData,
                },
            )
        }
...
const _: () = {
    ...
    #[automatically_derived]
    impl<'de> _serde::Deserialize<'de> for EffectType {
        fn deserialize<__D>(
            __deserializer: __D,
            ...
            __D: _serde::Deserializer<'de>,
        {
                    ...
                    __E: _serde::de::Error,
                {
                    if let Some(__value) = __value.into_inner() {
                        match __value.as_ref() {
                            ...
                            v if v == "2"
                                || v.eq_ignore_ascii_case("EFFECT_TYPE_HLSL_FX_INLINE") => {
                                _serde::__private::Ok(__Field::__field2)
                            }
                            v if v == "3"
                                || v.eq_ignore_ascii_case("EFFECT_TYPE_CG_FX_INLINE") => {
                                _serde::__private::Ok(__Field::__field3)
                            }
                            v if v == "4"
                                || v
                                    .eq_ignore_ascii_case("EFFECT_TYPE_HLSL_FX_FILENAME") => {
                                _serde::__private::Ok(__Field::__field4)
                            }
                            v if v == "5"
                                || v.eq_ignore_ascii_case("EFFECT_TYPE_CG_FX_FILENAME") => {
            ...
            #[doc(hidden)]
            struct __Visitor<'de> {
                marker: _serde::__private::PhantomData<EffectType>,
                    ...
                    __A: _serde::de::EnumAccess<'de>,
                {
                    match _serde::de::EnumAccess::variant(__data)? {
                        (__Field::__field0, __variant) => {
                            ...
                            _serde::__private::Ok(EffectType::EFFECT_TYPE_INVALID)
                        }
                        (__Field::__field1, __variant) => {
                            _serde::de::VariantAccess::unit_variant(__variant)?;
                            _serde::__private::Ok(EffectType::EFFECT_TYPE_UNKNOWN)
                        }
                        (__Field::__field2, __variant) => {
                            _serde::de::VariantAccess::unit_variant(__variant)?;
                            _serde::__private::Ok(EffectType::EFFECT_TYPE_HLSL_FX_INLINE)
                        }
                        (__Field::__field3, __variant) => {
                            _serde::de::VariantAccess::unit_variant(__variant)?;
                            _serde::__private::Ok(EffectType::EFFECT_TYPE_CG_FX_INLINE)
                        }
                        (__Field::__field4, __variant) => {
                            _serde::de::VariantAccess::unit_variant(__variant)?;
                            _serde::__private::Ok(
                                EffectType::EFFECT_TYPE_HLSL_FX_FILENAME,
                            )
                        }
                        (__Field::__field5, __variant) => {
                            _serde::de::VariantAccess::unit_variant(__variant)?;
                            _serde::__private::Ok(EffectType::EFFECT_TYPE_CG_FX_FILENAME)
                        }
                        (__Field::__field6, __variant) => {
                            _serde::de::VariantAccess::unit_variant(__variant)?;
                            _serde::__private::Ok(EffectType::EFFECT_TYPE_MAX_ID)
                        }
                    }
                }
            }

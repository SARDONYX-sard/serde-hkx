...
const _: () = {
    ...
    impl __serde::HavokClass for hkaAnimationPreviewColorContainer {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(1271186400u32)
        }
    }
    impl __serde::Serialize for hkaAnimationPreviewColorContainer {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(1271186400u32)));

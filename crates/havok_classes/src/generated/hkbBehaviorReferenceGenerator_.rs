...
const _: () = {
    ...
    impl<'a> __serde::HavokClass for hkbBehaviorReferenceGenerator<'a> {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(264983587u32)
        }
    }
    impl<'a> __serde::Serialize for hkbBehaviorReferenceGenerator<'a> {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(264983587u32)));

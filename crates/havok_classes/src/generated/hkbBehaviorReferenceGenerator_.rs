...
pub(super) struct __hkbBehaviorReferenceGeneratorVisitor<'de> {
    marker: core::marker::PhantomData<hkbBehaviorReferenceGenerator<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbBehaviorReferenceGeneratorVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbBehaviorReferenceGenerator<'de>, __A::Error>
    where
        ...
        _serde::de::Visitor::visit_struct(
            Self {
                marker: _serde::__private::PhantomData::<
                    hkbBehaviorReferenceGenerator<'de>,
                >,
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkbBehaviorReferenceGeneratorVisitor<'de> {
    type Value = hkbBehaviorReferenceGenerator<'de>;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbBehaviorReferenceGenerator<'de> {
        fn deserialize<__D>(deserializer: __D) -> core::result::Result<Self, __D::Error>
        where
            __D: _serde::Deserializer<'de>,
        {
            const FIELDS: &[&str] = &["behaviorName", "behavior"];
            _serde::Deserializer::deserialize_struct(
                deserializer,
                "hkbBehaviorReferenceGenerator",
                FIELDS,
                __hkbBehaviorReferenceGeneratorVisitor {
                    marker: _serde::__private::PhantomData::<
                        hkbBehaviorReferenceGenerator,
                    >,
                    lifetime: _serde::__private::PhantomData,

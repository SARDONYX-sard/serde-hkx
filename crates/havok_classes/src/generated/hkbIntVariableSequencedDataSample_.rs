...
const _: () = {
    ...
    impl _serde::HavokClass for hkbIntVariableSequencedDataSample {
        #[inline]
        ...
        fn signature(&self) -> _serde::__private::Signature {
            _serde::__private::Signature::new(0xbe7ac63c)
        }
    }
    impl _serde::Serialize for hkbIntVariableSequencedDataSample {
            ...
            S: _serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, _serde::__private::Signature::new(0xbe7ac63c)));
...
pub(super) struct __hkbIntVariableSequencedDataSampleVisitor<'de> {
    marker: core::marker::PhantomData<hkbIntVariableSequencedDataSample>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbIntVariableSequencedDataSampleVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbIntVariableSequencedDataSample, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkbIntVariableSequencedDataSampleVisitor<'de> {
    type Value = hkbIntVariableSequencedDataSample;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        _serde::__private::Ok(hkbIntVariableSequencedDataSample {
            __ptr,
            m_time,
            m_value,
        })
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbIntVariableSequencedDataSample {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            _serde::Deserializer::deserialize_struct(
                ...
                "hkbIntVariableSequencedDataSample",
                FIELDS,
                __hkbIntVariableSequencedDataSampleVisitor {
                    marker: _serde::__private::PhantomData::<
                        hkbIntVariableSequencedDataSample,
                    >,
                    lifetime: _serde::__private::PhantomData,

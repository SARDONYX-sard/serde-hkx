...
pub struct hkbIntVariableSequencedDataSample<'a> {
...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkbIntVariableSequencedDataSample<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkbIntVariableSequencedDataSample<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbIntVariableSequencedDataSample<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkbIntVariableSequencedDataSampleVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkbIntVariableSequencedDataSample<'de>,
                >,
            ...
            for __hkbIntVariableSequencedDataSampleVisitor<'de> {
                type Value = hkbIntVariableSequencedDataSample<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

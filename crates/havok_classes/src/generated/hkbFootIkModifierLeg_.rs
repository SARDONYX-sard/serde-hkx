...
pub struct hkbFootIkModifierLeg<'a> {
    ...
    #[cfg_attr(feature = "serde", serde(rename = "isOriginalAnkleTransformMSSet"))]
    pub m_isOriginalAnkleTransformMSSet: bool,
}
const _: () = {
    use havok_serde as _serde;
    impl<'a> _serde::HavokClass for hkbFootIkModifierLeg<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkbFootIkModifierLeg<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbFootIkModifierLeg<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkbFootIkModifierLegVisitor<'de> {
                marker: _serde::__private::PhantomData<hkbFootIkModifierLeg<'de>>,
            ...
            impl<'de> _serde::de::Visitor<'de> for __hkbFootIkModifierLegVisitor<'de> {
                type Value = hkbFootIkModifierLeg<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpBoxMotion<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpBoxMotion<'a> {
            ...
            S: _serde::ser::Serializer,
        {
            ...
            let mut serializer = __serializer
                .serialize_struct("hkpBoxMotion", class_meta, (288u64, 320u64))?;
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpBoxMotion<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpBoxMotionVisitor<'de> {
                marker: _serde::__private::PhantomData<hkpBoxMotion<'de>>,
            ...
            impl<'de> _serde::de::Visitor<'de> for __hkpBoxMotionVisitor<'de> {
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    let __ptr = __A::class_ptr(&mut __map);
                    _serde::__private::Ok(hkpBoxMotion {
                        __ptr: __ptr.clone(),
                        parent,
                    })
                }

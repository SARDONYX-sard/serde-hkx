...
pub(super) struct __hkMeshVertexBufferVisitor<'de> {
    marker: core::marker::PhantomData<hkMeshVertexBuffer>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkMeshVertexBufferVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkMeshVertexBuffer, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkMeshVertexBufferVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkMeshVertexBuffer")
    }

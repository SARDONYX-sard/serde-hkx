...
const _: () = {
    ...
    impl __serde::HavokClass for hkpWorld {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(2866605111u32)
        }
    }
    impl __serde::Serialize for hkpWorld {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(2866605111u32)));

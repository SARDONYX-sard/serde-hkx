...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkCustomAttributesAttribute<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkCustomAttributesAttributeVisitor<'de> {
                marker: _serde::__private::PhantomData<hkCustomAttributesAttribute<'de>>,
            ...
            for __hkCustomAttributesAttributeVisitor<'de> {

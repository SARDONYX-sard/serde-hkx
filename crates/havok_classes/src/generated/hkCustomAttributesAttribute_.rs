...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkCustomAttributesAttribute<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkCustomAttributesAttribute<'a> {
...
pub(super) struct __hkCustomAttributesAttributeVisitor<'de> {
    marker: core::marker::PhantomData<hkCustomAttributesAttribute<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkCustomAttributesAttributeVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkCustomAttributesAttribute<'de>, __A::Error>
    where
        ...
        _serde::de::Visitor::visit_struct(
            Self {
                marker: _serde::__private::PhantomData::<
                    hkCustomAttributesAttribute<'de>,
                >,
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkCustomAttributesAttributeVisitor<'de> {
    type Value = hkCustomAttributesAttribute<'de>;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkCustomAttributesAttribute<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            _serde::Deserializer::deserialize_struct(
                ...
                "hkCustomAttributesAttribute",
                FIELDS,
                __hkCustomAttributesAttributeVisitor {
                    marker: _serde::__private::PhantomData::<
                        hkCustomAttributesAttribute,
                    >,
                    lifetime: _serde::__private::PhantomData,

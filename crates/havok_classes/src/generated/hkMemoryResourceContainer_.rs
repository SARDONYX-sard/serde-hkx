...
pub(super) struct __hkMemoryResourceContainerVisitor<'de> {
    marker: core::marker::PhantomData<hkMemoryResourceContainer<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkMemoryResourceContainerVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkMemoryResourceContainer<'de>, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkMemoryResourceContainerVisitor<'de> {
    type Value = hkMemoryResourceContainer<'de>;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkMemoryResourceContainer")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let m_resourceHandles = match m_resourceHandles {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("resourceHandles"),
                );
            }
        };
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let parent = __hkResourceContainerVisitor::visit_as_parent(&mut __map)?;
        let mut m_name: _serde::__private::Option<StringPtr<'de>> = _serde::__private::None;
        let mut m_resourceHandles: _serde::__private::Option<Vec<Pointer>> = _serde::__private::None;
        let mut m_children: _serde::__private::Option<Vec<Pointer>> = _serde::__private::None;
        for _ in 0..3usize {

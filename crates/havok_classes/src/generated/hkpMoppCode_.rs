...
pub(super) struct __hkpMoppCodeVisitor<'de> {
    marker: core::marker::PhantomData<hkpMoppCode>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpMoppCodeVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpMoppCode, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkpMoppCodeVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpMoppCode")
    }
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpMoppCode {
        ...
        where
            __D: _serde::Deserializer<'de>,
        {
            const FIELDS: &[&str] = &["info", "data", "buildType"];
            _serde::Deserializer::deserialize_struct(
                deserializer,
                "hkpMoppCode",
                FIELDS,
                __hkpMoppCodeVisitor {
                    marker: _serde::__private::PhantomData::<hkpMoppCode>,
                    lifetime: _serde::__private::PhantomData,
                },
            )

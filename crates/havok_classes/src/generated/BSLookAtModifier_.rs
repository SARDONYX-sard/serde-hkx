...
const _: () = {
    ...
    impl<'a> __serde::HavokClass for BSLookAtModifier<'a> {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(3612802085u32)
        }
    }
    impl<'a> __serde::Serialize for BSLookAtModifier<'a> {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(3612802085u32)));

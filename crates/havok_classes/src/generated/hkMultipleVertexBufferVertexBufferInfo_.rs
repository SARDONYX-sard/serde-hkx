...
const _: () = {
    ...
    impl __serde::HavokClass for hkMultipleVertexBufferVertexBufferInfo {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(3673940198u32)
        }
    }
    impl __serde::Serialize for hkMultipleVertexBufferVertexBufferInfo {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(3673940198u32)));

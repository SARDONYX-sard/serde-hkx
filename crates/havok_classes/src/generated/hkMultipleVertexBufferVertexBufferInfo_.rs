...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkMultipleVertexBufferVertexBufferInfo<'a> {
        #[inline]
        ...
        fn deps_indexes(&self) -> Vec<&Pointer<'_>> {
            ...
            v.push(&self.m_lockedVertices);
            v
        }
    }
    impl<'a> _serde::Serialize for hkMultipleVertexBufferVertexBufferInfo<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkMultipleVertexBufferVertexBufferInfo<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkMultipleVertexBufferVertexBufferInfoVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkMultipleVertexBufferVertexBufferInfo<'de>,
                >,
            ...
            for __hkMultipleVertexBufferVertexBufferInfoVisitor<'de> {
                type Value = hkMultipleVertexBufferVertexBufferInfo<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    let mut m_lockedVertices: _serde::__private::Option<Pointer<'de>> = _serde::__private::None;

...
pub(super) struct __hkpKeyframedRigidMotionVisitor<'de> {
    marker: core::marker::PhantomData<hkpKeyframedRigidMotion>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpKeyframedRigidMotionVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpKeyframedRigidMotion, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpKeyframedRigidMotionVisitor<'de> {
    type Value = hkpKeyframedRigidMotion;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpKeyframedRigidMotion")
    }

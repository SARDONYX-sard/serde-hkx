...
pub(super) struct __hkpConvexTransformShapeBaseVisitor<'de> {
    marker: core::marker::PhantomData<hkpConvexTransformShapeBase>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpConvexTransformShapeBaseVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpConvexTransformShapeBase, __A::Error>
    where
        __A: _serde::de::MapAccess<'de>,
    {
        _serde::de::Visitor::visit_struct(
            Self {
                marker: _serde::__private::PhantomData::<hkpConvexTransformShapeBase>,
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpConvexTransformShapeBaseVisitor<'de> {
    type Value = hkpConvexTransformShapeBase;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let m_childShapeSize = match m_childShapeSize {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("childShapeSize"),
                );
            }
        };
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpConvexTransformShapeBase {
        fn deserialize<__D>(deserializer: __D) -> core::result::Result<Self, __D::Error>
        where
            __D: _serde::Deserializer<'de>,
        {
            const FIELDS: &[&str] = &["childShape", "childShapeSize"];
            _serde::Deserializer::deserialize_struct(
                deserializer,
                "hkpConvexTransformShapeBase",
                FIELDS,
                __hkpConvexTransformShapeBaseVisitor {

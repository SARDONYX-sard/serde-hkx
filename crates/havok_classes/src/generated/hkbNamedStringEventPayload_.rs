...
pub(super) struct __hkbNamedStringEventPayloadVisitor<'de> {
    marker: core::marker::PhantomData<hkbNamedStringEventPayload<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbNamedStringEventPayloadVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbNamedStringEventPayload<'de>, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkbNamedStringEventPayloadVisitor<'de> {
    type Value = hkbNamedStringEventPayload<'de>;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkbNamedStringEventPayload")
    }

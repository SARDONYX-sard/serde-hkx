...
const _: () = {
    ...
    impl __serde::HavokClass for hkpStorageSampledHeightFieldShape {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(369049931u32)
        }
    }
    impl __serde::Serialize for hkpStorageSampledHeightFieldShape {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(369049931u32)));

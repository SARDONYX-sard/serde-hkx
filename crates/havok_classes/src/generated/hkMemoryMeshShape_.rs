...
pub(super) struct __hkMemoryMeshShapeVisitor<'de> {
    marker: core::marker::PhantomData<hkMemoryMeshShape<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkMemoryMeshShapeVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkMemoryMeshShape<'de>, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkMemoryMeshShapeVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkMemoryMeshShape")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let mut m_sections: _serde::__private::Option<Vec<hkMeshSectionCinfo>> = _serde::__private::None;
            ...
            match i {
                0usize => {
                    ...
                    m_sections = _serde::__private::Some(
                        match __A::next_value::<Vec<hkMeshSectionCinfo>>(&mut __map) {
    ...
    {
        let __ptr = __A::class_ptr(&mut __map);
        let parent = __hkMeshShapeVisitor::visit_as_parent(&mut __map)?;
        let mut m_sections: _serde::__private::Option<Vec<hkMeshSectionCinfo>> = _serde::__private::None;
        let mut m_indices16: _serde::__private::Option<Vec<u16>> = _serde::__private::None;
        let mut m_indices32: _serde::__private::Option<Vec<u32>> = _serde::__private::None;
        let mut m_name: _serde::__private::Option<StringPtr<'de>> = _serde::__private::None;

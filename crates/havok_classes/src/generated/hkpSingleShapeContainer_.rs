...
pub struct hkpSingleShapeContainer<'a> {
    ...
    #[cfg_attr(feature = "serde", serde(borrow))]
    pub parent: hkpShapeContainer<'a>,
    /// # C++ Info
    ...
    pub m_childShape: Pointer<'a>,
}
const _: () = {
    use havok_serde as _serde;
    impl<'a> _serde::HavokClass for hkpSingleShapeContainer<'a> {
        #[inline]
        ...
        fn deps_indexes(&self) -> Vec<&Pointer<'_>> {
            let mut v = Vec::new();
            v.push(&self.m_childShape);
            v
        }
    }
    impl<'a> _serde::Serialize for hkpSingleShapeContainer<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpSingleShapeContainer<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpSingleShapeContainerVisitor<'de> {
                marker: _serde::__private::PhantomData<hkpSingleShapeContainer<'de>>,
            ...
            for __hkpSingleShapeContainerVisitor<'de> {
                type Value = hkpSingleShapeContainer<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    let mut m_childShape: _serde::__private::Option<Pointer<'de>> = _serde::__private::None;
                    for i in 0..1usize {
                        match i {
                            0usize => {

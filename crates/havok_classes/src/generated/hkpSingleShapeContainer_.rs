...
const _: () = {
    ...
    impl __serde::HavokClass for hkpSingleShapeContainer {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(1940528440u32)
        }
    }
    impl __serde::Serialize for hkpSingleShapeContainer {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(1940528440u32)));

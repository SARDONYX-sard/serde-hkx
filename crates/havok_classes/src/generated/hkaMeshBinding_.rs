...
impl<'de> _serde::de::Visitor<'de> for __FieldVisitor {
        ...
        __E: _serde::de::Error,
    {
        match __value {
            ...
            "boneFromSkinMeshTransforms" => Ok(__Field::m_boneFromSkinMeshTransforms),
...
pub(super) struct __hkaMeshBindingVisitor<'de> {
    marker: core::marker::PhantomData<hkaMeshBinding<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkaMeshBindingVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkaMeshBinding<'de>, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkaMeshBindingVisitor<'de> {
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let mut m_mappings: _serde::__private::Option<Vec<hkaMeshBindingMapping>> = _serde::__private::None;

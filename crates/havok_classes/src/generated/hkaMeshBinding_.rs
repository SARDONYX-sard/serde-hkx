...
const _: () = {
    ...
    impl<'a> __serde::HavokClass for hkaMeshBinding<'a> {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(2178520331u32)
        }
    }
    impl<'a> __serde::Serialize for hkaMeshBinding<'a> {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(2178520331u32)));

...
pub struct hkpRackAndPinionConstraintData<'a> {
    ...
    pub m_atoms: hkpRackAndPinionConstraintDataAtoms<'a>,
}
const _: () = {
    use havok_serde as _serde;
    impl<'a> _serde::HavokClass for hkpRackAndPinionConstraintData<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpRackAndPinionConstraintData<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpRackAndPinionConstraintData<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpRackAndPinionConstraintDataVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkpRackAndPinionConstraintData<'de>,
                >,
            ...
            for __hkpRackAndPinionConstraintDataVisitor<'de> {
                type Value = hkpRackAndPinionConstraintData<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

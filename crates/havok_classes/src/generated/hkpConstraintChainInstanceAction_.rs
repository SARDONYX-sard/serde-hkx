...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpConstraintChainInstanceAction<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpConstraintChainInstanceAction<'a> {
...
impl<'de> _serde::de::Visitor<'de> for __FieldVisitor {
    ...
    {
        match __value {
            "constraintInstance" => Ok(__Field::m_constraintInstance),
...
pub(super) struct __hkpConstraintChainInstanceActionVisitor<'de> {
    marker: core::marker::PhantomData<hkpConstraintChainInstanceAction<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpConstraintChainInstanceActionVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpConstraintChainInstanceAction<'de>, __A::Error>
    where
        ...
        _serde::de::Visitor::visit_struct(
            Self {
                marker: _serde::__private::PhantomData::<
                    hkpConstraintChainInstanceAction<'de>,
                >,
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpConstraintChainInstanceActionVisitor<'de> {
    type Value = hkpConstraintChainInstanceAction<'de>;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpConstraintChainInstanceAction<'de> {
        fn deserialize<__D>(deserializer: __D) -> core::result::Result<Self, __D::Error>
        where
            __D: _serde::Deserializer<'de>,
        {
            const FIELDS: &[&str] = &["constraintInstance"];
            _serde::Deserializer::deserialize_struct(
                deserializer,
                "hkpConstraintChainInstanceAction",
                FIELDS,
                __hkpConstraintChainInstanceActionVisitor {
                    marker: _serde::__private::PhantomData::<
                        hkpConstraintChainInstanceAction,
                    >,
                    lifetime: _serde::__private::PhantomData,

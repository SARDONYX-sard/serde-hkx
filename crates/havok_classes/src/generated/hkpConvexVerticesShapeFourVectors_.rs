...
const _: () = {
    ...
    impl __serde::HavokClass for hkpConvexVerticesShapeFourVectors {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(1031849407u32)
        }
    }
    impl __serde::Serialize for hkpConvexVerticesShapeFourVectors {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(1031849407u32)));

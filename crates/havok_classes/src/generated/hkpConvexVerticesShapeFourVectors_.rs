...
const _: () = {
    ...
    impl _serde::HavokClass for hkpConvexVerticesShapeFourVectors {
        ...
        fn signature(&self) -> _serde::__private::Signature {
            _serde::__private::Signature::new(0x3d80c5bf)
        }
    }
...
pub(super) struct __hkpConvexVerticesShapeFourVectorsVisitor<'de> {
    marker: core::marker::PhantomData<hkpConvexVerticesShapeFourVectors>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpConvexVerticesShapeFourVectorsVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpConvexVerticesShapeFourVectors, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpConvexVerticesShapeFourVectorsVisitor<'de> {
    type Value = hkpConvexVerticesShapeFourVectors;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpConvexVerticesShapeFourVectors {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            _serde::Deserializer::deserialize_struct(
                ...
                "hkpConvexVerticesShapeFourVectors",
                FIELDS,
                __hkpConvexVerticesShapeFourVectorsVisitor {
                    marker: _serde::__private::PhantomData::<
                        hkpConvexVerticesShapeFourVectors,
                    >,
                    lifetime: _serde::__private::PhantomData,

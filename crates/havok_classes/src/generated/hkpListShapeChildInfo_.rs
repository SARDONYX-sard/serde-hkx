...
const _: () = {
    ...
    impl __serde::HavokClass for hkpListShapeChildInfo {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(2162102160u32)
        }
    }
    impl __serde::Serialize for hkpListShapeChildInfo {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(2162102160u32)));

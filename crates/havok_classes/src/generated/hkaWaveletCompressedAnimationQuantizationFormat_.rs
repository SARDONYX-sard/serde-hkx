...
use super::*;
/// # C++ Info
/// -            name: `hkaWaveletCompressedAnimationQuantizationFormat`
/// -         version: `0`
...
const _: () = {
    ...
    impl _serde::HavokClass for hkaWaveletCompressedAnimationQuantizationFormat {
        #[inline]
    ...
    impl _serde::Serialize for hkaWaveletCompressedAnimationQuantizationFormat {
...
pub(super) struct __hkaWaveletCompressedAnimationQuantizationFormatVisitor<'de> {
    marker: core::marker::PhantomData<hkaWaveletCompressedAnimationQuantizationFormat>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkaWaveletCompressedAnimationQuantizationFormatVisitor<'de> {
...
for __hkaWaveletCompressedAnimationQuantizationFormatVisitor<'de> {
    type Value = hkaWaveletCompressedAnimationQuantizationFormat;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
...
const _: () = {
    ...
    for hkaWaveletCompressedAnimationQuantizationFormat {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            _serde::Deserializer::deserialize_struct(
                ...
                "hkaWaveletCompressedAnimationQuantizationFormat",
                FIELDS,
                __hkaWaveletCompressedAnimationQuantizationFormatVisitor {
                    marker: _serde::__private::PhantomData::<
                        hkaWaveletCompressedAnimationQuantizationFormat,
                    >,
                    lifetime: _serde::__private::PhantomData,

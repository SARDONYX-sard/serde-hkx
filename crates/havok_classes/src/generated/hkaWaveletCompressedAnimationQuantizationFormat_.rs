...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkaWaveletCompressedAnimationQuantizationFormat<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkaWaveletCompressedAnimationQuantizationFormat<'a> {
...
const _: () = {
    ...
    for hkaWaveletCompressedAnimationQuantizationFormat<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkaWaveletCompressedAnimationQuantizationFormatVisitor<'de> {
            ...
            for __hkaWaveletCompressedAnimationQuantizationFormatVisitor<'de> {
                type Value = hkaWaveletCompressedAnimationQuantizationFormat<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

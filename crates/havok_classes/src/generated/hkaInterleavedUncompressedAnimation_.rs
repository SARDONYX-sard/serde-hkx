...
pub(super) struct __hkaInterleavedUncompressedAnimationVisitor<'de> {
    marker: core::marker::PhantomData<hkaInterleavedUncompressedAnimation<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkaInterleavedUncompressedAnimationVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkaInterleavedUncompressedAnimation<'de>, __A::Error>
    where

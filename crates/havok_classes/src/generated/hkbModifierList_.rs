    ...
    impl<'a> _serde::Serialize for hkbModifierList<'a> {
            ...
            S: _serde::ser::Serializer,
        {
            ...
            let mut serializer = __serializer
                .serialize_struct("hkbModifierList", class_meta)?;
            ...
            serializer.pad_field([0u8; 0usize].as_slice(), [0u8; 4usize].as_slice())?;
            serializer.serialize_array_meta_field("modifiers", &self.m_modifiers)?;
            serializer
...
pub(super) struct __hkbModifierListVisitor<'de> {
    marker: core::marker::PhantomData<hkbModifierList<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbModifierListVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbModifierList<'de>, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkbModifierListVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkbModifierList")
    }

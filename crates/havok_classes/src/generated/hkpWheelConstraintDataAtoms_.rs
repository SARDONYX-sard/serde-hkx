...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpWheelConstraintDataAtoms<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpWheelConstraintDataAtoms<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpWheelConstraintDataAtoms<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpWheelConstraintDataAtomsVisitor<'de> {
                marker: _serde::__private::PhantomData<hkpWheelConstraintDataAtoms<'de>>,
            ...
            for __hkpWheelConstraintDataAtomsVisitor<'de> {
                type Value = hkpWheelConstraintDataAtoms<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

...
const _: () = {
    ...
    impl __serde::HavokClass for hkbContext {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(3770995879u32)
        }
    }
    impl __serde::Serialize for hkbContext {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(3770995879u32)));

...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkbVariableValue<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkbVariableValue<'a> {
            ...
            S: _serde::ser::Serializer,
        {
            ...
            let mut serializer = __serializer
                .serialize_struct("hkbVariableValue", class_meta, (4u64, 4u64))?;
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbVariableValue<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkbVariableValueVisitor<'de> {
                marker: _serde::__private::PhantomData<hkbVariableValue<'de>>,
            ...
            impl<'de> _serde::de::Visitor<'de> for __hkbVariableValueVisitor<'de> {
                type Value = hkbVariableValue<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    _serde::__private::Ok(hkbVariableValue { __ptr, m_value })
                }

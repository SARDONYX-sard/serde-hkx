...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkbEvaluateExpressionModifier<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkbEvaluateExpressionModifier<'a> {
...
impl<'de> _serde::de::Visitor<'de> for __FieldVisitor {
    ...
    {
        match __value {
            "expressions" => Ok(__Field::m_expressions),
...
pub(super) struct __hkbEvaluateExpressionModifierVisitor<'de> {
    marker: core::marker::PhantomData<hkbEvaluateExpressionModifier<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbEvaluateExpressionModifierVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbEvaluateExpressionModifier<'de>, __A::Error>
    where
        ...
        _serde::de::Visitor::visit_struct(
            Self {
                marker: _serde::__private::PhantomData::<
                    hkbEvaluateExpressionModifier<'de>,
                >,
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkbEvaluateExpressionModifierVisitor<'de> {
    type Value = hkbEvaluateExpressionModifier<'de>;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let mut m_internalExpressionsData: _serde::__private::Option<Vec<()>> = _serde::__private::None;
        for i in 0..3usize {
            match i {
                0usize => {
                    if _serde::__private::Option::is_some(&m_expressions) {
                ...
                1usize => {
                    if _serde::__private::Option::is_some(&m_compiledExpressionSet) {
                        return _serde::__private::Err(
                            <__A::Error as _serde::de::Error>::duplicate_field(
                ...
                2usize => {
                    if _serde::__private::Option::is_some(&m_internalExpressionsData) {
                        return _serde::__private::Err(
                            <__A::Error as _serde::de::Error>::duplicate_field(
                                "internalExpressionsData",
                            ),
                    ...
                    m_internalExpressionsData = _serde::__private::Some(
        ...
        let m_expressions = match m_expressions {
            _serde::__private::Some(__field) => __field,
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("expressions"),
                );
            }
        };
        let m_compiledExpressionSet = match m_compiledExpressionSet {
            _serde::__private::Some(__field) => __field,
            _serde::__private::None => {
                return _serde::__private::Err(
        ...
        let m_internalExpressionsData = match m_internalExpressionsData {
            _serde::__private::Some(__field) => __field,
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field(
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbEvaluateExpressionModifier<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            _serde::Deserializer::deserialize_struct(
                ...
                "hkbEvaluateExpressionModifier",
                FIELDS,
                __hkbEvaluateExpressionModifierVisitor {
                    marker: _serde::__private::PhantomData::<
                        hkbEvaluateExpressionModifier,
                    >,
                    lifetime: _serde::__private::PhantomData,

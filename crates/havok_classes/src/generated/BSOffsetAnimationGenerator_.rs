...
pub(super) struct __BSOffsetAnimationGeneratorVisitor<'de> {
    marker: core::marker::PhantomData<BSOffsetAnimationGenerator<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __BSOffsetAnimationGeneratorVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<BSOffsetAnimationGenerator<'de>, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __BSOffsetAnimationGeneratorVisitor<'de> {
    type Value = BSOffsetAnimationGenerator<'de>;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct BSOffsetAnimationGenerator")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        for i in 0..11usize {
            match i {
                ...
                7usize => {
                    if _serde::__private::Option::is_some(&m_fCurrentPercentage) {
                        return _serde::__private::Err(
                            <__A::Error as _serde::de::Error>::duplicate_field(
                                "fCurrentPercentage",
                            ),
        ...
        let m_BoneOffsetA = match m_BoneOffsetA {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("BoneOffsetA"),
                );
            }
        };
        let m_BoneIndexA = match m_BoneIndexA {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("BoneIndexA"),
                );
            }
        };
        ...
        let m_iCurrentFrame = match m_iCurrentFrame {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("iCurrentFrame"),
                );
            }
        };
        let m_bZeroOffset = match m_bZeroOffset {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("bZeroOffset"),
                );
            }
        };
        let m_bOffsetValid = match m_bOffsetValid {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("bOffsetValid"),
                );
            }
        };

...
pub(super) struct __hkpCdBodyVisitor<'de> {
    marker: core::marker::PhantomData<hkpCdBody>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpCdBodyVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpCdBody, __A::Error>
    where

...
pub struct hkpSerializedTrack1nInfo<'a> {
    ...
    pub m_subTracks: Vec<Pointer<'a>>,
}
const _: () = {
    use havok_serde as _serde;
    impl<'a> _serde::HavokClass for hkpSerializedTrack1nInfo<'a> {
        #[inline]
        ...
        fn deps_indexes(&self) -> Vec<&Pointer<'_>> {
            let mut v = Vec::new();
            v.extend(self.m_sectors.iter());
            v.extend(self.m_subTracks.iter());
            v
        }
    }
    impl<'a> _serde::Serialize for hkpSerializedTrack1nInfo<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpSerializedTrack1nInfo<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpSerializedTrack1nInfoVisitor<'de> {
                marker: _serde::__private::PhantomData<hkpSerializedTrack1nInfo<'de>>,
            ...
            for __hkpSerializedTrack1nInfoVisitor<'de> {
                type Value = hkpSerializedTrack1nInfo<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

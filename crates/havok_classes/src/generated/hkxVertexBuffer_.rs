...
const _: () = {
    ...
    impl __serde::HavokClass for hkxVertexBuffer {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(1253115413u32)
        }
    }
    impl __serde::Serialize for hkxVertexBuffer {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(1253115413u32)));

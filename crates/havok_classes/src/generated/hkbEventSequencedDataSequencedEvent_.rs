...
pub(super) struct __hkbEventSequencedDataSequencedEventVisitor<'de> {
    marker: core::marker::PhantomData<hkbEventSequencedDataSequencedEvent>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbEventSequencedDataSequencedEventVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbEventSequencedDataSequencedEvent, __A::Error>
    where

...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkbGeneratorTransitionEffectInternalState<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkbGeneratorTransitionEffectInternalState<'a> {
...
const _: () = {
    ...
    for hkbGeneratorTransitionEffectInternalState<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkbGeneratorTransitionEffectInternalStateVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkbGeneratorTransitionEffectInternalState<'de>,
                >,
            ...
            for __hkbGeneratorTransitionEffectInternalStateVisitor<'de> {
                type Value = hkbGeneratorTransitionEffectInternalState<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

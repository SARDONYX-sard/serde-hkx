...
impl<'de> _serde::de::Visitor<'de> for __FieldVisitor {
        ...
        __E: _serde::de::Error,
    {
        match __value {
            ...
            "primaryTransmissionRatio" => Ok(__Field::m_primaryTransmissionRatio),
...
pub(super) struct __hkpVehicleDefaultTransmissionVisitor<'de> {
    marker: core::marker::PhantomData<hkpVehicleDefaultTransmission>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpVehicleDefaultTransmissionVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpVehicleDefaultTransmission, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpVehicleDefaultTransmissionVisitor<'de> {

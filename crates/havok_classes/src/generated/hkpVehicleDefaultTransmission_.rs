...
const _: () = {
    ...
    impl __serde::HavokClass for hkpVehicleDefaultTransmission {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(593321323u32)
        }
    }
    impl __serde::Serialize for hkpVehicleDefaultTransmission {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(593321323u32)));

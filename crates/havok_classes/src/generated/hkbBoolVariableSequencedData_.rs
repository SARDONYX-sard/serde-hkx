...
pub struct hkbBoolVariableSequencedData<'a> {
    ...
    pub m_samples: Vec<hkbBoolVariableSequencedDataSample<'a>>,
    /// # C++ Info
...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkbBoolVariableSequencedData<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkbBoolVariableSequencedData<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbBoolVariableSequencedData<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkbBoolVariableSequencedDataVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkbBoolVariableSequencedData<'de>,
                >,
            ...
            for __hkbBoolVariableSequencedDataVisitor<'de> {
                type Value = hkbBoolVariableSequencedData<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

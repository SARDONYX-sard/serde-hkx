...
const _: () = {
    ...
    impl _serde::HavokClass for hkbBoolVariableSequencedData {
        #[inline]
        ...
        fn signature(&self) -> _serde::__private::Signature {
            _serde::__private::Signature::new(0x37416fce)
        }
    }
    impl _serde::Serialize for hkbBoolVariableSequencedData {
...
pub(super) struct __hkbBoolVariableSequencedDataVisitor<'de> {
    marker: core::marker::PhantomData<hkbBoolVariableSequencedData>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbBoolVariableSequencedDataVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbBoolVariableSequencedData, __A::Error>
    where
        __A: _serde::de::MapAccess<'de>,
    {
        _serde::de::Visitor::visit_struct(
            Self {
                marker: _serde::__private::PhantomData::<hkbBoolVariableSequencedData>,
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkbBoolVariableSequencedDataVisitor<'de> {
    type Value = hkbBoolVariableSequencedData;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        _serde::__private::Ok(hkbBoolVariableSequencedData {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbBoolVariableSequencedData {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            _serde::Deserializer::deserialize_struct(
                ...
                "hkbBoolVariableSequencedData",
                FIELDS,
                __hkbBoolVariableSequencedDataVisitor {

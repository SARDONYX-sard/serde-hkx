...
pub struct hkbStringCondition<'a> {
    ...
    #[cfg_attr(feature = "json_schema", schemars(rename = "conditionString"))]
    #[cfg_attr(feature = "serde", serde(rename = "conditionString"))]
...
const _: () = {
    ...
    impl<'a> _serde::Serialize for hkbStringCondition<'a> {
            ...
            S: _serde::ser::Serializer,
        {
            ...
            serializer.serialize_field("conditionString", &self.m_conditionString)?;
            serializer.end()
        }
    }
};
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbStringCondition<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkbStringConditionVisitor<'de> {
            ...
            impl<'de> _serde::de::Visitor<'de> for __hkbStringConditionVisitor<'de> {
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    let mut m_conditionString: _serde::__private::Option<
                        StringPtr<'de>,

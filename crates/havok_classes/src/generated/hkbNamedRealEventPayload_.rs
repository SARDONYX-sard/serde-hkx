...
const _: () = {
    ...
    impl<'a> __serde::HavokClass for hkbNamedRealEventPayload<'a> {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(2627337584u32)
        }
    }
    impl<'a> __serde::Serialize for hkbNamedRealEventPayload<'a> {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(2627337584u32)));

...
pub(super) struct __hkbSetLocalTimeOfClipGeneratorCommandVisitor<'de> {
    marker: core::marker::PhantomData<hkbSetLocalTimeOfClipGeneratorCommand>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbSetLocalTimeOfClipGeneratorCommandVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbSetLocalTimeOfClipGeneratorCommand, __A::Error>
    where

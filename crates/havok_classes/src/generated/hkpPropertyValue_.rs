...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpPropertyValue<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpPropertyValue<'a> {
            ...
            S: _serde::ser::Serializer,
        {
            ...
            let mut serializer = __serializer
                .serialize_struct("hkpPropertyValue", class_meta, (8u64, 8u64))?;
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpPropertyValue<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpPropertyValueVisitor<'de> {
                marker: _serde::__private::PhantomData<hkpPropertyValue<'de>>,
            ...
            impl<'de> _serde::de::Visitor<'de> for __hkpPropertyValueVisitor<'de> {
                type Value = hkpPropertyValue<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    let mut m_data: _serde::__private::Option<U64<'de>> = _serde::__private::None;
                    for i in 0..1usize {
                        match i {
                            0usize => {
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    let __ptr = __A::class_ptr(&mut __map);
                    _serde::__private::Ok(hkpPropertyValue {
                        __ptr: __ptr.clone(),
                        m_data,
                    })
                }

...
pub(super) struct __hkbBindableVisitor<'de> {
    marker: core::marker::PhantomData<hkbBindable>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbBindableVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbBindable, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkbBindableVisitor<'de> {
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        for i in 0..3usize {
            match i {
                0usize => {
                    if _serde::__private::Option::is_some(&m_variableBindingSet) {
                ...
                2usize => {
                    if _serde::__private::Option::is_some(&m_areBindablesCached) {
                        return _serde::__private::Err(
                            <__A::Error as _serde::de::Error>::duplicate_field(
                                "areBindablesCached",
                            ),
        ...
        let m_cachedBindables = match m_cachedBindables {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("cachedBindables"),
                );
            }
        };

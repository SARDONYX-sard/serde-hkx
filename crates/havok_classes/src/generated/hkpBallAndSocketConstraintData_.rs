...
pub struct hkpBallAndSocketConstraintData<'a> {
    ...
    pub m_atoms: hkpBallAndSocketConstraintDataAtoms<'a>,
}
const _: () = {
    use havok_serde as _serde;
    impl<'a> _serde::HavokClass for hkpBallAndSocketConstraintData<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpBallAndSocketConstraintData<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpBallAndSocketConstraintData<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpBallAndSocketConstraintDataVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkpBallAndSocketConstraintData<'de>,
                >,
            ...
            for __hkpBallAndSocketConstraintDataVisitor<'de> {
                type Value = hkpBallAndSocketConstraintData<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

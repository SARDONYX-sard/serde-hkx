...
const _: () = {
    ...
    impl __serde::HavokClass for hkpBallAndSocketConstraintData {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(1516852441u32)
        }
    }
    impl __serde::Serialize for hkpBallAndSocketConstraintData {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(1516852441u32)));

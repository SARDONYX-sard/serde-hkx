...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkBaseObject<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkBaseObject<'a> {
            ...
            S: _serde::ser::Serializer,
        {
            ...
            let mut serializer = __serializer
                .serialize_struct("hkBaseObject", class_meta, (4u64, 8u64))?;
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkBaseObject<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkBaseObjectVisitor<'de> {
                marker: _serde::__private::PhantomData<hkBaseObject<'de>>,

...
const _: () = {
    ...
    impl __serde::HavokClass for hkxVertexDescriptionElementDecl {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(1211777691u32)
        }
    }
    impl __serde::Serialize for hkxVertexDescriptionElementDecl {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(1211777691u32)));

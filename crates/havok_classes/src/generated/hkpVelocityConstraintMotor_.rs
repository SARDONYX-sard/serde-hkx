...
const _: () = {
    ...
    impl _serde::HavokClass for hkpVelocityConstraintMotor {
        #[inline]
    ...
    impl _serde::Serialize for hkpVelocityConstraintMotor {
...
pub(super) struct __hkpVelocityConstraintMotorVisitor<'de> {
    marker: core::marker::PhantomData<hkpVelocityConstraintMotor>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpVelocityConstraintMotorVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpVelocityConstraintMotor, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpVelocityConstraintMotorVisitor<'de> {
    type Value = hkpVelocityConstraintMotor;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpVelocityConstraintMotor")
    }
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpVelocityConstraintMotor {

...
const _: () = {
    ...
    impl __serde::HavokClass for hkbStateMachineTransitionInfoReference {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(2551235280u32)
        }
    }
    impl __serde::Serialize for hkbStateMachineTransitionInfoReference {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(2551235280u32)));

...
const _: () = {
    ...
    impl<'a> __serde::HavokClass for hkbMoveCharacterModifier<'a> {
        fn name(&self) -> &'static core::ffi::CStr {
            c"hkbMoveCharacterModifier"
        }
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(2406781600u32)
        }
    }
    impl<'a> __serde::Serialize for hkbMoveCharacterModifier<'a> {

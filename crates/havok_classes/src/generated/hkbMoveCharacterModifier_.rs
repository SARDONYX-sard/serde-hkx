...
pub(super) struct __hkbMoveCharacterModifierVisitor<'de> {
    marker: core::marker::PhantomData<hkbMoveCharacterModifier<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbMoveCharacterModifierVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbMoveCharacterModifier<'de>, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkbMoveCharacterModifierVisitor<'de> {
    type Value = hkbMoveCharacterModifier<'de>;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkbMoveCharacterModifier")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        for i in 0..2usize {
            match i {
                0usize => {
                    if _serde::__private::Option::is_some(&m_offsetPerSecondMS) {
        ...
        let m_offsetPerSecondMS = match m_offsetPerSecondMS {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("offsetPerSecondMS"),
                );
            }
        };

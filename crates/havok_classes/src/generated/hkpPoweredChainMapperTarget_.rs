...
pub(super) struct __hkpPoweredChainMapperTargetVisitor<'de> {
    marker: core::marker::PhantomData<hkpPoweredChainMapperTarget>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpPoweredChainMapperTargetVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpPoweredChainMapperTarget, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpPoweredChainMapperTargetVisitor<'de> {
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let m_infoIndex = match m_infoIndex {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("infoIndex"),
                );
            }
        };

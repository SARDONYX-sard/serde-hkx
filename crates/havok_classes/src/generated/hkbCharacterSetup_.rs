...
impl<'de> _serde::de::Visitor<'de> for __FieldVisitor {
    ...
    {
        match __value {
            "retargetingSkeletonMappers" => Ok(__Field::m_retargetingSkeletonMappers),
...
pub(super) struct __hkbCharacterSetupVisitor<'de> {
    marker: core::marker::PhantomData<hkbCharacterSetup>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbCharacterSetupVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbCharacterSetup, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkbCharacterSetupVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkbCharacterSetup")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let m_mirroredSkeleton = match m_mirroredSkeleton {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("mirroredSkeleton"),
                );
            }
        };

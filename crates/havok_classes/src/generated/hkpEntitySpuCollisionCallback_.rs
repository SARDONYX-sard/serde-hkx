...
pub(super) struct __hkpEntitySpuCollisionCallbackVisitor<'de> {
    marker: core::marker::PhantomData<hkpEntitySpuCollisionCallback>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpEntitySpuCollisionCallbackVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpEntitySpuCollisionCallback, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpEntitySpuCollisionCallbackVisitor<'de> {
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let m_eventFilter = match m_eventFilter {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("eventFilter"),
                );
            }
        };
        let m_userFilter = match m_userFilter {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("userFilter"),
                );
            }
        };

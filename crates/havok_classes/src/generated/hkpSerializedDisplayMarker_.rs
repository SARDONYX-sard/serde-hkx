...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpSerializedDisplayMarker<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpSerializedDisplayMarker<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpSerializedDisplayMarker<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpSerializedDisplayMarkerVisitor<'de> {
                marker: _serde::__private::PhantomData<hkpSerializedDisplayMarker<'de>>,
            ...
            for __hkpSerializedDisplayMarkerVisitor<'de> {
                type Value = hkpSerializedDisplayMarker<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

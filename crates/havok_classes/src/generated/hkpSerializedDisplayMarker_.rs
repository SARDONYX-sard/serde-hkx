...
pub(super) struct __hkpSerializedDisplayMarkerVisitor<'de> {
    marker: core::marker::PhantomData<hkpSerializedDisplayMarker>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpSerializedDisplayMarkerVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpSerializedDisplayMarker, __A::Error>
    where
        __A: _serde::de::MapAccess<'de>,
    {
        _serde::de::Visitor::visit_struct(
            Self {
                marker: _serde::__private::PhantomData::<hkpSerializedDisplayMarker>,
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpSerializedDisplayMarkerVisitor<'de> {
    type Value = hkpSerializedDisplayMarker;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpSerializedDisplayMarker")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        _serde::__private::Ok(hkpSerializedDisplayMarker {
            __ptr,
            parent,
            m_transform,
        })
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpSerializedDisplayMarker {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            _serde::Deserializer::deserialize_struct(
                ...
                "hkpSerializedDisplayMarker",
                FIELDS,
                __hkpSerializedDisplayMarkerVisitor {
                    marker: _serde::__private::PhantomData::<hkpSerializedDisplayMarker>,
                    lifetime: _serde::__private::PhantomData,
                },
            )

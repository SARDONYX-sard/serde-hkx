...
const _: () = {
    ...
    impl __serde::HavokClass for hkpRagdollLimitsDataAtoms {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(2193134787u32)
        }
    }
    impl __serde::Serialize for hkpRagdollLimitsDataAtoms {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(2193134787u32)));

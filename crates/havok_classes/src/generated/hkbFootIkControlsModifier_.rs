...
pub(super) struct __hkbFootIkControlsModifierVisitor<'de> {
    marker: core::marker::PhantomData<hkbFootIkControlsModifier<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbFootIkControlsModifierVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbFootIkControlsModifier<'de>, __A::Error>
    where
        __A: _serde::de::MapAccess<'de>,
    {
        _serde::de::Visitor::visit_struct(
            Self {
                marker: _serde::__private::PhantomData::<hkbFootIkControlsModifier<'de>>,
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkbFootIkControlsModifierVisitor<'de> {
    type Value = hkbFootIkControlsModifier<'de>;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkbFootIkControlsModifier")
    }
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbFootIkControlsModifier<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            _serde::Deserializer::deserialize_struct(
                ...
                "hkbFootIkControlsModifier",
                FIELDS,
                __hkbFootIkControlsModifierVisitor {
                    marker: _serde::__private::PhantomData::<hkbFootIkControlsModifier>,
                    lifetime: _serde::__private::PhantomData,
                },
            )
        }

...
const _: () = {
    ...
    impl __serde::HavokClass for hkpConvexShape {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(4176957317u32)
        }
    }
    impl __serde::Serialize for hkpConvexShape {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(4176957317u32)));

...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbRotateCharacterModifier<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkbRotateCharacterModifierVisitor<'de> {
                marker: _serde::__private::PhantomData<hkbRotateCharacterModifier<'de>>,
            ...
            for __hkbRotateCharacterModifierVisitor<'de> {

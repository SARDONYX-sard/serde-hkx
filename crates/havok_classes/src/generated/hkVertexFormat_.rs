...
pub(super) struct __hkVertexFormatVisitor<'de> {
    marker: core::marker::PhantomData<hkVertexFormat>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkVertexFormatVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkVertexFormat, __A::Error>
    where

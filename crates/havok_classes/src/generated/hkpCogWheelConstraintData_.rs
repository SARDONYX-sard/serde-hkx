...
pub(super) struct __hkpCogWheelConstraintDataVisitor<'de> {
    marker: core::marker::PhantomData<hkpCogWheelConstraintData>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpCogWheelConstraintDataVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpCogWheelConstraintData, __A::Error>
    where
        __A: _serde::de::MapAccess<'de>,
    {
        _serde::de::Visitor::visit_struct(
            Self {
                marker: _serde::__private::PhantomData::<hkpCogWheelConstraintData>,
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpCogWheelConstraintDataVisitor<'de> {
    type Value = hkpCogWheelConstraintData;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpCogWheelConstraintData")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let mut m_atoms: _serde::__private::Option<hkpCogWheelConstraintDataAtoms> = _serde::__private::None;
        for i in 0..1usize {
            match i {
                0usize => {
        ...
        _serde::__private::Ok(hkpCogWheelConstraintData {
            __ptr,
            parent,
            m_atoms,
        })
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpCogWheelConstraintData {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            _serde::Deserializer::deserialize_struct(
                ...
                "hkpCogWheelConstraintData",
                FIELDS,
                __hkpCogWheelConstraintDataVisitor {
                    marker: _serde::__private::PhantomData::<hkpCogWheelConstraintData>,
                    lifetime: _serde::__private::PhantomData,
                },
            )

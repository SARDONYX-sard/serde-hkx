...
pub struct hkpCogWheelConstraintData<'a> {
    ...
    pub m_atoms: hkpCogWheelConstraintDataAtoms<'a>,
}
const _: () = {
    use havok_serde as _serde;
    impl<'a> _serde::HavokClass for hkpCogWheelConstraintData<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpCogWheelConstraintData<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpCogWheelConstraintData<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpCogWheelConstraintDataVisitor<'de> {
                marker: _serde::__private::PhantomData<hkpCogWheelConstraintData<'de>>,
            ...
            for __hkpCogWheelConstraintDataVisitor<'de> {
                type Value = hkpCogWheelConstraintData<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbTransformVectorModifier<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkbTransformVectorModifierVisitor<'de> {
                marker: _serde::__private::PhantomData<hkbTransformVectorModifier<'de>>,
            ...
            for __hkbTransformVectorModifierVisitor<'de> {

...
pub(super) struct __hkpCachingShapePhantomVisitor<'de> {
    marker: core::marker::PhantomData<hkpCachingShapePhantom<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpCachingShapePhantomVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpCachingShapePhantom<'de>, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkpCachingShapePhantomVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpCachingShapePhantom")
    }

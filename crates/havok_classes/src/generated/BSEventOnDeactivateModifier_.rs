...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for BSEventOnDeactivateModifier<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __BSEventOnDeactivateModifierVisitor<'de> {
                marker: _serde::__private::PhantomData<BSEventOnDeactivateModifier<'de>>,
            ...
            for __BSEventOnDeactivateModifierVisitor<'de> {

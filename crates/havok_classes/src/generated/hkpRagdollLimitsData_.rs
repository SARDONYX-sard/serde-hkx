...
const _: () = {
    ...
    impl __serde::HavokClass for hkpRagdollLimitsData {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(3420144810u32)
        }
    }
    impl __serde::Serialize for hkpRagdollLimitsData {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(3420144810u32)));

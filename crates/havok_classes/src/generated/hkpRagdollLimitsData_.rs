...
pub struct hkpRagdollLimitsData<'a> {
    ...
    pub m_atoms: hkpRagdollLimitsDataAtoms<'a>,
}
const _: () = {
    use havok_serde as _serde;
    impl<'a> _serde::HavokClass for hkpRagdollLimitsData<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpRagdollLimitsData<'a> {
            ...
            S: _serde::ser::Serializer,
        {
            ...
            let mut serializer = __serializer
                .serialize_struct("hkpRagdollLimitsData", class_meta, (192u64, 208u64))?;
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpRagdollLimitsData<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpRagdollLimitsDataVisitor<'de> {
                marker: _serde::__private::PhantomData<hkpRagdollLimitsData<'de>>,
            ...
            impl<'de> _serde::de::Visitor<'de> for __hkpRagdollLimitsDataVisitor<'de> {
                type Value = hkpRagdollLimitsData<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

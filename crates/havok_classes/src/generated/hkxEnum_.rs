...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkxEnum<'a> {
        ...
        fn signature(&self) -> _serde::__private::Signature {
            _serde::__private::Signature::new(0xc4e1211)
        }
    }
    impl<'a> _serde::Serialize for hkxEnum<'a> {
            ...
            S: _serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, _serde::__private::Signature::new(0xc4e1211)));
...
pub(super) struct __hkxEnumVisitor<'de> {
    marker: core::marker::PhantomData<hkxEnum<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkxEnumVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkxEnum<'de>, __A::Error>
    where
        __A: _serde::de::MapAccess<'de>,
    {
        _serde::de::Visitor::visit_struct(
            Self {
                marker: _serde::__private::PhantomData::<hkxEnum<'de>>,
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkxEnumVisitor<'de> {
    type Value = hkxEnum<'de>;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkxEnum")
    }
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkxEnum<'de> {
        fn deserialize<__D>(deserializer: __D) -> core::result::Result<Self, __D::Error>
        where
            __D: _serde::Deserializer<'de>,
        {
            const FIELDS: &[&str] = &["items"];
            _serde::Deserializer::deserialize_struct(
                deserializer,
                "hkxEnum",
                FIELDS,
                __hkxEnumVisitor {
                    marker: _serde::__private::PhantomData::<hkxEnum>,
                    lifetime: _serde::__private::PhantomData,
                },
            )
        }

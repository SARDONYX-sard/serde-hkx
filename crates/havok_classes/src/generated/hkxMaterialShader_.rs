...
pub(super) struct __hkxMaterialShaderVisitor<'de> {
    marker: core::marker::PhantomData<hkxMaterialShader<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkxMaterialShaderVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkxMaterialShader<'de>, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkxMaterialShaderVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkxMaterialShader")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let mut m_vertexEntryName: _serde::__private::Option<StringPtr<'de>> = _serde::__private::None;
        let mut m_geomEntryName: _serde::__private::Option<StringPtr<'de>> = _serde::__private::None;
        let mut m_pixelEntryName: _serde::__private::Option<StringPtr<'de>> = _serde::__private::None;
        ...
        let m_vertexEntryName = match m_vertexEntryName {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("vertexEntryName"),
                );
            }
        };
        let m_geomEntryName = match m_geomEntryName {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("geomEntryName"),
                );
            }
        };
        let m_pixelEntryName = match m_pixelEntryName {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("pixelEntryName"),
                );
            }
        };

...
pub struct hkpRagdollConstraintData<'a> {
    ...
    pub m_atoms: hkpRagdollConstraintDataAtoms<'a>,
}
const _: () = {
    use havok_serde as _serde;
    impl<'a> _serde::HavokClass for hkpRagdollConstraintData<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpRagdollConstraintData<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpRagdollConstraintData<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpRagdollConstraintDataVisitor<'de> {
                marker: _serde::__private::PhantomData<hkpRagdollConstraintData<'de>>,
            ...
            for __hkpRagdollConstraintDataVisitor<'de> {
                type Value = hkpRagdollConstraintData<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

...
pub(super) struct __hkbHandIkDriverInfoHandVisitor<'de> {
    marker: core::marker::PhantomData<hkbHandIkDriverInfoHand<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbHandIkDriverInfoHandVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbHandIkDriverInfoHand<'de>, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkbHandIkDriverInfoHandVisitor<'de> {
    type Value = hkbHandIkDriverInfoHand<'de>;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkbHandIkDriverInfoHand")
    }

...
pub(super) struct __hkpVehicleFrictionDescriptionVisitor<'de> {
    marker: core::marker::PhantomData<hkpVehicleFrictionDescription>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpVehicleFrictionDescriptionVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpVehicleFrictionDescription, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpVehicleFrictionDescriptionVisitor<'de> {
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let m_wheelDistance = match m_wheelDistance {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("wheelDistance"),
                );
            }
        };
        let m_chassisMassInv = match m_chassisMassInv {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("chassisMassInv"),
                );
            }
        };
        let m_axleDescr = match m_axleDescr {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("axleDescr"),
                );
            }
        };

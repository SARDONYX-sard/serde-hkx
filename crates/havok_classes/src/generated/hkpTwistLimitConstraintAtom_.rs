...
const _: () = {
    ...
    impl __serde::HavokClass for hkpTwistLimitConstraintAtom {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(2090537042u32)
        }
    }
    impl __serde::Serialize for hkpTwistLimitConstraintAtom {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(2090537042u32)));

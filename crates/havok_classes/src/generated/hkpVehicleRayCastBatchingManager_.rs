...
pub struct hkpVehicleRayCastBatchingManager<'a> {
    ...
    #[cfg_attr(feature = "serde", serde(borrow))]
    pub parent: hkpVehicleCastBatchingManager<'a>,
}
const _: () = {
    use havok_serde as _serde;
    impl<'a> _serde::HavokClass for hkpVehicleRayCastBatchingManager<'a> {
        #[inline]
        ...
        fn deps_indexes(&self) -> Vec<&Pointer<'_>> {
            let mut v = Vec::new();
            v.extend(self.parent.parent.m_registeredVehicles.iter());
            v
        }
    }
    impl<'a> _serde::Serialize for hkpVehicleRayCastBatchingManager<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpVehicleRayCastBatchingManager<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpVehicleRayCastBatchingManagerVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkpVehicleRayCastBatchingManager<'de>,
                >,
            ...
            for __hkpVehicleRayCastBatchingManagerVisitor<'de> {
                type Value = hkpVehicleRayCastBatchingManager<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    let mut m_totalNumWheels: _serde::__private::Option<U16<'de>> = _serde::__private::None;
                    ...
                    let parent = hkpVehicleCastBatchingManager {
                        __ptr: __ptr.clone(),
                        parent,
                        m_totalNumWheels,
                    };

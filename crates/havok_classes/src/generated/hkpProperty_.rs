...
const _: () = {
    ...
    impl __serde::HavokClass for hkpProperty {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(2632124649u32)
        }
    }
    impl __serde::Serialize for hkpProperty {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(2632124649u32)));

...
pub(super) struct __hkpPropertyVisitor<'de> {
    marker: core::marker::PhantomData<hkpProperty>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpPropertyVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpProperty, __A::Error>
    where

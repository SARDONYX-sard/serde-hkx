...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpProperty<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpProperty<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpProperty<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpPropertyVisitor<'de> {
                marker: _serde::__private::PhantomData<hkpProperty<'de>>,

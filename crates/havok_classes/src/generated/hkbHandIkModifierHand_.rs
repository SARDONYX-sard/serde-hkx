...
const _: () = {
    ...
    impl<'a> __serde::HavokClass for hkbHandIkModifierHand<'a> {
        #[inline]
    ...
    impl<'a> __serde::Serialize for hkbHandIkModifierHand<'a> {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(350216669u32)));

...
pub(super) struct __hkbSequenceInternalStateVisitor<'de> {
    marker: core::marker::PhantomData<hkbSequenceInternalState>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbSequenceInternalStateVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbSequenceInternalState, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkbSequenceInternalStateVisitor<'de> {
    type Value = hkbSequenceInternalState;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkbSequenceInternalState")
    }

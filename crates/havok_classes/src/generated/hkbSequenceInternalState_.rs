...
const _: () = {
    ...
    impl __serde::HavokClass for hkbSequenceInternalState {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(1100716549u32)
        }
    }
    impl __serde::Serialize for hkbSequenceInternalState {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(1100716549u32)));

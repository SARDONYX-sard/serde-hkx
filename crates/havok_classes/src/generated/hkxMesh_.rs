...
const _: () = {
    ...
    impl __serde::HavokClass for hkxMesh {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(4075670623u32)
        }
    }
    impl __serde::Serialize for hkxMesh {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(4075670623u32)));

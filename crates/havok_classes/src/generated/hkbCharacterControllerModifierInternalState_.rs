...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkbCharacterControllerModifierInternalState<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkbCharacterControllerModifierInternalState<'a> {
...
const _: () = {
    ...
    for hkbCharacterControllerModifierInternalState<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkbCharacterControllerModifierInternalStateVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkbCharacterControllerModifierInternalState<'de>,
                >,
            ...
            for __hkbCharacterControllerModifierInternalStateVisitor<'de> {
                type Value = hkbCharacterControllerModifierInternalState<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

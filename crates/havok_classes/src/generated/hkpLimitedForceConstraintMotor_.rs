...
pub struct hkpLimitedForceConstraintMotor<'a> {
    ...
    #[cfg_attr(feature = "serde", serde(borrow))]
    pub parent: hkpConstraintMotor<'a>,
    /// # C++ Info
...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpLimitedForceConstraintMotor<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpLimitedForceConstraintMotor<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpLimitedForceConstraintMotor<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpLimitedForceConstraintMotorVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkpLimitedForceConstraintMotor<'de>,
                >,
            ...
            for __hkpLimitedForceConstraintMotorVisitor<'de> {
                type Value = hkpLimitedForceConstraintMotor<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpVehicleFrictionDescriptionAxisDescription<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpVehicleFrictionDescriptionAxisDescription<'a> {
...
const _: () = {
    ...
    for hkpVehicleFrictionDescriptionAxisDescription<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpVehicleFrictionDescriptionAxisDescriptionVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkpVehicleFrictionDescriptionAxisDescription<'de>,
                >,
            ...
            for __hkpVehicleFrictionDescriptionAxisDescriptionVisitor<'de> {
                type Value = hkpVehicleFrictionDescriptionAxisDescription<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

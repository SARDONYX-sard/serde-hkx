...
pub struct hkpGravityGun<'a> {
    ...
    pub m_maxNumObjectsPicked: I32<'a>,
    /// # C++ Info
...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpGravityGun<'a> {
        ...
        fn deps_indexes(&self) -> Vec<&Pointer<'_>> {
            ...
            v.extend(self.m_grabbedBodies.iter());
            v
        }
    }
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            impl<'de> _serde::de::Visitor<'de> for __hkpGravityGunVisitor<'de> {
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    let mut m_grabbedBodies: _serde::__private::Option<
                        Vec<Pointer<'de>>,
                    > = _serde::__private::None;
                    let mut m_maxNumObjectsPicked: _serde::__private::Option<I32<'de>> = _serde::__private::None;

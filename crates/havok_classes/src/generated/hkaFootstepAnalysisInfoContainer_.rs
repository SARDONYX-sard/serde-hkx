...
const _: () = {
    ...
    impl __serde::HavokClass for hkaFootstepAnalysisInfoContainer {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(495001724u32)
        }
    }
    impl __serde::Serialize for hkaFootstepAnalysisInfoContainer {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(495001724u32)));

...
const _: () = {
    ...
    impl __serde::HavokClass for hkbCameraShakeEventPayload {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(1678993794u32)
        }
    }
    impl __serde::Serialize for hkbCameraShakeEventPayload {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(1678993794u32)));

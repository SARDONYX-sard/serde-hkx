...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkbCameraShakeEventPayload<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkbCameraShakeEventPayload<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbCameraShakeEventPayload<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkbCameraShakeEventPayloadVisitor<'de> {
                marker: _serde::__private::PhantomData<hkbCameraShakeEventPayload<'de>>,
            ...
            for __hkbCameraShakeEventPayloadVisitor<'de> {
                type Value = hkbCameraShakeEventPayload<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

...
const _: () = {
    ...
    impl __serde::HavokClass for hkpLimitedHingeConstraintDataAtoms {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(1422356827u32)
        }
    }
    impl __serde::Serialize for hkpLimitedHingeConstraintDataAtoms {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(1422356827u32)));

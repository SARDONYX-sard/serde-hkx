...
pub(super) struct __hkpLimitedHingeConstraintDataAtomsVisitor<'de> {
    marker: core::marker::PhantomData<hkpLimitedHingeConstraintDataAtoms>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpLimitedHingeConstraintDataAtomsVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpLimitedHingeConstraintDataAtoms, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpLimitedHingeConstraintDataAtomsVisitor<'de> {
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        > = _serde::__private::None;
        let mut m_angMotor: _serde::__private::Option<hkpAngMotorConstraintAtom> = _serde::__private::None;

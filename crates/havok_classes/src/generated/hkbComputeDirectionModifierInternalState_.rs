...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkbComputeDirectionModifierInternalState<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkbComputeDirectionModifierInternalState<'a> {
...
const _: () = {
    ...
    for hkbComputeDirectionModifierInternalState<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkbComputeDirectionModifierInternalStateVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkbComputeDirectionModifierInternalState<'de>,
                >,
            ...
            for __hkbComputeDirectionModifierInternalStateVisitor<'de> {
                type Value = hkbComputeDirectionModifierInternalState<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

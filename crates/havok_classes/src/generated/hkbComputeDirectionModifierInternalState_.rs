...
pub(super) struct __hkbComputeDirectionModifierInternalStateVisitor<'de> {
    marker: core::marker::PhantomData<hkbComputeDirectionModifierInternalState>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbComputeDirectionModifierInternalStateVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbComputeDirectionModifierInternalState, __A::Error>
    where

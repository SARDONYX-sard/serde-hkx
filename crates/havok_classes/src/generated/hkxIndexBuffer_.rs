...
pub(super) struct __hkxIndexBufferVisitor<'de> {
    marker: core::marker::PhantomData<hkxIndexBuffer>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkxIndexBufferVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkxIndexBuffer, __A::Error>
    where

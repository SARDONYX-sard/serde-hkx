...
const _: () = {
    ...
    impl __serde::HavokClass for hkbClipTrigger {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(2125749482u32)
        }
    }
    impl __serde::Serialize for hkbClipTrigger {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(2125749482u32)));

...
const _: () = {
    ...
    impl __serde::HavokClass for hkaSkeletonMapperDataChainMapping {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(2770925519u32)
        }
    }
    impl __serde::Serialize for hkaSkeletonMapperDataChainMapping {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(2770925519u32)));

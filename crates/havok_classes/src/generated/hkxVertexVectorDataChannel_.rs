...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkxVertexVectorDataChannel<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkxVertexVectorDataChannel<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkxVertexVectorDataChannel<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkxVertexVectorDataChannelVisitor<'de> {
                marker: _serde::__private::PhantomData<hkxVertexVectorDataChannel<'de>>,
            ...
            for __hkxVertexVectorDataChannelVisitor<'de> {
                type Value = hkxVertexVectorDataChannel<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    let mut m_perVertexVectors: _serde::__private::Option<
                        Vec<Vector4>,

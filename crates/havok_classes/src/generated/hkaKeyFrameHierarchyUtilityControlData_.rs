...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkaKeyFrameHierarchyUtilityControlData<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkaKeyFrameHierarchyUtilityControlData<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkaKeyFrameHierarchyUtilityControlData<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkaKeyFrameHierarchyUtilityControlDataVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkaKeyFrameHierarchyUtilityControlData<'de>,
                >,
            ...
            for __hkaKeyFrameHierarchyUtilityControlDataVisitor<'de> {
                type Value = hkaKeyFrameHierarchyUtilityControlData<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

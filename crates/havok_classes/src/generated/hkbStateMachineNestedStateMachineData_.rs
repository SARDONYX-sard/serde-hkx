...
pub(super) struct __hkbStateMachineNestedStateMachineDataVisitor<'de> {
    marker: core::marker::PhantomData<hkbStateMachineNestedStateMachineData>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbStateMachineNestedStateMachineDataVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbStateMachineNestedStateMachineData, __A::Error>
    where
...
for __hkbStateMachineNestedStateMachineDataVisitor<'de> {
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        for i in 0..2usize {
            match i {
                0usize => {
                    if _serde::__private::Option::is_some(&m_nestedStateMachine) {

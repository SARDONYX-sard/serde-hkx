...
pub(super) struct __hkResourceBaseVisitor<'de> {
    marker: core::marker::PhantomData<hkResourceBase>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkResourceBaseVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkResourceBase, __A::Error>
    where
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkResourceBase {

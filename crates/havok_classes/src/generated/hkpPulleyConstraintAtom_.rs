...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpPulleyConstraintAtom<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpPulleyConstraintAtom<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpPulleyConstraintAtom<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpPulleyConstraintAtomVisitor<'de> {
                marker: _serde::__private::PhantomData<hkpPulleyConstraintAtom<'de>>,
            ...
            for __hkpPulleyConstraintAtomVisitor<'de> {
                type Value = hkpPulleyConstraintAtom<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

...
pub struct hkpAngConstraintAtom<'a> {
    ...
    #[cfg_attr(feature = "json_schema", schemars(rename = "firstConstrainedAxis"))]
    #[cfg_attr(feature = "serde", serde(rename = "firstConstrainedAxis"))]
    pub m_firstConstrainedAxis: U8<'a>,
    /// # C++ Info
    /// - name: `numConstrainedAxes`(ctype: `hkUint8`)
    /// - offset: `  3`(x86)/`  3`(x86_64)
    /// - type_size: `  1`(x86)/`  1`(x86_64)
    #[cfg_attr(feature = "json_schema", schemars(rename = "numConstrainedAxes"))]
    #[cfg_attr(feature = "serde", serde(rename = "numConstrainedAxes"))]
    pub m_numConstrainedAxes: U8<'a>,
}
const _: () = {
    use havok_serde as _serde;
    impl<'a> _serde::HavokClass for hkpAngConstraintAtom<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpAngConstraintAtom<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpAngConstraintAtom<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpAngConstraintAtomVisitor<'de> {
                marker: _serde::__private::PhantomData<hkpAngConstraintAtom<'de>>,
            ...
            impl<'de> _serde::de::Visitor<'de> for __hkpAngConstraintAtomVisitor<'de> {
                type Value = hkpAngConstraintAtom<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    let mut m_firstConstrainedAxis: _serde::__private::Option<U8<'de>> = _serde::__private::None;
                    let mut m_numConstrainedAxes: _serde::__private::Option<U8<'de>> = _serde::__private::None;
                    for i in 0..2usize {
                        match i {
                            0usize => {

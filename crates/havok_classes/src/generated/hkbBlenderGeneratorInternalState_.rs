...
const _: () = {
    ...
    impl __serde::HavokClass for hkbBlenderGeneratorInternalState {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(2222027912u32)
        }
    }
    impl __serde::Serialize for hkbBlenderGeneratorInternalState {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(2222027912u32)));

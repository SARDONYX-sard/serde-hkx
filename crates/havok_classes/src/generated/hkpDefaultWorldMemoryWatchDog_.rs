...
const _: () = {
    ...
    impl __serde::HavokClass for hkpDefaultWorldMemoryWatchDog {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(2010558879u32)
        }
    }
    impl __serde::Serialize for hkpDefaultWorldMemoryWatchDog {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(2010558879u32)));

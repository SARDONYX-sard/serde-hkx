    ...
    impl _serde::Serialize for hkbIntEventPayload {
            ...
            S: _serde::ser::Serializer,
        {
            ...
            let mut serializer = __serializer
                .serialize_struct("hkbIntEventPayload", class_meta)?;
...
pub(super) struct __hkbIntEventPayloadVisitor<'de> {
    marker: core::marker::PhantomData<hkbIntEventPayload>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbIntEventPayloadVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbIntEventPayload, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkbIntEventPayloadVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkbIntEventPayload")
    }

...
const _: () = {
    ...
    impl __serde::HavokClass for hkpTyremarksInfo {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(1023685590u32)
        }
    }
    impl __serde::Serialize for hkpTyremarksInfo {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(1023685590u32)));

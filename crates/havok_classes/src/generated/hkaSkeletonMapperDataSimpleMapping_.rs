...
const _: () = {
    ...
    impl __serde::HavokClass for hkaSkeletonMapperDataSimpleMapping {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(872799946u32)
        }
    }
    impl __serde::Serialize for hkaSkeletonMapperDataSimpleMapping {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(872799946u32)));

...
pub struct BSRagdollContactListenerModifier<'a> {
    ...
    pub m_contactEvent: hkbEventProperty<'a>,
    /// # C++ Info
    ...
    #[cfg_attr(feature = "json_schema", schemars(rename = "throwEvent"))]
...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for BSRagdollContactListenerModifier<'a> {
        ...
        fn deps_indexes(&self) -> Vec<&Pointer<'_>> {
            ...
            v.extend(self.m_contactEvent.deps_indexes());
            v.push(&self.m_bones);
            v.extend(self.m_ragdollRigidBodies.iter());
            v
        }
    }
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for BSRagdollContactListenerModifier<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __BSRagdollContactListenerModifierVisitor<'de> {
            ...
            for __BSRagdollContactListenerModifierVisitor<'de> {
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    let mut m_contactEvent: _serde::__private::Option<
                        hkbEventProperty<'de>,
                    ...
                    let mut m_ragdollRigidBodies: _serde::__private::Option<
                        Vec<Pointer<'de>>,
                    > = _serde::__private::None;
                    for i in 0..4usize {
                        match i {

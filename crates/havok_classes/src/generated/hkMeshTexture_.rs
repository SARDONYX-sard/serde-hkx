...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkMeshTexture<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkMeshTexture<'a> {
            ...
            S: _serde::ser::Serializer,
        {
            ...
            let mut serializer = __serializer
                .serialize_struct("hkMeshTexture", class_meta, (8u64, 16u64))?;
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkMeshTexture<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkMeshTextureVisitor<'de> {
                marker: _serde::__private::PhantomData<hkMeshTexture<'de>>,
            ...
            impl<'de> _serde::de::Visitor<'de> for __hkMeshTextureVisitor<'de> {
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    let __ptr = __A::class_ptr(&mut __map);
                    _serde::__private::Ok(hkMeshTexture {
                        __ptr: __ptr.clone(),
                        parent,
                    })
                }

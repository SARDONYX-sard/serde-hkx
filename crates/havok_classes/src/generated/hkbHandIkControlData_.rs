...
pub(super) struct __hkbHandIkControlDataVisitor<'de> {
    marker: core::marker::PhantomData<hkbHandIkControlData>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbHandIkControlDataVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbHandIkControlData, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkbHandIkControlDataVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkbHandIkControlData")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        for i in 0..12usize {
            match i {
                ...
                4usize => {
                    if _serde::__private::Option::is_some(&m_transformOnFraction) {
                        return _serde::__private::Err(
                            <__A::Error as _serde::de::Error>::duplicate_field(
                                "transformOnFraction",
                            ),

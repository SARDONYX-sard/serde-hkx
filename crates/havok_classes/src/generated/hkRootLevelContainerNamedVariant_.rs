...
pub struct hkRootLevelContainerNamedVariant<'a> {
    ...
    /// - type_size: `  4`(x86)/`  8`(x86_64)
    #[cfg_attr(feature = "json_schema", schemars(rename = "className"))]
    #[cfg_attr(feature = "serde", serde(rename = "className"))]
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkRootLevelContainerNamedVariant<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkRootLevelContainerNamedVariantVisitor<'de> {
            ...
            for __hkRootLevelContainerNamedVariantVisitor<'de> {

...
pub(super) struct __hkRootLevelContainerNamedVariantVisitor<'de> {
    marker: core::marker::PhantomData<hkRootLevelContainerNamedVariant<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkRootLevelContainerNamedVariantVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkRootLevelContainerNamedVariant<'de>, __A::Error>
    where
        ...
        _serde::de::Visitor::visit_struct(
            Self {
                marker: _serde::__private::PhantomData::<
                    hkRootLevelContainerNamedVariant<'de>,
                >,
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkRootLevelContainerNamedVariantVisitor<'de> {
    type Value = hkRootLevelContainerNamedVariant<'de>;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkRootLevelContainerNamedVariant<'de> {
        fn deserialize<__D>(deserializer: __D) -> core::result::Result<Self, __D::Error>
        where
            __D: _serde::Deserializer<'de>,
        {
            const FIELDS: &[&str] = &["name", "className", "variant"];
            _serde::Deserializer::deserialize_struct(
                deserializer,
                "hkRootLevelContainerNamedVariant",
                FIELDS,
                __hkRootLevelContainerNamedVariantVisitor {
                    marker: _serde::__private::PhantomData::<
                        hkRootLevelContainerNamedVariant,
                    >,
                    lifetime: _serde::__private::PhantomData,

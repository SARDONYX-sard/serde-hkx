    ...
    impl _serde::Serialize for hkaSkeletonMapper {
            ...
            S: _serde::ser::Serializer,
        {
            ...
            let mut serializer = __serializer
                .serialize_struct("hkaSkeletonMapper", class_meta)?;
            serializer.pad_field([0u8; 4usize].as_slice(), [0u8; 8usize].as_slice())?;
            serializer.skip_field("memSizeAndFlags", &self.parent.m_memSizeAndFlags)?;
            serializer.skip_field("referenceCount", &self.parent.m_referenceCount)?;
            serializer.pad_field([0u8; 0usize].as_slice(), [0u8; 4usize].as_slice())?;
            serializer.pad_field([0u8; 8usize].as_slice(), [0u8; 0usize].as_slice())?;
            serializer.serialize_field("mapping", &self.m_mapping)?;
            serializer.end()
        }
    }
};
...
pub(super) struct __hkaSkeletonMapperVisitor<'de> {
    marker: core::marker::PhantomData<hkaSkeletonMapper>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkaSkeletonMapperVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkaSkeletonMapper, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkaSkeletonMapperVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkaSkeletonMapper")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let mut m_mapping: _serde::__private::Option<hkaSkeletonMapperData> = _serde::__private::None;
        for i in 0..1usize {
            match i {
                0usize => {

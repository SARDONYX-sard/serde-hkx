...
const _: () = {
    ...
    impl __serde::HavokClass for hkpTyremarksWheel {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(514781249u32)
        }
    }
    impl __serde::Serialize for hkpTyremarksWheel {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(514781249u32)));

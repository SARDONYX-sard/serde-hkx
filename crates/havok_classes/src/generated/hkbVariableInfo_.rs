...
pub(super) struct __hkbVariableInfoVisitor<'de> {
    marker: core::marker::PhantomData<hkbVariableInfo>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbVariableInfoVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbVariableInfo, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkbVariableInfoVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkbVariableInfo")
    }

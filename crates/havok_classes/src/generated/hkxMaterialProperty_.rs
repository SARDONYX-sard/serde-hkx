...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkxMaterialProperty<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkxMaterialProperty<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkxMaterialProperty<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkxMaterialPropertyVisitor<'de> {
                marker: _serde::__private::PhantomData<hkxMaterialProperty<'de>>,
            ...
            impl<'de> _serde::de::Visitor<'de> for __hkxMaterialPropertyVisitor<'de> {
                type Value = hkxMaterialProperty<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    let mut m_value: _serde::__private::Option<U32<'de>> = _serde::__private::None;
                    for i in 0..2usize {
                        match i {
                            0usize => {

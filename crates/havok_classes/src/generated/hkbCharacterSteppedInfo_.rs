...
pub(super) struct __hkbCharacterSteppedInfoVisitor<'de> {
    marker: core::marker::PhantomData<hkbCharacterSteppedInfo>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbCharacterSteppedInfoVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbCharacterSteppedInfo, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkbCharacterSteppedInfoVisitor<'de> {
    type Value = hkbCharacterSteppedInfo;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkbCharacterSteppedInfo")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let m_deltaTime = match m_deltaTime {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("deltaTime"),
                );
            }
        };

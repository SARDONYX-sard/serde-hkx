...
const _: () = {
    ...
    impl __serde::HavokClass for hkbCharacterSteppedInfo {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(786072824u32)
        }
    }
    impl __serde::Serialize for hkbCharacterSteppedInfo {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(786072824u32)));

...
pub struct hkpPrismaticConstraintData<'a> {
    ...
    pub m_atoms: hkpPrismaticConstraintDataAtoms<'a>,
}
const _: () = {
    use havok_serde as _serde;
    impl<'a> _serde::HavokClass for hkpPrismaticConstraintData<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpPrismaticConstraintData<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpPrismaticConstraintData<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpPrismaticConstraintDataVisitor<'de> {
                marker: _serde::__private::PhantomData<hkpPrismaticConstraintData<'de>>,
            ...
            for __hkpPrismaticConstraintDataVisitor<'de> {
                type Value = hkpPrismaticConstraintData<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

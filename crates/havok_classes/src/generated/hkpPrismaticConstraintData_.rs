...
pub(super) struct __hkpPrismaticConstraintDataVisitor<'de> {
    marker: core::marker::PhantomData<hkpPrismaticConstraintData>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpPrismaticConstraintDataVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpPrismaticConstraintData, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpPrismaticConstraintDataVisitor<'de> {
    type Value = hkpPrismaticConstraintData;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpPrismaticConstraintData")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let mut m_atoms: _serde::__private::Option<hkpPrismaticConstraintDataAtoms> = _serde::__private::None;
        for i in 0..1usize {
            match i {
                0usize => {

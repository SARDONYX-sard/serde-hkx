...
const _: () = {
    ...
    impl __serde::HavokClass for hkpPrismaticConstraintData {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(966181767u32)
        }
    }
    impl __serde::Serialize for hkpPrismaticConstraintData {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(966181767u32)));

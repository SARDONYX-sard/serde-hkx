...
pub(super) struct __hkpVehicleDefaultVelocityDamperVisitor<'de> {
    marker: core::marker::PhantomData<hkpVehicleDefaultVelocityDamper>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpVehicleDefaultVelocityDamperVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpVehicleDefaultVelocityDamper, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpVehicleDefaultVelocityDamperVisitor<'de> {
    type Value = hkpVehicleDefaultVelocityDamper;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        for i in 0..3usize {
            match i {
                0usize => {
                    if _serde::__private::Option::is_some(&m_normalSpinDamping) {
                ...
                1usize => {
                    if _serde::__private::Option::is_some(&m_collisionSpinDamping) {
                        return _serde::__private::Err(
                            <__A::Error as _serde::de::Error>::duplicate_field(
                ...
                2usize => {
                    if _serde::__private::Option::is_some(&m_collisionThreshold) {
                        return _serde::__private::Err(
                            <__A::Error as _serde::de::Error>::duplicate_field(
                                "collisionThreshold",
                            ),
        ...
        let m_normalSpinDamping = match m_normalSpinDamping {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("normalSpinDamping"),
                );
            }
        };
    ...
    {
        let __ptr = __A::class_ptr(&mut __map);
        let parent = __hkpVehicleVelocityDamperVisitor::visit_as_parent(&mut __map)?;
        let mut m_normalSpinDamping: _serde::__private::Option<f32> = _serde::__private::None;
        let mut m_collisionSpinDamping: _serde::__private::Option<f32> = _serde::__private::None;
        let mut m_collisionThreshold: _serde::__private::Option<f32> = _serde::__private::None;
        for _ in 0..3usize {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpVehicleDefaultVelocityDamper {

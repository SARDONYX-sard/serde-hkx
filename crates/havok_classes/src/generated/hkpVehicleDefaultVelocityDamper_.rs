...
const _: () = {
    ...
    impl __serde::HavokClass for hkpVehicleDefaultVelocityDamper {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(1947962782u32)
        }
    }
    impl __serde::Serialize for hkpVehicleDefaultVelocityDamper {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(1947962782u32)));

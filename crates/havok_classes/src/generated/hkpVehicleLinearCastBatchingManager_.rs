...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpVehicleLinearCastBatchingManager<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpVehicleLinearCastBatchingManager<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpVehicleLinearCastBatchingManager<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpVehicleLinearCastBatchingManagerVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkpVehicleLinearCastBatchingManager<'de>,
                >,
            ...
            for __hkpVehicleLinearCastBatchingManagerVisitor<'de> {
                type Value = hkpVehicleLinearCastBatchingManager<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

...
const _: () = {
    ...
    impl __serde::HavokClass for hkpVehicleLinearCastBatchingManager {
        #[inline]
    ...
    impl __serde::Serialize for hkpVehicleLinearCastBatchingManager {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(3981614867u32)));

...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpVehicleDefaultBrakeWheelBrakingProperties<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpVehicleDefaultBrakeWheelBrakingProperties<'a> {
...
const _: () = {
    ...
    for hkpVehicleDefaultBrakeWheelBrakingProperties<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpVehicleDefaultBrakeWheelBrakingPropertiesVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkpVehicleDefaultBrakeWheelBrakingProperties<'de>,
                >,
            ...
            for __hkpVehicleDefaultBrakeWheelBrakingPropertiesVisitor<'de> {
                type Value = hkpVehicleDefaultBrakeWheelBrakingProperties<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

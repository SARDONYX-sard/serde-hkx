...
pub struct hkpRackAndPinionConstraintDataAtoms<'a> {
    ...
    #[cfg_attr(feature = "json_schema", schemars(rename = "rackAndPinion"))]
    #[cfg_attr(feature = "serde", serde(rename = "rackAndPinion"))]
    pub m_rackAndPinion: hkpRackAndPinionConstraintAtom<'a>,
}
const _: () = {
    use havok_serde as _serde;
    impl<'a> _serde::HavokClass for hkpRackAndPinionConstraintDataAtoms<'a> {
        #[inline]
        ...
        fn deps_indexes(&self) -> Vec<&Pointer<'_>> {
            ...
            v.extend(self.m_rackAndPinion.deps_indexes());
            v
        }
    }
    impl<'a> _serde::Serialize for hkpRackAndPinionConstraintDataAtoms<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpRackAndPinionConstraintDataAtoms<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpRackAndPinionConstraintDataAtomsVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkpRackAndPinionConstraintDataAtoms<'de>,
                >,
            ...
            for __hkpRackAndPinionConstraintDataAtomsVisitor<'de> {
                type Value = hkpRackAndPinionConstraintDataAtoms<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

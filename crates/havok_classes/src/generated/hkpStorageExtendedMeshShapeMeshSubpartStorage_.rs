...
pub(super) struct __hkpStorageExtendedMeshShapeMeshSubpartStorageVisitor<'de> {
    marker: core::marker::PhantomData<
        hkpStorageExtendedMeshShapeMeshSubpartStorage<'de>,
    >,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpStorageExtendedMeshShapeMeshSubpartStorageVisitor<'de> {
...
for __hkpStorageExtendedMeshShapeMeshSubpartStorageVisitor<'de> {
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let mut m_indices8: _serde::__private::Option<Vec<u8>> = _serde::__private::None;

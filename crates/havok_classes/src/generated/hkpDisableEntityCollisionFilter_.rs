...
pub struct hkpDisableEntityCollisionFilter<'a> {
    ...
    pub m_disabledEntities: Vec<Pointer<'a>>,
}
const _: () = {
    use havok_serde as _serde;
    impl<'a> _serde::HavokClass for hkpDisableEntityCollisionFilter<'a> {
        #[inline]
        ...
        fn deps_indexes(&self) -> Vec<&Pointer<'_>> {
            let mut v = Vec::new();
            v.extend(self.m_disabledEntities.iter());
            v
        }
    }
    impl<'a> _serde::Serialize for hkpDisableEntityCollisionFilter<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpDisableEntityCollisionFilter<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpDisableEntityCollisionFilterVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkpDisableEntityCollisionFilter<'de>,
                >,
            ...
            for __hkpDisableEntityCollisionFilterVisitor<'de> {
                type Value = hkpDisableEntityCollisionFilter<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

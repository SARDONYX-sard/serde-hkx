...
pub(super) struct __hkbCharacterInfoVisitor<'de> {
    marker: core::marker::PhantomData<hkbCharacterInfo>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbCharacterInfoVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbCharacterInfo, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkbCharacterInfoVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkbCharacterInfo")
    }

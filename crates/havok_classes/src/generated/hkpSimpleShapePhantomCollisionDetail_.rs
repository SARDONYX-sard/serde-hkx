...
pub struct hkpSimpleShapePhantomCollisionDetail<'a> {
    ...
    pub m_collidable: Pointer<'a>,
}
const _: () = {
    use havok_serde as _serde;
    impl<'a> _serde::HavokClass for hkpSimpleShapePhantomCollisionDetail<'a> {
        #[inline]
        ...
        fn deps_indexes(&self) -> Vec<&Pointer<'_>> {
            let mut v = Vec::new();
            v.push(&self.m_collidable);
            v
        }
    }
    impl<'a> _serde::Serialize for hkpSimpleShapePhantomCollisionDetail<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpSimpleShapePhantomCollisionDetail<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpSimpleShapePhantomCollisionDetailVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkpSimpleShapePhantomCollisionDetail<'de>,
                >,
            ...
            for __hkpSimpleShapePhantomCollisionDetailVisitor<'de> {
                type Value = hkpSimpleShapePhantomCollisionDetail<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    let mut m_collidable: _serde::__private::Option<Pointer<'de>> = _serde::__private::None;
                    for i in 0..1usize {
                        match i {
                            0usize => {

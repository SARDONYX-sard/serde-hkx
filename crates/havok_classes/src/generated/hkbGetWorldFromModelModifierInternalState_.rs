...
const _: () = {
    ...
    impl __serde::HavokClass for hkbGetWorldFromModelModifierInternalState {
        fn name(&self) -> &'static core::ffi::CStr {
            c"hkbGetWorldFromModelModifierInternalState"
        }
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(2838418335u32)
        }
    }
    impl __serde::Serialize for hkbGetWorldFromModelModifierInternalState {

...
pub struct hkpNullCollisionFilter<'a> {
...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpNullCollisionFilter<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpNullCollisionFilter<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpNullCollisionFilter<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpNullCollisionFilterVisitor<'de> {
                marker: _serde::__private::PhantomData<hkpNullCollisionFilter<'de>>,
            ...
            impl<'de> _serde::de::Visitor<'de> for __hkpNullCollisionFilterVisitor<'de> {
                type Value = hkpNullCollisionFilter<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

...
pub(super) struct __hkpNullCollisionFilterVisitor<'de> {
    marker: core::marker::PhantomData<hkpNullCollisionFilter>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpNullCollisionFilterVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpNullCollisionFilter, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkpNullCollisionFilterVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpNullCollisionFilter")
    }

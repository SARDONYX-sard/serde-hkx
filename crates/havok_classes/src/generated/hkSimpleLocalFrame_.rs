...
pub(super) struct __hkSimpleLocalFrameVisitor<'de> {
    marker: core::marker::PhantomData<hkSimpleLocalFrame<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkSimpleLocalFrameVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkSimpleLocalFrame<'de>, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkSimpleLocalFrameVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkSimpleLocalFrame")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let m_parentFrame = match m_parentFrame {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("parentFrame"),
                );
            }
        };

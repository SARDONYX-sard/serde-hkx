...
const _: () = {
    ...
    impl __serde::HavokClass for hkpConvexVerticesConnectivity {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(1674808988u32)
        }
    }
    impl __serde::Serialize for hkpConvexVerticesConnectivity {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(1674808988u32)));

...
const _: () = {
    ...
    impl __serde::HavokClass for hkpMassChangerModifierConstraintAtom {
        fn name(&self) -> &'static core::ffi::CStr {
            c"hkpMassChangerModifierConstraintAtom"
        }
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(3065152064u32)
        }
    }
    impl __serde::Serialize for hkpMassChangerModifierConstraintAtom {

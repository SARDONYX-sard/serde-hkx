...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpMassChangerModifierConstraintAtom<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpMassChangerModifierConstraintAtom<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpMassChangerModifierConstraintAtom<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpMassChangerModifierConstraintAtomVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkpMassChangerModifierConstraintAtom<'de>,
                >,
            ...
            for __hkpMassChangerModifierConstraintAtomVisitor<'de> {
                type Value = hkpMassChangerModifierConstraintAtom<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

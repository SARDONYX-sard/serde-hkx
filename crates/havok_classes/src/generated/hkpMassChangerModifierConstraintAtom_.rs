...
pub(super) struct __hkpMassChangerModifierConstraintAtomVisitor<'de> {
    marker: core::marker::PhantomData<hkpMassChangerModifierConstraintAtom>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpMassChangerModifierConstraintAtomVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpMassChangerModifierConstraintAtom, __A::Error>
    where
            ...
            match i {
                0usize => {
                    if _serde::__private::Option::is_some(&m_factorA) {
                        return _serde::__private::Err(
                            <__A::Error as _serde::de::Error>::duplicate_field("factorA"),
                        );
                    }
                ...
                1usize => {
                    if _serde::__private::Option::is_some(&m_factorB) {
                        return _serde::__private::Err(
                            <__A::Error as _serde::de::Error>::duplicate_field("factorB"),
                        );
                    }

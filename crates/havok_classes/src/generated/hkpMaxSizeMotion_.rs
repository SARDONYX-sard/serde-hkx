...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpMaxSizeMotion<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpMaxSizeMotion<'a> {
            ...
            S: _serde::ser::Serializer,
        {
            ...
            let mut serializer = __serializer
                .serialize_struct("hkpMaxSizeMotion", class_meta, (288u64, 320u64))?;
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpMaxSizeMotion<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpMaxSizeMotionVisitor<'de> {
                marker: _serde::__private::PhantomData<hkpMaxSizeMotion<'de>>,
            ...
            impl<'de> _serde::de::Visitor<'de> for __hkpMaxSizeMotionVisitor<'de> {
                type Value = hkpMaxSizeMotion<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

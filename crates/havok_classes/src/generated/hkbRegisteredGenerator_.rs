...
pub struct hkbRegisteredGenerator<'a> {
    ...
    #[cfg_attr(feature = "json_schema", schemars(rename = "relativePosition"))]
    #[cfg_attr(feature = "serde", serde(rename = "relativePosition"))]
    pub m_relativePosition: Vector4,
    /// # C++ Info
    /// - name: `relativeDirection`(ctype: `hkVector4`)
    /// - offset: ` 48`(x86)/` 80`(x86_64)
    /// - type_size: ` 16`(x86)/` 16`(x86_64)
    #[cfg_attr(feature = "json_schema", schemars(rename = "relativeDirection"))]
    #[cfg_attr(feature = "serde", serde(rename = "relativeDirection"))]

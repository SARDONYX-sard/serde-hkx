...
pub(super) struct __hkpVehicleDriverInputAnalogStatusVisitor<'de> {
    marker: core::marker::PhantomData<hkpVehicleDriverInputAnalogStatus>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpVehicleDriverInputAnalogStatusVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpVehicleDriverInputAnalogStatus, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpVehicleDriverInputAnalogStatusVisitor<'de> {
    ...
    {
        let __ptr = __A::class_ptr(&mut __map);
        let parent = __hkpVehicleDriverInputStatusVisitor::visit_as_parent(&mut __map)?;
        let mut m_positionX: _serde::__private::Option<f32> = _serde::__private::None;
        let mut m_positionY: _serde::__private::Option<f32> = _serde::__private::None;
        let mut m_handbrakeButtonPressed: _serde::__private::Option<bool> = _serde::__private::None;
        let mut m_reverseButtonPressed: _serde::__private::Option<bool> = _serde::__private::None;

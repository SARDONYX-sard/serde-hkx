...
pub(super) struct __hkpSerializedDisplayRbTransformsVisitor<'de> {
    marker: core::marker::PhantomData<hkpSerializedDisplayRbTransforms>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpSerializedDisplayRbTransformsVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpSerializedDisplayRbTransforms, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpSerializedDisplayRbTransformsVisitor<'de> {

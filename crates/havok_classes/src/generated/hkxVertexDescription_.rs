...
const _: () = {
    ...
    impl _serde::HavokClass for hkxVertexDescription {
        #[inline]
    ...
    impl _serde::Serialize for hkxVertexDescription {
...
pub(super) struct __hkxVertexDescriptionVisitor<'de> {
    marker: core::marker::PhantomData<hkxVertexDescription>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkxVertexDescriptionVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkxVertexDescription, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkxVertexDescriptionVisitor<'de> {
    type Value = hkxVertexDescription;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkxVertexDescription")
    }
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkxVertexDescription {

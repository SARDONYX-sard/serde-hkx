...
const _: () = {
    ...
    impl __serde::HavokClass for hkpConvexPieceStreamData {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(2780634478u32)
        }
    }
    impl __serde::Serialize for hkpConvexPieceStreamData {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(2780634478u32)));

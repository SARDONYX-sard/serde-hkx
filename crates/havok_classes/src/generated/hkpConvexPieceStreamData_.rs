...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpConvexPieceStreamData<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpConvexPieceStreamData<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpConvexPieceStreamData<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpConvexPieceStreamDataVisitor<'de> {
                marker: _serde::__private::PhantomData<hkpConvexPieceStreamData<'de>>,
            ...
            for __hkpConvexPieceStreamDataVisitor<'de> {
                type Value = hkpConvexPieceStreamData<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    let mut m_convexPieceOffsets: _serde::__private::Option<
                        Vec<U32<'de>>,
                    > = _serde::__private::None;

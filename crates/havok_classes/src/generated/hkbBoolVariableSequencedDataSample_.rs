...
pub(super) struct __hkbBoolVariableSequencedDataSampleVisitor<'de> {
    marker: core::marker::PhantomData<hkbBoolVariableSequencedDataSample>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbBoolVariableSequencedDataSampleVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbBoolVariableSequencedDataSample, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkbBoolVariableSequencedDataSampleVisitor<'de> {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbBoolVariableSequencedDataSample {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            _serde::Deserializer::deserialize_struct(
                ...
                "hkbBoolVariableSequencedDataSample",
                FIELDS,
                __hkbBoolVariableSequencedDataSampleVisitor {
                    marker: _serde::__private::PhantomData::<
                        hkbBoolVariableSequencedDataSample,
                    >,
                    lifetime: _serde::__private::PhantomData,

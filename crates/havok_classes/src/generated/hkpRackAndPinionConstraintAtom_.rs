...
const _: () = {
    ...
    impl __serde::HavokClass for hkpRackAndPinionConstraintAtom {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(818601990u32)
        }
    }
    impl __serde::Serialize for hkpRackAndPinionConstraintAtom {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(818601990u32)));

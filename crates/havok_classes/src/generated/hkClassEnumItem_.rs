...
pub(super) struct __hkClassEnumItemVisitor<'de> {
    marker: core::marker::PhantomData<hkClassEnumItem<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkClassEnumItemVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkClassEnumItem<'de>, __A::Error>
    where
        __A: _serde::de::MapAccess<'de>,
    {
        _serde::de::Visitor::visit_struct(
            Self {
                marker: _serde::__private::PhantomData::<hkClassEnumItem<'de>>,
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkClassEnumItemVisitor<'de> {
    type Value = hkClassEnumItem<'de>;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkClassEnumItem")
    }
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkClassEnumItem<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            _serde::Deserializer::deserialize_struct(
                ...
                "hkClassEnumItem",
                FIELDS,
                __hkClassEnumItemVisitor {
                    marker: _serde::__private::PhantomData::<hkClassEnumItem>,
                    lifetime: _serde::__private::PhantomData,
                },
            )
        }

...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpCenterOfMassChangerModifierConstraintAtom<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpCenterOfMassChangerModifierConstraintAtom<'a> {
...
const _: () = {
    ...
    for hkpCenterOfMassChangerModifierConstraintAtom<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpCenterOfMassChangerModifierConstraintAtomVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkpCenterOfMassChangerModifierConstraintAtom<'de>,
                >,
            ...
            for __hkpCenterOfMassChangerModifierConstraintAtomVisitor<'de> {
                type Value = hkpCenterOfMassChangerModifierConstraintAtom<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

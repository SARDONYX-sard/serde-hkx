...
pub(super) struct __hkpBridgeAtomsVisitor<'de> {
    marker: core::marker::PhantomData<hkpBridgeAtoms>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpBridgeAtomsVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpBridgeAtoms, __A::Error>
    where
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let m_bridgeAtom = match m_bridgeAtom {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("bridgeAtom"),
                );
            }
        };

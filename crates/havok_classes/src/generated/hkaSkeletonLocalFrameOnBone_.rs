...
const _: () = {
    ...
    impl __serde::HavokClass for hkaSkeletonLocalFrameOnBone {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(86933571u32)
        }
    }
    impl __serde::Serialize for hkaSkeletonLocalFrameOnBone {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(86933571u32)));

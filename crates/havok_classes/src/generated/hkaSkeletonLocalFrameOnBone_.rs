...
pub(super) struct __hkaSkeletonLocalFrameOnBoneVisitor<'de> {
    marker: core::marker::PhantomData<hkaSkeletonLocalFrameOnBone>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkaSkeletonLocalFrameOnBoneVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkaSkeletonLocalFrameOnBone, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkaSkeletonLocalFrameOnBoneVisitor<'de> {

...
pub struct hkpStiffSpringConstraintData<'a> {
    ...
    pub m_atoms: hkpStiffSpringConstraintDataAtoms<'a>,
}
const _: () = {
    use havok_serde as _serde;
    impl<'a> _serde::HavokClass for hkpStiffSpringConstraintData<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpStiffSpringConstraintData<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpStiffSpringConstraintData<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpStiffSpringConstraintDataVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkpStiffSpringConstraintData<'de>,
                >,
            ...
            for __hkpStiffSpringConstraintDataVisitor<'de> {
                type Value = hkpStiffSpringConstraintData<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

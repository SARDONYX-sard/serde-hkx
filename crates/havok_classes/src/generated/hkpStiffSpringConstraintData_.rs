...
const _: () = {
    ...
    impl _serde::HavokClass for hkpStiffSpringConstraintData {
        ...
        fn signature(&self) -> _serde::__private::Signature {
            _serde::__private::Signature::new(0xb98f66f4)
        }
    }
    impl _serde::Serialize for hkpStiffSpringConstraintData {
            ...
            S: _serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, _serde::__private::Signature::new(0xb98f66f4)));
...
pub(super) struct __hkpStiffSpringConstraintDataVisitor<'de> {
    marker: core::marker::PhantomData<hkpStiffSpringConstraintData>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpStiffSpringConstraintDataVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpStiffSpringConstraintData, __A::Error>
    where
        __A: _serde::de::MapAccess<'de>,
    {
        _serde::de::Visitor::visit_struct(
            Self {
                marker: _serde::__private::PhantomData::<hkpStiffSpringConstraintData>,
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpStiffSpringConstraintDataVisitor<'de> {
    type Value = hkpStiffSpringConstraintData;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpStiffSpringConstraintData {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            _serde::Deserializer::deserialize_struct(
                ...
                "hkpStiffSpringConstraintData",
                FIELDS,
                __hkpStiffSpringConstraintDataVisitor {

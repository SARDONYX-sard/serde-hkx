...
pub(super) struct __hkMeshSectionVisitor<'de> {
    marker: core::marker::PhantomData<hkMeshSection>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkMeshSectionVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkMeshSection, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkMeshSectionVisitor<'de> {
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let mut m_indexType: _serde::__private::Option<MeshSectionIndexType> = _serde::__private::None;
        ...
        let m_numIndices = match m_numIndices {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("numIndices"),
                );
            }
        };
        ...
        let m_sectionIndex = match m_sectionIndex {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("sectionIndex"),
                );
            }
        };

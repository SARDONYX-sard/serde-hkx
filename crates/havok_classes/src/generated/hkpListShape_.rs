...
const _: () = {
    ...
    impl __serde::HavokClass for hkpListShape {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(2710797501u32)
        }
    }
    impl __serde::Serialize for hkpListShape {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(2710797501u32)));

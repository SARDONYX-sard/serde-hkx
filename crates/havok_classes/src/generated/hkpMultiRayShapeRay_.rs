...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpMultiRayShapeRay<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpMultiRayShapeRay<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpMultiRayShapeRay<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpMultiRayShapeRayVisitor<'de> {
                marker: _serde::__private::PhantomData<hkpMultiRayShapeRay<'de>>,
            ...
            impl<'de> _serde::de::Visitor<'de> for __hkpMultiRayShapeRayVisitor<'de> {
                type Value = hkpMultiRayShapeRay<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

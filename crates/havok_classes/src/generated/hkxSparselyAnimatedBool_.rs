...
pub(super) struct __hkxSparselyAnimatedBoolVisitor<'de> {
    marker: core::marker::PhantomData<hkxSparselyAnimatedBool>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkxSparselyAnimatedBoolVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkxSparselyAnimatedBool, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkxSparselyAnimatedBoolVisitor<'de> {
    type Value = hkxSparselyAnimatedBool;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkxSparselyAnimatedBool")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let mut m_bools: _serde::__private::Option<Vec<bool>> = _serde::__private::None;
        let mut m_times: _serde::__private::Option<Vec<f32>> = _serde::__private::None;
        for i in 0..2usize {
            match i {
                0usize => {
                    if _serde::__private::Option::is_some(&m_bools) {
                        return _serde::__private::Err(
                            <__A::Error as _serde::de::Error>::duplicate_field("bools"),
                        );
                    }
                    m_bools = _serde::__private::Some(
        ...
        let m_bools = match m_bools {
            _serde::__private::Some(__field) => __field,
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("bools"),
                );
            }
        };
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkxSparselyAnimatedBool {
        ...
        where
            __D: _serde::Deserializer<'de>,
        {
            const FIELDS: &[&str] = &["bools", "times"];
            _serde::Deserializer::deserialize_struct(
                deserializer,
                "hkxSparselyAnimatedBool",
                FIELDS,
                __hkxSparselyAnimatedBoolVisitor {
                    marker: _serde::__private::PhantomData::<hkxSparselyAnimatedBool>,
                    lifetime: _serde::__private::PhantomData,
                },
            )

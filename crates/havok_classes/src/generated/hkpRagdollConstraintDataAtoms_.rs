...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpRagdollConstraintDataAtoms<'a> {
        #[inline]
        ...
        fn deps_indexes(&self) -> Vec<&Pointer<'_>> {
            ...
            v.extend(self.m_ragdollMotors.deps_indexes());
            v.extend(self.m_angFriction.deps_indexes());
            v.extend(self.m_twistLimit.deps_indexes());
            v.extend(self.m_coneLimit.deps_indexes());
            v.extend(self.m_planesLimit.deps_indexes());
            v.extend(self.m_ballSocket.deps_indexes());
            v
        }
    }
    impl<'a> _serde::Serialize for hkpRagdollConstraintDataAtoms<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpRagdollConstraintDataAtoms<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpRagdollConstraintDataAtomsVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkpRagdollConstraintDataAtoms<'de>,
                >,
            ...
            for __hkpRagdollConstraintDataAtomsVisitor<'de> {
                type Value = hkpRagdollConstraintDataAtoms<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

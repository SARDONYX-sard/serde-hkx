...
const _: () = {
    ...
    impl __serde::HavokClass for hkpIgnoreModifierConstraintAtom {
        #[inline]
    ...
    impl __serde::Serialize for hkpIgnoreModifierConstraintAtom {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(1550491981u32)));

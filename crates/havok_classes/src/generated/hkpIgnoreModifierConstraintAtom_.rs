...
pub(super) struct __hkpIgnoreModifierConstraintAtomVisitor<'de> {
    marker: core::marker::PhantomData<hkpIgnoreModifierConstraintAtom>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpIgnoreModifierConstraintAtomVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpIgnoreModifierConstraintAtom, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpIgnoreModifierConstraintAtomVisitor<'de> {
    type Value = hkpIgnoreModifierConstraintAtom;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpIgnoreModifierConstraintAtom {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            _serde::Deserializer::deserialize_struct(
                ...
                "hkpIgnoreModifierConstraintAtom",
                FIELDS,
                __hkpIgnoreModifierConstraintAtomVisitor {
                    marker: _serde::__private::PhantomData::<
                        hkpIgnoreModifierConstraintAtom,
                    >,
                    lifetime: _serde::__private::PhantomData,

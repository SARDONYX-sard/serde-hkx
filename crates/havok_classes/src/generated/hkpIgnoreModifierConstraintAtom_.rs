...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpIgnoreModifierConstraintAtom<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpIgnoreModifierConstraintAtom<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpIgnoreModifierConstraintAtom<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpIgnoreModifierConstraintAtomVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkpIgnoreModifierConstraintAtom<'de>,
                >,
            ...
            for __hkpIgnoreModifierConstraintAtomVisitor<'de> {
                type Value = hkpIgnoreModifierConstraintAtom<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

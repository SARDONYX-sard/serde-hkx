...
pub(super) struct __hkIndexedTransformSetVisitor<'de> {
    marker: core::marker::PhantomData<hkIndexedTransformSet<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkIndexedTransformSetVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkIndexedTransformSet<'de>, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkIndexedTransformSetVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkIndexedTransformSet")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let mut m_matricesNames: _serde::__private::Option<Vec<StringPtr<'de>>> = _serde::__private::None;

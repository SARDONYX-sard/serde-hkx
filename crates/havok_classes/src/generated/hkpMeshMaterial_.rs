...
pub struct hkpMeshMaterial<'a> {
    ...
    pub m_filterInfo: U32<'a>,
}
const _: () = {
    use havok_serde as _serde;
    impl<'a> _serde::HavokClass for hkpMeshMaterial<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkpMeshMaterial<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpMeshMaterial<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpMeshMaterialVisitor<'de> {
                marker: _serde::__private::PhantomData<hkpMeshMaterial<'de>>,

...
impl<'de> _serde::de::Visitor<'de> for __FieldVisitor {
        ...
        __E: _serde::de::Error,
    {
        match __value {
            ...
            "extraDownStaticFriction" => Ok(__Field::m_extraDownStaticFriction),
...
pub(super) struct __hkpCharacterProxyCinfoVisitor<'de> {
    marker: core::marker::PhantomData<hkpCharacterProxyCinfo>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpCharacterProxyCinfoVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpCharacterProxyCinfo, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkpCharacterProxyCinfoVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpCharacterProxyCinfo")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        for i in 0..19usize {
            match i {
                ...
                6usize => {
                    if _serde::__private::Option::is_some(&m_extraUpStaticFriction) {
                        return _serde::__private::Err(
                            <__A::Error as _serde::de::Error>::duplicate_field(
                                "extraUpStaticFriction",
                            ),
                ...
                7usize => {
                    if _serde::__private::Option::is_some(&m_extraDownStaticFriction) {
                        return _serde::__private::Err(
                            <__A::Error as _serde::de::Error>::duplicate_field(
                                "extraDownStaticFriction",
                            ),
        ...
        let m_shapePhantom = match m_shapePhantom {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("shapePhantom"),
                );
            }
        };

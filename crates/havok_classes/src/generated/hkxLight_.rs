...
pub(super) struct __hkxLightVisitor<'de> {
    marker: core::marker::PhantomData<hkxLight>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkxLightVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkxLight, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkxLightVisitor<'de> {
    type Value = hkxLight;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkxLight")
    }
            ...
            match i {
                0usize => {
                    ...
                    m_type = _serde::__private::Some(
                        match __A::next_value::<LightType>(&mut __map) {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkxLight {
        ...
        where
            __D: _serde::Deserializer<'de>,
        {
            const FIELDS: &[&str] = &["type", "position", "direction", "color", "angle"];

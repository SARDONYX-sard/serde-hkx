...
pub(super) struct __hkPostFinishAttributeVisitor<'de> {
    marker: core::marker::PhantomData<hkPostFinishAttribute>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkPostFinishAttributeVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkPostFinishAttribute, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkPostFinishAttributeVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkPostFinishAttribute")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        for i in 0..1usize {
            match i {
                0usize => {
                    if _serde::__private::Option::is_some(&m_postFinishFunction) {
        ...
        let m_postFinishFunction = match m_postFinishFunction {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkPostFinishAttribute {
        ...
        where
            __D: _serde::Deserializer<'de>,
        {
            const FIELDS: &[&str] = &["postFinishFunction"];
            _serde::Deserializer::deserialize_struct(
                deserializer,
                "hkPostFinishAttribute",
                FIELDS,
                __hkPostFinishAttributeVisitor {
                    marker: _serde::__private::PhantomData::<hkPostFinishAttribute>,
                    lifetime: _serde::__private::PhantomData,
                },
            )

...
const _: () = {
    ...
    impl __serde::HavokClass for hkbProjectData {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(329489319u32)
        }
    }
    impl __serde::Serialize for hkbProjectData {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(329489319u32)));

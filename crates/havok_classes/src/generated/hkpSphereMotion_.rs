...
const _: () = {
    ...
    impl _serde::HavokClass for hkpSphereMotion {
        #[inline]
    ...
    impl _serde::Serialize for hkpSphereMotion {
            ...
            S: _serde::ser::Serializer,
        {
            ...
            let mut serializer = __serializer
                .serialize_struct("hkpSphereMotion", class_meta)?;
...
pub(super) struct __hkpSphereMotionVisitor<'de> {
    marker: core::marker::PhantomData<hkpSphereMotion>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpSphereMotionVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpSphereMotion, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkpSphereMotionVisitor<'de> {
    type Value = hkpSphereMotion;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpSphereMotion")
    }
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpSphereMotion {

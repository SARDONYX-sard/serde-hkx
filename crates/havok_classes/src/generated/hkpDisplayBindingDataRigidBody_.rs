...
pub(super) struct __hkpDisplayBindingDataRigidBodyVisitor<'de> {
    marker: core::marker::PhantomData<hkpDisplayBindingDataRigidBody>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpDisplayBindingDataRigidBodyVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpDisplayBindingDataRigidBody, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpDisplayBindingDataRigidBodyVisitor<'de> {
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let m_rigidBody = match m_rigidBody {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("rigidBody"),
                );
            }
        };
        let m_displayObjectPtr = match m_displayObjectPtr {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("displayObjectPtr"),
                );
            }
        };

...
const _: () = {
    ...
    impl __serde::HavokClass for hkpDisplayBindingDataRigidBody {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(4262912675u32)
        }
    }
    impl __serde::Serialize for hkpDisplayBindingDataRigidBody {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(4262912675u32)));

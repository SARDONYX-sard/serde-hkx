...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkbEventProperty<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkbEventProperty<'a> {
            ...
            S: _serde::ser::Serializer,
        {
            ...
            let mut serializer = __serializer
                .serialize_struct("hkbEventProperty", class_meta, (8u64, 16u64))?;
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbEventProperty<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkbEventPropertyVisitor<'de> {
                marker: _serde::__private::PhantomData<hkbEventProperty<'de>>,
            ...
            impl<'de> _serde::de::Visitor<'de> for __hkbEventPropertyVisitor<'de> {
                type Value = hkbEventProperty<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

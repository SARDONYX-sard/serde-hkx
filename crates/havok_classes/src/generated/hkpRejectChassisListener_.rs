...
pub(super) struct __hkpRejectChassisListenerVisitor<'de> {
    marker: core::marker::PhantomData<hkpRejectChassisListener>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpRejectChassisListenerVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpRejectChassisListener, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpRejectChassisListenerVisitor<'de> {
    type Value = hkpRejectChassisListener;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpRejectChassisListener")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        for i in 0..1usize {
            match i {
                0usize => {
                    if _serde::__private::Option::is_some(&m_chassis) {
                        return _serde::__private::Err(
                            <__A::Error as _serde::de::Error>::duplicate_field("chassis"),
                        );
                    }
        ...
        let m_chassis = match m_chassis {
            _serde::__private::Some(__field) => __field,
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("chassis"),
                );
            }
        };
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpRejectChassisListener {
        ...
        where
            __D: _serde::Deserializer<'de>,
        {
            const FIELDS: &[&str] = &["chassis"];
            _serde::Deserializer::deserialize_struct(
                deserializer,
                "hkpRejectChassisListener",
                FIELDS,
                __hkpRejectChassisListenerVisitor {
                    marker: _serde::__private::PhantomData::<hkpRejectChassisListener>,
                    lifetime: _serde::__private::PhantomData,
                },
            )

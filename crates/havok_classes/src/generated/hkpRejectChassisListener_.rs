...
const _: () = {
    ...
    impl __serde::HavokClass for hkpRejectChassisListener {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(3304724169u32)
        }
    }
    impl __serde::Serialize for hkpRejectChassisListener {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(3304724169u32)));

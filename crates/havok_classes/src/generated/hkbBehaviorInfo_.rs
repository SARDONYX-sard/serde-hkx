...
pub(super) struct __hkbBehaviorInfoVisitor<'de> {
    marker: core::marker::PhantomData<hkbBehaviorInfo<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbBehaviorInfoVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbBehaviorInfo<'de>, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkbBehaviorInfoVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkbBehaviorInfo")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let m_idToNamePairs = match m_idToNamePairs {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("idToNamePairs"),
                );
            }
        };

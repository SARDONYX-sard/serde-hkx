    ...
    impl _serde::Serialize for hkResourceContainer {
            ...
            S: _serde::ser::Serializer,
        {
            ...
            let mut serializer = __serializer
                .serialize_struct("hkResourceContainer", class_meta)?;
...
pub(super) struct __hkResourceContainerVisitor<'de> {
    marker: core::marker::PhantomData<hkResourceContainer>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkResourceContainerVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkResourceContainer, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkResourceContainerVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkResourceContainer")
    }

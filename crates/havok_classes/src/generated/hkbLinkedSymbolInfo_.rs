...
pub(super) struct __hkbLinkedSymbolInfoVisitor<'de> {
    marker: core::marker::PhantomData<hkbLinkedSymbolInfo<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbLinkedSymbolInfoVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbLinkedSymbolInfo<'de>, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkbLinkedSymbolInfoVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkbLinkedSymbolInfo")
    }

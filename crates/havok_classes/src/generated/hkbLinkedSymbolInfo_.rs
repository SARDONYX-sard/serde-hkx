...
const _: () = {
    ...
    impl<'a> __serde::HavokClass for hkbLinkedSymbolInfo<'a> {
        #[inline]
    ...
    impl<'a> __serde::Serialize for hkbLinkedSymbolInfo<'a> {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(1783665891u32)));

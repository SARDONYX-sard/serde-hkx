...
pub(super) struct __hkpVehicleFrictionStatusVisitor<'de> {
    marker: core::marker::PhantomData<hkpVehicleFrictionStatus>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpVehicleFrictionStatusVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpVehicleFrictionStatus, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkpVehicleFrictionStatusVisitor<'de> {
    type Value = hkpVehicleFrictionStatus;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpVehicleFrictionStatus")
    }

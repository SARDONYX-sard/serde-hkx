...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkxTextureFile<'a> {
        ...
        fn signature(&self) -> _serde::__private::Signature {
            _serde::__private::Signature::new(0x1e289259)
        }
    }
...
pub(super) struct __hkxTextureFileVisitor<'de> {
    marker: core::marker::PhantomData<hkxTextureFile<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkxTextureFileVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkxTextureFile<'de>, __A::Error>
    where
        __A: _serde::de::MapAccess<'de>,
    {
        _serde::de::Visitor::visit_struct(
            Self {
                marker: _serde::__private::PhantomData::<hkxTextureFile<'de>>,
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkxTextureFileVisitor<'de> {
    type Value = hkxTextureFile<'de>;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkxTextureFile")
    }
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkxTextureFile<'de> {
        fn deserialize<__D>(deserializer: __D) -> core::result::Result<Self, __D::Error>
        where
            __D: _serde::Deserializer<'de>,
        {
            const FIELDS: &[&str] = &["filename", "name", "originalFilename"];
            _serde::Deserializer::deserialize_struct(
                deserializer,
                "hkxTextureFile",
                FIELDS,
                __hkxTextureFileVisitor {
                    marker: _serde::__private::PhantomData::<hkxTextureFile>,
                    lifetime: _serde::__private::PhantomData,
                },
            )
        }

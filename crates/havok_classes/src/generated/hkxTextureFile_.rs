...
const _: () = {
    ...
    impl<'a> __serde::HavokClass for hkxTextureFile<'a> {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(505975385u32)
        }
    }
    impl<'a> __serde::Serialize for hkxTextureFile<'a> {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(505975385u32)));

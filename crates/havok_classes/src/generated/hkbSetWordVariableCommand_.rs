...
const _: () = {
    ...
    impl __serde::HavokClass for hkbSetWordVariableCommand {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(4088291274u32)
        }
    }
    impl __serde::Serialize for hkbSetWordVariableCommand {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(4088291274u32)));

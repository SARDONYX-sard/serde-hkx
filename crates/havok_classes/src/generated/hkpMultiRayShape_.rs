...
pub(super) struct __hkpMultiRayShapeVisitor<'de> {
    marker: core::marker::PhantomData<hkpMultiRayShape>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpMultiRayShapeVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpMultiRayShape, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkpMultiRayShapeVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpMultiRayShape")
    }
            ...
            match i {
                0usize => {
                    ...
                    m_rays = _serde::__private::Some(
                        match __A::next_value::<Vec<hkpMultiRayShapeRay>>(&mut __map) {
                ...
                1usize => {
                    if _serde::__private::Option::is_some(&m_rayPenetrationDistance) {
                        return _serde::__private::Err(
                    ...
                    m_rayPenetrationDistance = _serde::__private::Some(
        ...
        for _ in 0..2usize {
            ...
            >(&mut __map)? {
                match __key {
                    ...
                    __Field::m_rayPenetrationDistance => {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpMultiRayShape {
        ...
        where
            __D: _serde::Deserializer<'de>,
        {
            const FIELDS: &[&str] = &["rays", "rayPenetrationDistance"];
            _serde::Deserializer::deserialize_struct(
                deserializer,
                "hkpMultiRayShape",
                FIELDS,
                __hkpMultiRayShapeVisitor {
                    marker: _serde::__private::PhantomData::<hkpMultiRayShape>,
                    lifetime: _serde::__private::PhantomData,
                },
            )

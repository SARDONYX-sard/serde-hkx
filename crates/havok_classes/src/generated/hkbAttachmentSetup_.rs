...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkbAttachmentSetup<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkbAttachmentSetup<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbAttachmentSetup<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkbAttachmentSetupVisitor<'de> {
                marker: _serde::__private::PhantomData<hkbAttachmentSetup<'de>>,
            ...
            impl<'de> _serde::de::Visitor<'de> for __hkbAttachmentSetupVisitor<'de> {
                type Value = hkbAttachmentSetup<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {
...
/// # C++ Info
/// - name: `AttachmentType`(ctype: `hkEnum<AttachmentType, hkInt8>`)
#[allow(non_upper_case_globals, non_snake_case)]
#[cfg_attr(feature = "json_schema", derive(schemars::JsonSchema))]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(

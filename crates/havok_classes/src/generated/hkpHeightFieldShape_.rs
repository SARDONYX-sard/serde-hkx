...
pub(super) struct __hkpHeightFieldShapeVisitor<'de> {
    marker: core::marker::PhantomData<hkpHeightFieldShape>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpHeightFieldShapeVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpHeightFieldShape, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkpHeightFieldShapeVisitor<'de> {
    type Value = hkpHeightFieldShape;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpHeightFieldShape")
    }
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpHeightFieldShape {

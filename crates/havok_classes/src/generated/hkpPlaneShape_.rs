...
pub struct hkpPlaneShape<'a> {
    ...
    #[cfg_attr(feature = "json_schema", schemars(rename = "plane"))]
...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpPlaneShape<'a> {
        #[inline]
        ...
        fn signature(&self) -> _serde::__private::Signature {
            _serde::__private::Signature::new(0xc36bbd30)
        }
    ...
    impl<'a> _serde::Serialize for hkpPlaneShape<'a> {
            ...
            S: _serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .as_ref()
                .map(|name| (name, _serde::__private::Signature::new(0xc36bbd30)));
            let mut serializer = __serializer
                .serialize_struct("hkpPlaneShape", class_meta, (64u64, 80u64))?;
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpPlaneShape<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpPlaneShapeVisitor<'de> {
                marker: _serde::__private::PhantomData<hkpPlaneShape<'de>>,
                lifetime: _serde::__private::PhantomData<&'de ()>,
            }
            #[allow(clippy::match_single_binding)]
            #[allow(clippy::reversed_empty_ranges)]
            #[allow(clippy::single_match)]
            impl<'de> _serde::de::Visitor<'de> for __hkpPlaneShapeVisitor<'de> {
                type Value = hkpPlaneShape<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {
                    core::fmt::Formatter::write_str(__formatter, "struct hkpPlaneShape")
                }
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    let mut m_plane: _serde::__private::Option<Vector4> = _serde::__private::None;
                    ...
                    for i in 0..3usize {
                        match i {
                            0usize => {
                                if _serde::__private::Option::is_some(&m_plane) {
                                    return _serde::__private::Err(
                                        <__A::Error as _serde::de::Error>::duplicate_field("plane"),
                                    );
                                }
                                m_plane = _serde::__private::Some(
                    ...
                    let m_plane = match m_plane {
                        _serde::__private::Some(__field) => __field,
                        _serde::__private::None => {
                            return _serde::__private::Err(
                                <__A::Error as _serde::de::Error>::missing_field("plane"),
                            );
                        }
                    };
                    ...
                    _serde::__private::Ok(hkpPlaneShape {
                        __ptr,
                        parent,
                        m_plane,
                        m_aabbCenter,
            ...
            const FIELDS: &[&str] = &["plane", "aabbCenter", "aabbHalfExtents"];
            _serde::Deserializer::deserialize_struct(
                deserializer,
                "hkpPlaneShape",
                FIELDS,
                __hkpPlaneShapeVisitor {
                    marker: _serde::__private::PhantomData::<hkpPlaneShape>,

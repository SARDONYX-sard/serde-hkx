...
const _: () = {
    ...
    impl _serde::HavokClass for hkpPlaneShape {
        #[inline]
    ...
    impl _serde::Serialize for hkpPlaneShape {
...
pub(super) struct __hkpPlaneShapeVisitor<'de> {
    marker: core::marker::PhantomData<hkpPlaneShape>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpPlaneShapeVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpPlaneShape, __A::Error>
    where
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpPlaneShape {

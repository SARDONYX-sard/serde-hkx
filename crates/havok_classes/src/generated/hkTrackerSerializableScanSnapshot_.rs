...
pub(super) struct __hkTrackerSerializableScanSnapshotVisitor<'de> {
    marker: core::marker::PhantomData<hkTrackerSerializableScanSnapshot>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkTrackerSerializableScanSnapshotVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkTrackerSerializableScanSnapshot, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkTrackerSerializableScanSnapshotVisitor<'de> {

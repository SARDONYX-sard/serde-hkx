...
const _: () = {
    ...
    impl __serde::HavokClass for hkTrackerSerializableScanSnapshot {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(2270884313u32)
        }
    }
    impl __serde::Serialize for hkTrackerSerializableScanSnapshot {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(2270884313u32)));

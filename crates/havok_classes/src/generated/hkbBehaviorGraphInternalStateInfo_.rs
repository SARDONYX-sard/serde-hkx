...
const _: () = {
    ...
    impl __serde::HavokClass for hkbBehaviorGraphInternalStateInfo {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(1683982731u32)
        }
    }
    impl __serde::Serialize for hkbBehaviorGraphInternalStateInfo {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(1683982731u32)));

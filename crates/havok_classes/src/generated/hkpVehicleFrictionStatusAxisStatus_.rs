...
const _: () = {
    ...
    impl __serde::HavokClass for hkpVehicleFrictionStatusAxisStatus {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(3876465588u32)
        }
    }
    impl __serde::Serialize for hkpVehicleFrictionStatusAxisStatus {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(3876465588u32)));

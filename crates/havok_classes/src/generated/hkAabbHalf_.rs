...
pub(super) struct __hkAabbHalfVisitor<'de> {
    marker: core::marker::PhantomData<hkAabbHalf>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkAabbHalfVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkAabbHalf, __A::Error>
    where

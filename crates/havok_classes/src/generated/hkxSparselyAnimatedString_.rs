...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkxSparselyAnimatedString<'a> {
        #[inline]
        ...
        fn signature(&self) -> _serde::__private::Signature {
            _serde::__private::Signature::new(0x185da6fd)
        }
    }
    impl<'a> _serde::Serialize for hkxSparselyAnimatedString<'a> {
            ...
            S: _serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, _serde::__private::Signature::new(0x185da6fd)));
...
pub(super) struct __hkxSparselyAnimatedStringVisitor<'de> {
    marker: core::marker::PhantomData<hkxSparselyAnimatedString<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkxSparselyAnimatedStringVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkxSparselyAnimatedString<'de>, __A::Error>
    where
        __A: _serde::de::MapAccess<'de>,
    {
        _serde::de::Visitor::visit_struct(
            Self {
                marker: _serde::__private::PhantomData::<hkxSparselyAnimatedString<'de>>,
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkxSparselyAnimatedStringVisitor<'de> {
    type Value = hkxSparselyAnimatedString<'de>;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkxSparselyAnimatedString")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let m_strings = match m_strings {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("strings"),
                );
            }
        };
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkxSparselyAnimatedString<'de> {
        fn deserialize<__D>(deserializer: __D) -> core::result::Result<Self, __D::Error>
        where
            __D: _serde::Deserializer<'de>,
        {
            const FIELDS: &[&str] = &["strings", "times"];
            _serde::Deserializer::deserialize_struct(
                deserializer,
                "hkxSparselyAnimatedString",
                FIELDS,
                __hkxSparselyAnimatedStringVisitor {
                    marker: _serde::__private::PhantomData::<hkxSparselyAnimatedString>,
                    lifetime: _serde::__private::PhantomData,
                },
            )
        }

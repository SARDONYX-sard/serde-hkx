...
pub struct hkxSparselyAnimatedString<'a> {
    ...
    /// - type_size: ` 12`(x86)/` 16`(x86_64)
    #[cfg_attr(feature = "json_schema", schemars(rename = "times"))]
    #[cfg_attr(feature = "serde", serde(rename = "times"))]
    pub m_times: Vec<f32>,
}
const _: () = {
    ...
    impl<'a> _serde::Serialize for hkxSparselyAnimatedString<'a> {
            ...
            S: _serde::ser::Serializer,
        {
            ...
            serializer
                .serialize_array_field("strings", &self.m_strings, TypeSize::String)?;
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkxSparselyAnimatedString<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkxSparselyAnimatedStringVisitor<'de> {
            ...
            for __hkxSparselyAnimatedStringVisitor<'de> {

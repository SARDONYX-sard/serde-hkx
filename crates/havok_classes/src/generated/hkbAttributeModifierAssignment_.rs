...
pub struct hkbAttributeModifierAssignment<'a> {
...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkbAttributeModifierAssignment<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkbAttributeModifierAssignment<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbAttributeModifierAssignment<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkbAttributeModifierAssignmentVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkbAttributeModifierAssignment<'de>,
                >,
            ...
            for __hkbAttributeModifierAssignmentVisitor<'de> {
                type Value = hkbAttributeModifierAssignment<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    let mut m_attributeIndex: _serde::__private::Option<I32<'de>> = _serde::__private::None;

...
pub(super) struct __hkpConstraintAtomVisitor<'de> {
    marker: core::marker::PhantomData<hkpConstraintAtom>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpConstraintAtomVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpConstraintAtom, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkpConstraintAtomVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpConstraintAtom")
    }

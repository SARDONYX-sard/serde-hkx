...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkbDelayedModifier<'a> {
        ...
        fn signature(&self) -> _serde::__private::Signature {
            _serde::__private::Signature::new(0x8e101a7a)
        }
    }
...
impl<'de> _serde::de::Visitor<'de> for __FieldVisitor {
    ...
    {
        match __value {
            "delaySeconds" => Ok(__Field::m_delaySeconds),
            "durationSeconds" => Ok(__Field::m_durationSeconds),
...
pub(super) struct __hkbDelayedModifierVisitor<'de> {
    marker: core::marker::PhantomData<hkbDelayedModifier<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbDelayedModifierVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbDelayedModifier<'de>, __A::Error>
    where
        __A: _serde::de::MapAccess<'de>,
    {
        _serde::de::Visitor::visit_struct(
            Self {
                marker: _serde::__private::PhantomData::<hkbDelayedModifier<'de>>,
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkbDelayedModifierVisitor<'de> {
    type Value = hkbDelayedModifier<'de>;
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkbDelayedModifier")
    }
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let mut m_delaySeconds: _serde::__private::Option<f32> = _serde::__private::None;
        let mut m_durationSeconds: _serde::__private::Option<f32> = _serde::__private::None;
        ...
        for i in 0..4usize {
            match i {
                0usize => {
                    if _serde::__private::Option::is_some(&m_delaySeconds) {
                    ...
                    m_delaySeconds = _serde::__private::Some(
                ...
                1usize => {
                    if _serde::__private::Option::is_some(&m_durationSeconds) {
                        return _serde::__private::Err(
                            <__A::Error as _serde::de::Error>::duplicate_field(
                                "durationSeconds",
                            ),
                    ...
                    m_durationSeconds = _serde::__private::Some(
                        match __A::next_value::<f32>(&mut __map) {
                            _serde::__private::Ok(__val) => __val,
                            _serde::__private::Err(__err) => {
                                return _serde::__private::Err(__err);
        ...
        let m_delaySeconds = match m_delaySeconds {
            _serde::__private::Some(__field) => __field,
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("delaySeconds"),
                );
            }
        };
        let m_durationSeconds = match m_durationSeconds {
            _serde::__private::Some(__field) => __field,
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("durationSeconds"),
                );
            }
        };
        ...
        _serde::__private::Ok(hkbDelayedModifier {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbDelayedModifier<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            _serde::Deserializer::deserialize_struct(
                ...
                "hkbDelayedModifier",
                FIELDS,
                __hkbDelayedModifierVisitor {
                    marker: _serde::__private::PhantomData::<hkbDelayedModifier>,
                    lifetime: _serde::__private::PhantomData,
                },
            )
        }

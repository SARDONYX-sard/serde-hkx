...
pub(super) struct __hkpWeldingUtilityVisitor<'de> {
    marker: core::marker::PhantomData<hkpWeldingUtility>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpWeldingUtilityVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpWeldingUtility, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkpWeldingUtilityVisitor<'de> {
    ...
    fn expecting(&self, __formatter: &mut core::fmt::Formatter) -> core::fmt::Result {
        core::fmt::Formatter::write_str(__formatter, "struct hkpWeldingUtility")
    }

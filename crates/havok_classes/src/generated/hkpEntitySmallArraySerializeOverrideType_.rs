...
pub(super) struct __hkpEntitySmallArraySerializeOverrideTypeVisitor<'de> {
    marker: core::marker::PhantomData<hkpEntitySmallArraySerializeOverrideType>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkpEntitySmallArraySerializeOverrideTypeVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkpEntitySmallArraySerializeOverrideType, __A::Error>
    where

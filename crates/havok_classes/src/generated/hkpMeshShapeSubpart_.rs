...
const _: () = {
    ...
    impl __serde::HavokClass for hkpMeshShapeSubpart {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(657682013u32)
        }
    }
    impl __serde::Serialize for hkpMeshShapeSubpart {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(657682013u32)));

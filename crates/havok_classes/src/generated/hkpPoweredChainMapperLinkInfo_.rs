...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkpPoweredChainMapperLinkInfo<'a> {
        #[inline]
        ...
        fn deps_indexes(&self) -> Vec<&Pointer<'_>> {
            let mut v = Vec::new();
            v.push(&self.m_limitConstraint);
            v
        }
    }
    impl<'a> _serde::Serialize for hkpPoweredChainMapperLinkInfo<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkpPoweredChainMapperLinkInfo<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkpPoweredChainMapperLinkInfoVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkpPoweredChainMapperLinkInfo<'de>,
                >,
            ...
            for __hkpPoweredChainMapperLinkInfoVisitor<'de> {
                type Value = hkpPoweredChainMapperLinkInfo<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    let mut m_firstTargetIdx: _serde::__private::Option<I32<'de>> = _serde::__private::None;
                    let mut m_numTargets: _serde::__private::Option<I32<'de>> = _serde::__private::None;
                    let mut m_limitConstraint: _serde::__private::Option<Pointer<'de>> = _serde::__private::None;
                    for i in 0..3usize {
                        match i {
                            0usize => {

...
const _: () = {
    ...
    for hkpSerializedDisplayRbTransformsDisplayTransformPair<'a> {
        #[inline]
...
const _: () = {
    ...
    for hkpSerializedDisplayRbTransformsDisplayTransformPair<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            for __hkpSerializedDisplayRbTransformsDisplayTransformPairVisitor<'de> {
                type Value = hkpSerializedDisplayRbTransformsDisplayTransformPair<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                    ...
                    let mut m_rb: _serde::__private::Option<Pointer<'de>> = _serde::__private::None;

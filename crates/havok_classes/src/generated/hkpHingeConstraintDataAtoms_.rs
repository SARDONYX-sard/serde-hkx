...
const _: () = {
    ...
    impl __serde::HavokClass for hkpHingeConstraintDataAtoms {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(1767388956u32)
        }
    }
    impl __serde::Serialize for hkpHingeConstraintDataAtoms {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(1767388956u32)));

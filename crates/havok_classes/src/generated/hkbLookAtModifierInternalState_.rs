...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkbLookAtModifierInternalState<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkbLookAtModifierInternalState<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkbLookAtModifierInternalState<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkbLookAtModifierInternalStateVisitor<'de> {
                marker: _serde::__private::PhantomData<
                    hkbLookAtModifierInternalState<'de>,
                >,
            ...
            for __hkbLookAtModifierInternalStateVisitor<'de> {
                type Value = hkbLookAtModifierInternalState<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {

...
const _: () = {
    ...
    impl __serde::HavokClass for hkbLookAtModifierInternalState {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(2706156454u32)
        }
    }
    impl __serde::Serialize for hkbLookAtModifierInternalState {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(2706156454u32)));

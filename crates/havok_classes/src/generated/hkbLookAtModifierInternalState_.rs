...
pub(super) struct __hkbLookAtModifierInternalStateVisitor<'de> {
    marker: core::marker::PhantomData<hkbLookAtModifierInternalState>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkbLookAtModifierInternalStateVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkbLookAtModifierInternalState, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkbLookAtModifierInternalStateVisitor<'de> {

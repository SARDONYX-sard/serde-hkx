...
impl<'de> _serde::de::Visitor<'de> for __FieldVisitor {
        ...
        __E: _serde::de::Error,
    {
        match __value {
            ...
            "numImplementedInterfaces" => Ok(__Field::m_numImplementedInterfaces),
...
pub(super) struct __hkClassVisitor<'de> {
    marker: core::marker::PhantomData<hkClass<'de>>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkClassVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkClass<'de>, __A::Error>
    where
...
impl<'de> _serde::de::Visitor<'de> for __hkClassVisitor<'de> {
        ...
        __A: _serde::de::MapAccess<'de>,
    {
        ...
        let mut m_declaredEnums: _serde::__private::Option<Vec<hkClassEnum<'de>>> = _serde::__private::None;
        let mut m_declaredMembers: _serde::__private::Option<Vec<hkClassMember<'de>>> = _serde::__private::None;
        ...
        for i in 0..10usize {
            match i {
                ...
                3usize => {
                    if _serde::__private::Option::is_some(&m_numImplementedInterfaces) {
                        return _serde::__private::Err(
                            <__A::Error as _serde::de::Error>::duplicate_field(
                                "numImplementedInterfaces",
                            ),
                ...
                5usize => {
                    ...
                    m_declaredMembers = _serde::__private::Some(
                        match __A::next_value::<Vec<hkClassMember<'de>>>(&mut __map) {
                            _serde::__private::Ok(__val) => __val,
                            _serde::__private::Err(__err) => {
                                return _serde::__private::Err(__err);
                            }
        ...
        let m_objectSize = match m_objectSize {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("objectSize"),
                );
            }
        };
        ...
        let m_declaredEnums = match m_declaredEnums {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("declaredEnums"),
                );
            }
        };
        let m_declaredMembers = match m_declaredMembers {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("declaredMembers"),
                );
            }
        };
        ...
        let m_describedVersion = match m_describedVersion {
            ...
            _serde::__private::None => {
                return _serde::__private::Err(
                    <__A::Error as _serde::de::Error>::missing_field("describedVersion"),
                );
            }
        };

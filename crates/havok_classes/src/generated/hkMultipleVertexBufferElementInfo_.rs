...
pub(super) struct __hkMultipleVertexBufferElementInfoVisitor<'de> {
    marker: core::marker::PhantomData<hkMultipleVertexBufferElementInfo>,
    lifetime: core::marker::PhantomData<&'de ()>,
}
impl<'de> __hkMultipleVertexBufferElementInfoVisitor<'de> {
    ...
    pub(super) fn visit_as_parent<__A>(
        __map: &mut __A,
    ) -> _serde::__private::Result<hkMultipleVertexBufferElementInfo, __A::Error>
    where
...
#[allow(clippy::reversed_empty_ranges)]
#[allow(clippy::single_match)]
impl<'de> _serde::de::Visitor<'de> for __hkMultipleVertexBufferElementInfoVisitor<'de> {

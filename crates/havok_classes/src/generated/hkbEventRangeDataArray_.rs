...
const _: () = {
    ...
    impl __serde::HavokClass for hkbEventRangeDataArray {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(856315630u32)
        }
    }
    impl __serde::Serialize for hkbEventRangeDataArray {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(856315630u32)));

...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkSphere<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkSphere<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkSphere<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkSphereVisitor<'de> {
                marker: _serde::__private::PhantomData<hkSphere<'de>>,

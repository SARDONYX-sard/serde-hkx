...
const _: () = {
    ...
    impl __serde::HavokClass for hkpWorldCinfo {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(2770687045u32)
        }
    }
    impl __serde::Serialize for hkpWorldCinfo {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(2770687045u32)));

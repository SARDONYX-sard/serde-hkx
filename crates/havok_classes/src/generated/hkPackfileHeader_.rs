...
const _: () = {
    ...
    impl __serde::HavokClass for hkPackfileHeader {
        #[inline]
        ...
        fn signature(&self) -> __serde::__private::Signature {
            __serde::__private::Signature::new(2046427098u32)
        }
    }
    impl __serde::Serialize for hkPackfileHeader {
            ...
            S: __serde::ser::Serializer,
        {
            let class_meta = self
                .__ptr
                .map(|name| (name, __serde::__private::Signature::new(2046427098u32)));

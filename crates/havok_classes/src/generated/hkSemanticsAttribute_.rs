...
const _: () = {
    ...
    impl<'a> _serde::HavokClass for hkSemanticsAttribute<'a> {
        #[inline]
    ...
    impl<'a> _serde::Serialize for hkSemanticsAttribute<'a> {
...
const _: () = {
    ...
    impl<'de> _serde::Deserialize<'de> for hkSemanticsAttribute<'de> {
            ...
            __D: _serde::Deserializer<'de>,
        {
            ...
            struct __hkSemanticsAttributeVisitor<'de> {
                marker: _serde::__private::PhantomData<hkSemanticsAttribute<'de>>,
            ...
            impl<'de> _serde::de::Visitor<'de> for __hkSemanticsAttributeVisitor<'de> {
                type Value = hkSemanticsAttribute<'de>;
                fn expecting(
                    &self,
                    __formatter: &mut core::fmt::Formatter,
                ) -> core::fmt::Result {
...
/// # C++ Info
/// - name: `Semantics`(ctype: `hkEnum<Semantics, hkInt8>`)
#[allow(non_upper_case_globals, non_snake_case)]
#[cfg_attr(feature = "json_schema", derive(schemars::JsonSchema))]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
#[derive(

...
impl<'de> de::Deserializer<'de> for &mut BytesDeserializer<'de> {
    ...
    where
        V: Visitor<'de>,
    {
        let res = visitor.visit_int16(tri!(
            self.parse_peek(
    ...
    where
        V: Visitor<'de>,
    {
        let res = visitor.visit_uint16(tri!(
            self.parse_peek(
    ...
    where
        V: Visitor<'de>,
    {
        let res = visitor.visit_int32(tri!(
            self.parse_peek(
    ...
    where
        V: Visitor<'de>,
    {
        let res = visitor.visit_uint32(tri!(
            self.parse_peek(
    ...
    where
        V: Visitor<'de>,
    {
        let res = visitor.visit_int64(tri!(
            self.parse_peek(
    ...
    where
        V: Visitor<'de>,
    {
        let res = visitor.visit_uint64(tri!(
            self.parse_peek(
                binary::u64(self.endian)

...
/// This is an exact intermediate-state reproduction of the XML output of defaultmale.hkx generated by hkxcmd.
/// In particular, the numeric values of the pointers (ptr) are preserved.
